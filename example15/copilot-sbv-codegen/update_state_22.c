...
/*test 001*/
/*ACSL to write
 (s5 && (((((((((((s21 || s22) || s23) || s24) || s25) || s26) || s15) || s16) || s17) || s18) || s19) || s20))
*/
/*@
 assigns \nothing;
 ensures \result == (queue_5[ptr_5] && (((((((((((queue_21[ptr_21] || queue_22[ptr_22]) || queue_23[ptr_23]) || queue_24[ptr_24]) || queue_25[ptr_25]) || queue_26[ptr_26]) || queue_15[ptr_15]) || queue_16[ptr_16]) || queue_17[ptr_17]) || queue_18[ptr_18]) || queue_19[ptr_19]) || queue_20[ptr_20]));
*/
