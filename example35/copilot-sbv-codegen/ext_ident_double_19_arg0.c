...
/*@
 assigns \nothing;
 ensures \result == ((( (((((((ext_ownship_velocity_x) - (ext_intruder_velocity_x))) == (0.0))) && (((((ext_ownship_velocity_y) - (ext_intruder_velocity_y))) == (0.0))))) ? (0.0) : (((((0.0) - (ext_ident_double_16))) / (ext_ident_double_18))))));
*/
                                 ...
                                 const SDouble ext_ident_double_17)
{
  ...
  const SDouble s4 = ext_ident_double_16;
  ...
  const SDouble s9 = ext_ident_double_18;
  const SDouble s10 = ext_ident_double_17;
