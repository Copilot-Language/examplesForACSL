...
/*@
 assigns \nothing;
 ensures \result == ((( (((((((ext_ownship_velocity_x) - (ext_intruder_velocity_x))) == (0.0))) && (((((ext_ownship_velocity_y) - (ext_intruder_velocity_y))) == (0.0))))) ? (0.0) : (((((0.0) - (ext_ident_double_108))) / (ext_ident_double_110))))));
*/
                                  ...
                                  const SDouble ext_ident_double_109)
{
  ...
  const SDouble s4 = ext_ident_double_108;
  ...
  const SDouble s10 = ext_ident_double_109;
