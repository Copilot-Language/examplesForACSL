/* File: "ext_ident_double_170_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_166) < (0.0))) ? (((((0.0) - (ext_ident_double_168))) / (ext_ident_double_169))) : (-1.0))));
*/
...
{
  const SDouble s0 = ext_ident_double_166;
  ...
  const SDouble s10 = ext_ident_double_167;
  const SDouble s11 = ext_ident_double_169;
