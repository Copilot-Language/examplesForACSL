/* File: "ext_sqrt_86_arg0.c". Automatically generated by SBV. Do not edit! */
                         ...
                         const SDouble ext_ident_double_81)
{
  ...
  const SDouble s9 = ext_ident_double_68;
  const SDouble s10 = ext_ownship_position_y;
  const SDouble s11 = ext_intruder_position_y;
  const SDouble s12 = ext_ident_double_70;
  const SDouble s13 = ext_ident_double_69;
  const SDouble s14 = ext_ident_double_75;
  const SDouble s15 = ext_ident_double_72;
  const SDouble s16 = ext_ident_double_74;
  const SDouble s17 = ext_ident_double_73;
  const SDouble s18 = ext_ident_double_79;
  const SDouble s19 = ext_ident_double_76;
  const SDouble s20 = ext_ident_double_78;
  const SDouble s21 = ext_ident_double_77;
  const SDouble s22 = ext_ident_double_83;
  const SDouble s23 = ext_ident_double_80;
  const SDouble s24 = ext_ident_double_82;
  const SDouble s25 = ext_ident_double_81;
  return s0;
}
