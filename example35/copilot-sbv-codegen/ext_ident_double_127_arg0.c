/* File: "ext_ident_double_127_arg0.c". Automatically generated by SBV. Do not edit! */
                                  ...
                                  const SDouble ext_ident_double_121)
{
  ...
  const SDouble s10 = ext_ident_double_108;
  const SDouble s11 = ext_ownship_position_y;
  const SDouble s12 = ext_intruder_position_y;
  const SDouble s13 = ext_ident_double_110;
  const SDouble s14 = ext_ident_double_109;
  const SDouble s15 = ext_ident_double_115;
  const SDouble s16 = ext_ident_double_112;
  const SDouble s17 = ext_ident_double_114;
  const SDouble s18 = ext_ident_double_113;
  const SDouble s19 = ext_ident_double_119;
  const SDouble s20 = ext_ident_double_116;
  const SDouble s21 = ext_ident_double_118;
  const SDouble s22 = ext_ident_double_117;
  const SDouble s23 = ext_ident_double_123;
  const SDouble s24 = ext_ident_double_120;
  const SDouble s25 = ext_ident_double_122;
  const SDouble s26 = ext_ident_double_121;
