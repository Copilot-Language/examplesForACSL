/* File: "ext_ident_bool_141_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_bool_136) && (ext_ident_bool_140))));
*/
...
{
  const SBool   s0 = ext_ident_bool_136;
  const SDouble s1 = ext_ident_double_107;
  const SDouble s2 = ext_sqrt_106;
  const SDouble s3 = ext_ident_double_105;
  const SDouble s4 = ext_ident_double_104;
  ...
  const SDouble s9 = ext_ident_double_127;
  const SDouble s10 = ext_sqrt_126;
  const SDouble s11 = ext_ident_double_125;
  const SDouble s12 = ext_ident_double_124;
  const SDouble s13 = ext_ident_double_111;
  ...
  const SDouble s19 = ext_ident_double_110;
  const SDouble s20 = ext_ident_double_109;
  const SDouble s21 = ext_ident_double_115;
  const SDouble s22 = ext_ident_double_112;
  const SDouble s23 = ext_ident_double_114;
  const SDouble s24 = ext_ident_double_113;
  const SDouble s25 = ext_ident_double_119;
  const SDouble s26 = ext_ident_double_116;
  const SDouble s27 = ext_ident_double_118;
  const SDouble s28 = ext_ident_double_117;
  const SDouble s29 = ext_ident_double_123;
  const SDouble s30 = ext_ident_double_120;
  const SDouble s31 = ext_ident_double_122;
  const SDouble s32 = ext_ident_double_121;
  const SDouble s33 = ext_ident_double_131;
  const SDouble s34 = ext_ident_double_128;
  const SDouble s35 = ext_ident_double_130;
  const SDouble s36 = ext_ident_double_129;
  const SDouble s37 = ext_ident_double_135;
  const SDouble s38 = ext_ident_double_132;
  const SDouble s39 = ext_ident_double_134;
  const SDouble s40 = ext_ident_double_133;
  const SBool   s41 = ext_ident_bool_140;
  const SDouble s42 = ext_ownship_position_z;
  const SDouble s43 = ext_intruder_position_z;
  const SDouble s44 = ext_ident_double_137;
  const SDouble s45 = ext_ident_double_138;
  const SDouble s46 = ext_ownship_velocity_z;
  const SDouble s47 = ext_intruder_velocity_z;
  const SDouble s48 = ext_ident_double_139;
  const SBool   s49 = s0 && s41;
  const SBool   s50 = s49 /* wellClearViolation */;
