...
/*@
 assigns \nothing;
 ensures \result == ((((((((((ext_ownship_position_x) - (ext_intruder_position_x))) + (((ext_ident_double_149) * (((ext_ownship_velocity_x) - (ext_intruder_velocity_x))))))) * (((((ext_ownship_position_x) - (ext_intruder_position_x))) + (((ext_ident_double_153) * (((ext_ownship_velocity_x) - (ext_intruder_velocity_x))))))))) + (((((((ext_ownship_position_y) - (ext_intruder_position_y))) + (((ext_ident_double_157) * (((ext_ownship_velocity_y) - (ext_intruder_velocity_y))))))) * (((((ext_ownship_position_y) - (ext_intruder_position_y))) + (((ext_ident_double_161) * (((ext_ownship_velocity_y) - (ext_intruder_velocity_y))))))))))));
*/
                                  ...
                                  const SDouble ext_ident_double_159)
{
  ...
  const SDouble s7 = ext_ident_double_146;
  const SDouble s8 = ext_ownship_position_y;
  const SDouble s9 = ext_intruder_position_y;
  const SDouble s10 = ext_ident_double_148;
  const SDouble s11 = ext_ident_double_147;
  const SDouble s12 = ext_ident_double_153;
  const SDouble s13 = ext_ident_double_150;
  const SDouble s14 = ext_ident_double_152;
  const SDouble s15 = ext_ident_double_151;
  const SDouble s16 = ext_ident_double_157;
  const SDouble s17 = ext_ident_double_154;
  const SDouble s18 = ext_ident_double_156;
  const SDouble s19 = ext_ident_double_155;
  const SDouble s20 = ext_ident_double_161;
  const SDouble s21 = ext_ident_double_158;
  const SDouble s22 = ext_ident_double_160;
  const SDouble s23 = ext_ident_double_159;
