...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_32) - (((ext_ident_double_33) * (ext_ident_double_34))))));
*/
...
{
  const SDouble s0 = ext_ident_double_32;
  const SDouble s1 = ext_ident_double_31;
  ...
  const SDouble s6 = ext_ident_double_33;
  ...
  const SDouble s11 = ext_ident_double_34;
