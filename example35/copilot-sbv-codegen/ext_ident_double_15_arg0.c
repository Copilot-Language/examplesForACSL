/* File: "ext_ident_double_15_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((((ext_ownship_velocity_x) - (ext_intruder_velocity_x))) == (0.0))) && (((((ext_ownship_velocity_y) - (ext_intruder_velocity_y))) == (0.0))))) ? (0.0) : (((((0.0) - (ext_ident_double_12))) / (ext_ident_double_14))))));
*/
                                 ...
                                 const SDouble ext_ident_double_13)
{
  ...
  const SDouble s4 = ext_ident_double_12;
  ...
  const SDouble s9 = ext_ident_double_14;
  const SDouble s10 = ext_ident_double_13;
