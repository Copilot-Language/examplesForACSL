...
/*@
 assigns \nothing;
 ensures \result == ((ext_ident_double_20));
*/
                                 ...
                                 const SDouble ext_ident_double_17)
{
  ...
  const SDouble s3 = ext_ident_double_7;
  ...
  const SDouble s8 = ext_ident_double_4;
  const SDouble s9 = ext_ownship_position_y;
  const SDouble s10 = ext_intruder_position_y;
  const SDouble s11 = ext_ident_double_6;
  const SDouble s12 = ext_ident_double_5;
  const SDouble s13 = ext_ident_double_11;
  const SDouble s14 = ext_ident_double_8;
  const SDouble s15 = ext_ident_double_10;
  const SDouble s16 = ext_ident_double_9;
  const SDouble s17 = ext_ident_double_15;
  const SDouble s18 = ext_ident_double_12;
  const SDouble s19 = ext_ident_double_14;
  const SDouble s20 = ext_ident_double_13;
  const SDouble s21 = ext_ident_double_19;
  const SDouble s22 = ext_ident_double_16;
  const SDouble s23 = ext_ident_double_18;
  const SDouble s24 = ext_ident_double_17;
