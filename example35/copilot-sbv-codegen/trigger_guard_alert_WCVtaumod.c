...
/*@
 assigns \nothing;
 ensures \result == (ext_ident_bool_103);
*/
                                    ...
                                    const SDouble ext_ident_double_101)
{
  ...
  const SBool   s1 = ext_ident_bool_98;
  const SDouble s2 = ext_ident_double_67;
  const SDouble s3 = ext_sqrt_66;
  ...
  const SDouble s10 = ext_ident_double_87;
  const SDouble s11 = ext_sqrt_86;
  const SDouble s12 = ext_ident_double_85;
  const SDouble s13 = ext_ident_double_84;
  ...
  const SDouble s19 = ext_ident_double_68;
  const SDouble s20 = ext_ident_double_70;
  const SDouble s21 = ext_ident_double_69;
  const SDouble s22 = ext_ident_double_75;
  const SDouble s23 = ext_ident_double_72;
  const SDouble s24 = ext_ident_double_74;
  const SDouble s25 = ext_ident_double_73;
  const SDouble s26 = ext_ident_double_79;
  const SDouble s27 = ext_ident_double_76;
  const SDouble s28 = ext_ident_double_78;
  const SDouble s29 = ext_ident_double_77;
  const SDouble s30 = ext_ident_double_83;
  const SDouble s31 = ext_ident_double_80;
  const SDouble s32 = ext_ident_double_82;
  const SDouble s33 = ext_ident_double_81;
  const SDouble s34 = ext_ident_double_92;
  const SDouble s35 = ext_ident_double_88;
  const SDouble s36 = ext_ident_double_90;
  const SDouble s37 = ext_ident_double_89;
  const SDouble s38 = ext_ident_double_91;
  const SDouble s39 = ext_ident_double_97;
  const SDouble s40 = ext_ident_double_93;
  const SDouble s41 = ext_ident_double_95;
  const SDouble s42 = ext_ident_double_94;
  const SDouble s43 = ext_ident_double_96;
  const SBool   s44 = ext_ident_bool_102;
  const SDouble s45 = ext_ownship_position_z;
  const SDouble s46 = ext_intruder_position_z;
  const SDouble s47 = ext_ident_double_99;
  const SDouble s48 = ext_ident_double_100;
  const SDouble s49 = ext_ownship_velocity_z;
  const SDouble s50 = ext_intruder_velocity_z;
  const SDouble s51 = ext_ident_double_101;
  return s0;
}
