...
27 -> 28
29 [label="ext_sqrt_5",color=cyan4, style=filled]
28 -> 29
...
269 -> 270
271 [label="label: ?taumod",color=plum, style=filled]
269 -> 271
...
291 -> 292
293 [label="const: 3429904.0",color=red1, style=filled]
292 -> 293
...
268 -> 328
329 [label="label: ?taumod",color=plum, style=filled]
328 -> 329
...
349 -> 350
351 [label="const: 3429904.0",color=red1, style=filled]
350 -> 351
                                    ...
                                    const SDouble ext_intruder_velocity_z)
{
  ...
  const SDouble s31 = s23 * s23;
  const SDouble s32 = s30 + s31;
  const SDouble s33 = s32 /* ?scalar2dim */;
  const SDouble s34 = s33 /* ?normsq2dim */;
  const SDouble s35 = 3429904.0 - s34;
  const SDouble s36 = s35 / s27;
  const SDouble s38 = s28 ? s36 : -1.0;
  const SDouble s39 = s38 /* ?taumod */;
  ...
  const SDouble s56 = s53 ? s55 : -1.0;
  const SDouble s57 = s56 /* ?tcoa */;
  const SBool   s58 = 0.0 <= s57;
  const SBool   s59 = s57 <= 30.0;
  const SBool   s60 = s58 && s59;
  const SBool   s61 = s50 || s60;
  const SBool   s62 = s61 /* ?verticalWCV */;
  const SBool   s63 = s46 && s62;
  const SBool   s64 = s63 /* ?wellClearViolation */;
