/* File: "ext_ident_double_115_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((((ext_ownship_velocity_x) - (ext_intruder_velocity_x))) == (0.0))) && (((((ext_ownship_velocity_y) - (ext_intruder_velocity_y))) == (0.0))))) ? (0.0) : (((((0.0) - (ext_ident_double_112))) / (ext_ident_double_114))))));
*/
                                  ...
                                  const SDouble ext_ident_double_113)
{
  ...
  const SDouble s4 = ext_ident_double_112;
  ...
  const SDouble s10 = ext_ident_double_113;
