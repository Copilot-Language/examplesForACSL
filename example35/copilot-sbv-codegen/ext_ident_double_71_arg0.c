/* File: "ext_ident_double_71_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((((ext_ownship_velocity_x) - (ext_intruder_velocity_x))) == (0.0))) && (((((ext_ownship_velocity_y) - (ext_intruder_velocity_y))) == (0.0))))) ? (0.0) : (((((0.0) - (ext_ident_double_68))) / (ext_ident_double_70))))));
*/
                                 ...
                                 const SDouble ext_ident_double_69)
{
  ...
  const SDouble s4 = ext_ident_double_68;
  ...
  const SDouble s9 = ext_ident_double_70;
  const SDouble s10 = ext_ident_double_69;
