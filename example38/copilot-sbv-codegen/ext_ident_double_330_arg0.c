/* File: "ext_ident_double_330_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((((ext_ident_double_322) - (ext_ident_double_323))) * (((ext_ident_double_324) - (ext_ident_double_325))))) < (0.0))) ? (((((0.0) - (((ext_ident_double_326) - (ext_ident_double_327))))) / (((ext_ident_double_328) - (ext_ident_double_329))))) : (-1.0))));
*/
...
{
  const SDouble s0 = ext_ident_double_322;
  const SDouble s2 = ext_ident_double_323;
  const SDouble s4 = ext_ident_double_324;
  const SDouble s6 = ext_ident_double_325;
  const SDouble s8 = ext_ident_double_326;
  const SDouble s9 = ext_ident_double_327;
  const SDouble s10 = ext_ident_double_328;
  const SDouble s11 = ext_ident_double_329;
