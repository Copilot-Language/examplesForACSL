...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_903) - (ext_ident_double_904))) * (((ext_ident_double_905) - (ext_ident_double_906))))) + (((((ext_ident_double_907) - (ext_ident_double_908))) * (((ext_ident_double_909) - (ext_ident_double_910))))))));
*/
                                  ...
                                  const SDouble ext_ident_double_910)
{
  ...
  const SDouble s2 = ext_ident_double_904;
  const SDouble s4 = ext_ident_double_905;
  const SDouble s5 = ext_ident_double_906;
  const SDouble s6 = ext_ident_double_907;
  const SDouble s7 = ext_ident_double_908;
  const SDouble s9 = ext_ident_double_909;
  const SDouble s10 = ext_ident_double_910;
