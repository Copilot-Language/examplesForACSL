/* File: "ext_ident_bool_316_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ident_double_11) <= (ext_ident_double_12))) || (((((ext_ident_double_128) <= (ext_ident_double_129))) && (((((0.0) <= (ext_ident_double_222))) && (((ext_ident_double_315) <= (30.0))))))))));
*/
                              ...
                              const SDouble ext_ident_double_311)
{
  ...
  const SDouble s15 = ext_ident_double_12;
  const SDouble s16 = ext_ident_double_128;
  const SDouble s136 = ext_ident_double_129;
  const SDouble s137 = ext_ident_double_222;
  const SDouble s230 = ext_ident_double_315;
  const SBool   s323 = s0 <= s15;
  const SBool   s324 = s16 <= s136;
  const SBool   s326 = 0.0 <= s137;
  const SBool   s328 = s230 <= 30.0;
  const SBool   s329 = s326 && s328;
  const SBool   s330 = s324 && s329;
  const SBool   s331 = s323 || s330;
  const SBool   s332 = s331 /* horizontalWCV */;
