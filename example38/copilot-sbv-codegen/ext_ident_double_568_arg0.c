/* File: "ext_ident_double_568_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_560) - (ext_ident_double_561))) * (((ext_ident_double_562) - (ext_ident_double_563))))) + (((((ext_ident_double_564) - (ext_ident_double_565))) * (((ext_ident_double_566) - (ext_ident_double_567))))))));
*/
...
{
  const SDouble s0 = ext_ident_double_560;
  const SDouble s2 = ext_ident_double_561;
  const SDouble s4 = ext_ident_double_562;
  const SDouble s5 = ext_ident_double_563;
  const SDouble s6 = ext_ident_double_564;
  const SDouble s7 = ext_ident_double_565;
  const SDouble s9 = ext_ident_double_566;
  const SDouble s10 = ext_ident_double_567;
