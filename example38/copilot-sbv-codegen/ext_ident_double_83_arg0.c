/* File: "ext_ident_double_83_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_75) - (ext_ident_double_76))) * (((ext_ident_double_77) - (ext_ident_double_78))))) + (((((ext_ident_double_79) - (ext_ident_double_80))) * (((ext_ident_double_81) - (ext_ident_double_82))))))));
*/
                                 ...
                                 const SDouble ext_ident_double_82, const SDouble ext_intruder_vy)
{
  ...
  const SDouble s2 = ext_ident_double_76;
  const SDouble s4 = ext_ident_double_77;
  const SDouble s6 = ext_ident_double_78;
  const SDouble s8 = ext_ident_double_79;
  const SDouble s9 = ext_ident_double_80;
  const SDouble s11 = ext_ident_double_81;
