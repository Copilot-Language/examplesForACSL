/* File: "ext_ident_double_261_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_253) - (ext_ident_double_254))) * (((ext_ident_double_255) - (ext_ident_double_256))))) - (((((ext_ident_double_257) - (ext_ident_double_258))) * (((ext_ident_double_259) - (ext_ident_double_260))))))));
*/
                                  ...
                                  const SDouble ext_intruder_y_position_ft)
{
  ...
  const SDouble s2 = ext_ident_double_254;
  const SDouble s4 = ext_ident_double_255;
  const SDouble s6 = ext_ident_double_256;
  const SDouble s8 = ext_ident_double_257;
  const SDouble s10 = ext_ident_double_258;
  const SDouble s12 = ext_ident_double_259;
  const SDouble s13 = ext_ident_double_260;
