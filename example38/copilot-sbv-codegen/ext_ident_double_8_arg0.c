/* File: "ext_ident_double_8_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_0) - (ext_ident_double_1))) * (((ext_ident_double_2) - (ext_ident_double_3))))) + (((((ext_ident_double_4) - (ext_ident_double_5))) * (((ext_ident_double_6) - (ext_ident_double_7))))))));
*/
                                ...
                                const SDouble ext_ident_double_6, const SDouble ext_ident_double_7)
{
  ...
  const SDouble s4 = ext_ident_double_2;
  const SDouble s5 = ext_ident_double_3;
  const SDouble s6 = ext_ident_double_4;
  const SDouble s7 = ext_ident_double_5;
  const SDouble s9 = ext_ident_double_6;
  const SDouble s10 = ext_ident_double_7;
