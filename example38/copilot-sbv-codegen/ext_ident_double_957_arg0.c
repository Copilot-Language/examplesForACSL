...
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ident_double_955) - (ext_ident_double_956))) > 0)? 1 : ((((ext_ident_double_955) - (ext_ident_double_956))) < 0 ? -1 : (((ext_ident_double_955) - (ext_ident_double_956))))));
*/
...
{
  const SDouble s0 = ext_ident_double_955;
  const SDouble s2 = ext_ident_double_956;
