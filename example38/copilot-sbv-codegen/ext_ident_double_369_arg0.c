...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_361) - (ext_ident_double_362))) * (((ext_ident_double_363) - (ext_ident_double_364))))) + (((((ext_ident_double_365) - (ext_ident_double_366))) * (((ext_ident_double_367) - (ext_ident_double_368))))))));
*/
SDouble ext_ident_double_369_arg0(const SDouble ext_ident_double_361,
                                  ...
                                  const SDouble ext_ident_double_368, const SDouble ext_intruder_vy)
{
  const SDouble s0 = ext_ident_double_361;
  const SDouble s2 = ext_ident_double_362;
  const SDouble s4 = ext_ident_double_363;
  const SDouble s6 = ext_ident_double_364;
  const SDouble s8 = ext_ident_double_365;
  const SDouble s9 = ext_ident_double_366;
  const SDouble s11 = ext_ident_double_367;
  const SDouble s13 = ext_ident_double_368;
