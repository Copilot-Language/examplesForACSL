...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_151) - (ext_ident_double_152))) * (((ext_ident_double_153) - (ext_ident_double_154))))) - (((((ext_ident_double_155) - (ext_ident_double_156))) * (((ext_ident_double_157) - (ext_ident_double_158))))))));
*/
...
{
  const SDouble s0 = ext_ident_double_151;
  const SDouble s2 = ext_ident_double_152;
  const SDouble s4 = ext_ident_double_153;
  const SDouble s6 = ext_ident_double_154;
  const SDouble s8 = ext_ident_double_155;
  const SDouble s10 = ext_ident_double_156;
