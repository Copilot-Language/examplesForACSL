...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_141) - (ext_ident_double_142))) * (((ext_ident_double_143) - (ext_ident_double_144))))) + (((((ext_ident_double_145) - (ext_ident_double_146))) * (((ext_ident_double_147) - (ext_ident_double_148))))))));
*/
                                  ...
                                  const SDouble ext_ident_double_148)
{
  ...
  const SDouble s2 = ext_ident_double_142;
  const SDouble s4 = ext_ident_double_143;
  const SDouble s5 = ext_ident_double_144;
  const SDouble s6 = ext_ident_double_145;
  const SDouble s8 = ext_ident_double_146;
  const SDouble s10 = ext_ident_double_147;
