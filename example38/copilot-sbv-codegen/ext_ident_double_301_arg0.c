/* File: "ext_ident_double_301_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_293) - (ext_ident_double_294))) * (((ext_ident_double_295) - (ext_ident_double_296))))) - (((((ext_ident_double_297) - (ext_ident_double_298))) * (((ext_ident_double_299) - (ext_ident_double_300))))))));
*/
                                  ...
                                  const SDouble ext_intruder_y_position_ft)
{
  ...
  const SDouble s4 = ext_ident_double_295;
  const SDouble s6 = ext_ident_double_296;
  const SDouble s8 = ext_ident_double_297;
  const SDouble s10 = ext_ident_double_298;
  const SDouble s12 = ext_ident_double_299;
  const SDouble s13 = ext_ident_double_300;
