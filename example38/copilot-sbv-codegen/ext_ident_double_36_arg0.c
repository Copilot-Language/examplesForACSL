...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_28) - (ext_ident_double_29))) * (((ext_ident_double_30) - (ext_ident_double_31))))) + (((((ext_ident_double_32) - (ext_ident_double_33))) * (((ext_ident_double_34) - (ext_ident_double_35))))))));
*/
                                 ...
                                 const SDouble ext_ident_double_35)
{
  ...
  const SDouble s2 = ext_ident_double_29;
  const SDouble s4 = ext_ident_double_30;
  const SDouble s5 = ext_ident_double_31;
  const SDouble s6 = ext_ident_double_32;
  const SDouble s8 = ext_ident_double_33;
  const SDouble s10 = ext_ident_double_34;
  const SDouble s11 = ext_ident_double_35;
