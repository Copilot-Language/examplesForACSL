...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_103) - (ext_ident_double_104))) * (((ext_ident_double_105) - (ext_ident_double_106))))) + (((((ext_ident_double_107) - (ext_ident_double_108))) * (((ext_ident_double_109) - (ext_ident_double_110))))))));
*/
SDouble ext_ident_double_111_arg0(const SDouble ext_ident_double_103,
                                  ...
                                  const SDouble ext_ident_double_110, const SDouble ext_intruder_vy)
{
  const SDouble s0 = ext_ident_double_103;
  const SDouble s2 = ext_ident_double_104;
  const SDouble s4 = ext_ident_double_105;
  const SDouble s6 = ext_ident_double_106;
  const SDouble s8 = ext_ident_double_107;
