...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_160) - (ext_ident_double_161))) * (((ext_ident_double_162) - (ext_ident_double_163))))) - (((((ext_ident_double_164) - (ext_ident_double_165))) * (((ext_ident_double_166) - (ext_ident_double_167))))))));
*/
                                  ...
                                  const SDouble ext_intruder_y_position_ft)
{
  ...
  const SDouble s2 = ext_ident_double_161;
  const SDouble s4 = ext_ident_double_162;
  const SDouble s6 = ext_ident_double_163;
  const SDouble s8 = ext_ident_double_164;
  const SDouble s10 = ext_ident_double_165;
  const SDouble s12 = ext_ident_double_166;
