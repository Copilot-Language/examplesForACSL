...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_263) - (ext_ident_double_264))) * (((ext_ident_double_265) - (ext_ident_double_266))))) + (((((ext_ident_double_267) - (ext_ident_double_268))) * (((ext_ident_double_269) - (ext_ident_double_270))))))));
*/
...
{
  const SDouble s0 = ext_ident_double_263;
  const SDouble s2 = ext_ident_double_264;
  const SDouble s4 = ext_ident_double_265;
  const SDouble s6 = ext_ident_double_266;
  const SDouble s8 = ext_ident_double_267;
  const SDouble s9 = ext_ident_double_268;
  const SDouble s11 = ext_ident_double_269;
  const SDouble s13 = ext_ident_double_270;
