...
936 -> 937
938 [label="ext_ownship_x_position_ft",color=cyan1, style=filled]
937 -> 938
                                  ...
                                  const SDouble ext_ownship_vz, const SDouble ext_intruder_vz)
{
  ...
  const SDouble s20 = s5 * 0.3048;
  const SDouble s22 = s20 / 1.0;
  const SDouble s23 = s22 /* ?ownVelocityX */;
  const SDouble s24 = s6 * 0.3048;
  const SDouble s25 = s24 / 1.0;
  const SDouble s26 = s25 /* ?intVelocityX */;
  const SDouble s27 = s23 - s26;
  const SBool   s28 = 0.0 == s27;
  const SDouble s29 = s7 * 0.3048;
  const SDouble s30 = s29 / 1.0;
  const SDouble s31 = s30 /* ?ownVelocityY */;
  const SDouble s32 = s8 * 0.3048;
  const SDouble s33 = s32 / 1.0;
  const SDouble s34 = s33 /* ?intVelocityY */;
  const SDouble s35 = s31 - s34;
  const SBool   s36 = 0.0 == s35;
  const SBool   s37 = s28 && s36;
  const SDouble s38 = s1 * 0.3048;
  const SDouble s39 = s38 /* ?ownPositionX */;
  const SDouble s40 = s2 * 0.3048;
  const SDouble s41 = s40 /* ?intPositionX */;
  const SDouble s42 = s39 - s41;
  const SDouble s43 = s27 * s42;
  const SDouble s44 = s38 /* ?ownPositionY */;
  const SDouble s45 = s3 * 0.3048;
  const SDouble s46 = s45 /* ?intPositionY */;
  const SDouble s47 = s44 - s46;
  const SDouble s48 = s35 * s47;
  const SDouble s49 = s43 + s48;
  const SDouble s50 = s49 /* ?scalar2dim */;
  const SDouble s51 = 0.0 - s50;
  const SDouble s52 = s27 * s27;
  const SDouble s53 = s35 * s35;
  const SDouble s54 = s52 + s53;
  const SDouble s55 = s54 /* ?scalar2dim */;
  const SDouble s56 = s55 /* ?normsq2dim */;
  const SDouble s57 = s51 / s56;
  const SDouble s58 = s37 ? 0.0 : s57;
  const SDouble s59 = s58 /* ?tcpa */;
