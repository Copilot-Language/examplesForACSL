                        ...
                        const SDouble ext_tan_6)
{
  ...
  const SDouble s2 = ext_log_1;
  const SDouble s5 = ext_log_3;
  const SDouble s8 = ext_log_5;
  const SDouble s10 = ext_log_7;
