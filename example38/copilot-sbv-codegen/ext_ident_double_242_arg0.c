...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_234) - (ext_ident_double_235))) * (((ext_ident_double_236) - (ext_ident_double_237))))) + (((((ext_ident_double_238) - (ext_ident_double_239))) * (((ext_ident_double_240) - (ext_ident_double_241))))))));
*/
...
{
  const SDouble s0 = ext_ident_double_234;
  const SDouble s2 = ext_ident_double_235;
  const SDouble s4 = ext_ident_double_236;
  const SDouble s5 = ext_ident_double_237;
  const SDouble s6 = ext_ident_double_238;
  const SDouble s8 = ext_ident_double_239;
  const SDouble s10 = ext_ident_double_240;
  const SDouble s11 = ext_ident_double_241;
