/* File: "ext_sqrt_92_arg0.c". Automatically generated by SBV. Do not edit! */
                         ...
                         const SDouble ext_tan_90)
{
  ...
  const SDouble s2 = ext_log_85;
  const SDouble s5 = ext_log_87;
  const SDouble s8 = ext_log_89;
  const SDouble s10 = ext_log_91;
