...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_56) - (ext_ident_double_57))) * (((ext_ident_double_58) - (ext_ident_double_59))))) + (((((ext_ident_double_60) - (ext_ident_double_61))) * (((ext_ident_double_62) - (ext_ident_double_63))))))));
*/
...
{
  const SDouble s0 = ext_ident_double_56;
  const SDouble s2 = ext_ident_double_57;
  const SDouble s4 = ext_ident_double_58;
  const SDouble s5 = ext_ident_double_59;
  const SDouble s6 = ext_ident_double_60;
  const SDouble s8 = ext_ident_double_61;
