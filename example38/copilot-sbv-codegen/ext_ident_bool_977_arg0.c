/* File: "ext_ident_bool_977_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_bool_952) && (ext_ident_bool_976))));
*/
...
{
  const SBool   s0 = ext_ident_bool_952;
  const SBool   s196 = ext_ident_bool_976;
  const SBool   s224 = s0 && s196;
  const SBool   s225 = s224 /* wellClearViolation */;
