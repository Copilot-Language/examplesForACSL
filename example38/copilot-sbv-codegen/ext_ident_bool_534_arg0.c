/* File: "ext_ident_bool_534_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ident_double_353) <= (ext_ident_double_354))) || (((((ext_ident_double_470) <= (ext_ident_double_471))) && (((((0.0) <= (ext_ident_double_502))) && (((ext_ident_double_533) <= (30.0))))))))));
*/
                              ...
                              const SDouble ext_ident_double_531)
{
  ...
  const SDouble s16 = ext_ident_double_470;
  const SDouble s136 = ext_ident_double_471;
  const SDouble s137 = ext_ident_double_502;
  const SDouble s168 = ext_ident_double_533;
  const SBool   s199 = s0 <= s15;
  const SBool   s200 = s16 <= s136;
  const SBool   s202 = 0.0 <= s137;
  const SBool   s204 = s168 <= 30.0;
  const SBool   s205 = s202 && s204;
  const SBool   s206 = s200 && s205;
  const SBool   s207 = s199 || s206;
  const SBool   s208 = s207 /* horizontalWCV */;
