...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_274) - (ext_ident_double_275))) * (((ext_ident_double_276) - (ext_ident_double_277))))) + (((((ext_ident_double_278) - (ext_ident_double_279))) * (((ext_ident_double_280) - (ext_ident_double_281))))))));
*/
...
{
  const SDouble s0 = ext_ident_double_274;
  const SDouble s2 = ext_ident_double_275;
  const SDouble s4 = ext_ident_double_276;
  const SDouble s5 = ext_ident_double_277;
  const SDouble s6 = ext_ident_double_278;
  const SDouble s8 = ext_ident_double_279;
  const SDouble s10 = ext_ident_double_280;
  const SDouble s11 = ext_ident_double_281;
