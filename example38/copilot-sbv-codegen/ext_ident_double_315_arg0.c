...
3 -> 4
5 [label="ext_ident_double_231",color=cyan4, style=filled]
4 -> 5
62 [label="const: 0.0",color=red1, style=filled]
4 -> 62
63 [label="op2: >=",color=green4, style=filled]
3 -> 63
64 [label="ext_ident_double_262",color=cyan4, style=filled]
63 -> 64
257 [label="const: 0.0",color=red1, style=filled]
63 -> 257
258 [label="ext_ident_double_314",color=cyan4, style=filled]
2 -> 258
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_231) < (0.0))) && (((ext_ident_double_262) >= (0.0))))) ? (ext_ident_double_314) : (-1.0))));
*/
...
{
  const SDouble s0 = ext_ident_double_231;
  const SDouble s16 = ext_ident_double_262;
  const SDouble s47 = ext_ident_double_314;
