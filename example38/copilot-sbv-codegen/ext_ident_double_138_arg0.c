...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_130) - (ext_ident_double_131))) * (((ext_ident_double_132) - (ext_ident_double_133))))) + (((((ext_ident_double_134) - (ext_ident_double_135))) * (((ext_ident_double_136) - (ext_ident_double_137))))))));
*/
...
{
  const SDouble s0 = ext_ident_double_130;
  const SDouble s2 = ext_ident_double_131;
  const SDouble s4 = ext_ident_double_132;
  const SDouble s6 = ext_ident_double_133;
  const SDouble s8 = ext_ident_double_134;
  const SDouble s9 = ext_ident_double_135;
  const SDouble s11 = ext_ident_double_136;
  const SDouble s13 = ext_ident_double_137;
