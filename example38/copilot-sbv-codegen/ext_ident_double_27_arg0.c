/* File: "ext_ident_double_27_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_19) - (ext_ident_double_20))) * (((ext_ident_double_21) - (ext_ident_double_22))))) + (((((ext_ident_double_23) - (ext_ident_double_24))) * (((ext_ident_double_25) - (ext_ident_double_26))))))));
*/
                                 ...
                                 const SDouble ext_ident_double_26, const SDouble ext_intruder_vy)
{
  ...
  const SDouble s4 = ext_ident_double_21;
  const SDouble s6 = ext_ident_double_22;
  const SDouble s8 = ext_ident_double_23;
  const SDouble s9 = ext_ident_double_24;
  const SDouble s11 = ext_ident_double_25;
  const SDouble s13 = ext_ident_double_26;
