...
812 -> 813
814 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
813 -> 814
...
821 -> 822
823 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
822 -> 823
...
856 -> 857
858 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
857 -> 858
...
909 -> 910
911 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
910 -> 911
...
962 -> 963
964 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
963 -> 964
...
971 -> 972
973 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
972 -> 973
...
1006 -> 1007
1008 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
1007 -> 1008
                                    ...
                                    const SDouble ext_ownship_vz, const SDouble ext_intruder_vz)
{
  ...
  const SDouble s52 = s25 * s25;
  const SDouble s53 = s39 * s39;
  const SDouble s54 = s52 + s53;
  const SDouble s55 = s54 /* ?scalar2dim */;
  const SDouble s56 = s55 /* ?normsq2dim */;
  const SDouble s57 = 3429904.0 - s56;
  const SDouble s58 = s57 / s49;
  const SDouble s60 = s50 ? s58 : -1.0;
  const SDouble s61 = s60 /* ?taumod */;
  ...
  const SDouble s88 = s85 ? s87 : -1.0;
  const SDouble s89 = s88 /* ?tcoa */;
  const SBool   s90 = 0.0 <= s89;
  const SBool   s91 = s89 <= 30.0;
  const SBool   s92 = s90 && s91;
  const SBool   s93 = s76 || s92;
  const SBool   s94 = s93 /* ?verticalWCV */;
  const SBool   s95 = s68 && s94;
  const SBool   s96 = s95 /* ?wellClearViolation */;
