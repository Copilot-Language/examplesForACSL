/* File: "ext_sqrt_158_arg0.c". Automatically generated by SBV. Do not edit! */
                          ...
                          const SDouble ext_tan_156)
{
  ...
  const SDouble s2 = ext_log_151;
  const SDouble s5 = ext_log_153;
  const SDouble s8 = ext_log_155;
  const SDouble s10 = ext_log_157;
