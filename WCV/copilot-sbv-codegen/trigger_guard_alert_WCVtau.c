...
759 -> 760
761 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
760 -> 761
...
808 -> 809
810 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
809 -> 810
...
817 -> 818
819 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
818 -> 819
...
852 -> 853
854 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
853 -> 854
...
905 -> 906
907 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
906 -> 907
...
954 -> 955
956 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
955 -> 956
...
963 -> 964
965 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
964 -> 965
...
998 -> 999
1000 [label="ext_ownship_y_position_ft",color=cyan1, style=filled]
999 -> 1000
                                 ...
                                 const SDouble ext_ownship_vz, const SDouble ext_intruder_vz)
{
  ...
  const SDouble s21 = s1 * 0.3048;
  const SDouble s22 = s21 /* ?ownPositionX */;
  const SDouble s23 = s2 * 0.3048;
  const SDouble s24 = s23 /* ?intPositionX */;
  const SDouble s25 = s22 - s24;
  const SDouble s26 = s6 * 0.3048;
  const SDouble s28 = s26 / 1.0;
  const SDouble s29 = s28 /* ?ownVelocityX */;
  const SDouble s30 = s7 * 0.3048;
  const SDouble s31 = s30 / 1.0;
  const SDouble s32 = s31 /* ?intVelocityX */;
  const SDouble s33 = s29 - s32;
  const SDouble s34 = s25 * s33;
  const SDouble s35 = s3 * 0.3048;
  const SDouble s36 = s35 /* ?ownPositionY */;
  const SDouble s37 = s4 * 0.3048;
  const SDouble s38 = s37 /* ?intPositionY */;
  const SDouble s39 = s36 - s38;
  const SDouble s40 = s8 * 0.3048;
  const SDouble s41 = s40 / 1.0;
  const SDouble s42 = s41 /* ?ownVelocityY */;
  const SDouble s43 = s9 * 0.3048;
  const SDouble s44 = s43 / 1.0;
  const SDouble s45 = s44 /* ?intVelocityY */;
  const SDouble s46 = s42 - s45;
  const SDouble s47 = s39 * s46;
  const SDouble s48 = s34 + s47;
  const SDouble s49 = s48 /* ?scalar2dim */;
  const SBool   s50 = s49 < 0.0;
  const SDouble s51 = s25 * s25;
  const SDouble s52 = s39 * s39;
  const SDouble s53 = s51 + s52;
  const SDouble s54 = s53 /* ?scalar2dim */;
  const SDouble s55 = s54 /* ?normsq2dim */;
  const SDouble s56 = 0.0 - s55;
  const SDouble s57 = s56 / s49;
  const SDouble s59 = s50 ? s57 : -1.0;
  const SDouble s60 = s59 /* ?tau */;
  const SBool   s61 = 0.0 <= s60;
  const SBool   s63 = s60 <= 30.0;
  const SBool   s64 = s61 && s63;
  const SBool   s65 = s18 && s64;
  const SBool   s66 = s16 || s65;
  const SBool   s67 = s66 /* ?horizontalWCV */;
  const SDouble s68 = s10 * 0.3048;
  const SDouble s69 = s68 /* ?ownPositionZ */;
  const SDouble s70 = s11 * 0.3048;
  const SDouble s71 = s70 /* ?intPositionZ */;
  const SDouble s72 = s69 - s71;
  const SDouble s73 = fabs(s72);
  const SBool   s75 = s73 <= 144.78;
  const SDouble s76 = s12 * 0.3048;
  const SDouble s77 = s76 / 1.0;
  const SDouble s78 = s77 /* ?ownVelocityZ */;
  const SDouble s79 = s13 * 0.3048;
  const SDouble s80 = s79 / 1.0;
  const SDouble s81 = s80 /* ?intVelocityZ */;
  const SDouble s82 = s78 - s81;
  const SDouble s83 = s72 * s82;
  const SBool   s84 = s83 < 0.0;
  const SDouble s85 = 0.0 - s72;
  const SDouble s86 = s85 / s82;
  const SDouble s87 = s84 ? s86 : -1.0;
  const SDouble s88 = s87 /* ?tcoa */;
  const SBool   s89 = 0.0 <= s88;
  const SBool   s90 = s88 <= 30.0;
  const SBool   s91 = s89 && s90;
  const SBool   s92 = s75 || s91;
  const SBool   s93 = s92 /* ?verticalWCV */;
  const SBool   s94 = s67 && s93;
  const SBool   s95 = s94 /* ?wellClearViolation */;
