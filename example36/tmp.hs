...
hmdRA sl = label "?hmdRA" $ 
  mux (sl == 2) (0*0.3048) $
  mux (sl == 3) (1215*0.3048) $
  mux (sl == 4) (2126*0.3048) $
  mux (sl == 5) (3342*0.3048) $
  mux (sl == 6) (4861*0.3048) $
  mux (sl == 7) (6683*0.3048) $
  mux (sl == 8) (6683*0.3048) $ 
  (0)
...
--  trigger "alert_WCVtep" (wellClearViolation tep relPositionX relPositionY relPositionZ relVelocityX relVelocityY relVelocityZ) []
  ...
  trigger "isCorrective" (isCorrective relPositionX relPositionY ownPositionZ intPositionZ relVelocityX relVelocityY ownVelocityZ intVelocityZ 2 700 (tauRA $ sensitivityLevel ownPositionZ) (dmodRA $ sensitivityLevel ownPositionZ)) []
