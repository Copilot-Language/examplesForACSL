/* File: "ext_ident_double_156_arg0.c". Automatically generated by SBV. Do not edit! */
...
3 -> 4
5 [label="ext_ident_double_155",color=cyan4, style=filled]
4 -> 5
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_155) <= (0.0))) || (((ext_ownship_velocity_z) >= (700.0))))) ? (0.0) : (((((700.0) - (ext_ownship_velocity_z))) / (2.0))))));
*/
...
{
  const SDouble s0 = ext_ident_double_155;
  ...
  const SDouble s10 = ext_ident_double_151;
  const SDouble s11 = ext_ident_double_142;
  const SWord64 s12 = ext_ident_word64_135;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_136;
  const SWord64 s15 = ext_ident_word64_137;
  const SWord64 s16 = ext_ident_word64_138;
  const SWord64 s17 = ext_ident_word64_139;
  const SWord64 s18 = ext_ident_word64_140;
  const SWord64 s19 = ext_ident_word64_141;
  const SDouble s20 = ext_ident_double_150;
  const SWord64 s21 = ext_ident_word64_143;
  const SWord64 s22 = ext_ident_word64_144;
  const SWord64 s23 = ext_ident_word64_145;
  const SWord64 s24 = ext_ident_word64_146;
  const SWord64 s25 = ext_ident_word64_147;
  const SWord64 s26 = ext_ident_word64_148;
  const SWord64 s27 = ext_ident_word64_149;
  const SDouble s28 = ext_ident_double_153;
  const SDouble s29 = ext_ident_double_152;
  const SDouble s30 = ext_ident_double_154;
