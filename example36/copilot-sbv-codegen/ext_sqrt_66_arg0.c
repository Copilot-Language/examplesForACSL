/* File: "ext_sqrt_66_arg0.c". Automatically generated by SBV. Do not edit! */
                         ...
                         const SDouble ext_ident_double_64)
{
  ...
  const SDouble s1 = ext_ident_double_52;
  const SWord64 s2 = ext_ident_word64_45;
  const SDouble s3 = ext_ownship_position_z;
  const SWord64 s4 = ext_ident_word64_46;
  const SWord64 s5 = ext_ident_word64_47;
  const SWord64 s6 = ext_ident_word64_48;
  const SWord64 s7 = ext_ident_word64_49;
  const SWord64 s8 = ext_ident_word64_50;
  const SWord64 s9 = ext_ident_word64_51;
  const SDouble s10 = ext_ident_double_60;
  const SWord64 s11 = ext_ident_word64_53;
  const SWord64 s12 = ext_ident_word64_54;
  const SWord64 s13 = ext_ident_word64_55;
  const SWord64 s14 = ext_ident_word64_56;
  const SWord64 s15 = ext_ident_word64_57;
  const SWord64 s16 = ext_ident_word64_58;
  const SWord64 s17 = ext_ident_word64_59;
  const SDouble s18 = ext_ident_double_62;
  const SDouble s19 = ext_ident_double_61;
  ...
  const SDouble s29 = ext_ident_double_64;
  return s0;
}
