/* File: "ext_ident_double_1351_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_double_1330",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_1347",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_1349",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_1350",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_1330) < (0.0))) ? (((((ext_ident_double_1347) - (ext_ident_double_1349))) / (ext_ident_double_1350))) : (-1.0))));
*/
SDouble ext_ident_double_1351_arg0(const SDouble ext_ident_double_1330,
...
{
  const SDouble s0 = ext_ident_double_1330;
  ...
  const SDouble s10 = ext_ident_double_1338;
  const SWord64 s11 = ext_ident_word64_1331;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_1332;
  const SWord64 s14 = ext_ident_word64_1333;
  const SWord64 s15 = ext_ident_word64_1334;
  const SWord64 s16 = ext_ident_word64_1335;
  const SWord64 s17 = ext_ident_word64_1336;
  const SWord64 s18 = ext_ident_word64_1337;
  const SDouble s19 = ext_ident_double_1346;
  const SWord64 s20 = ext_ident_word64_1339;
  const SWord64 s21 = ext_ident_word64_1340;
  const SWord64 s22 = ext_ident_word64_1341;
  const SWord64 s23 = ext_ident_word64_1342;
  const SWord64 s24 = ext_ident_word64_1343;
  const SWord64 s25 = ext_ident_word64_1344;
  const SWord64 s26 = ext_ident_word64_1345;
  const SDouble s27 = ext_ident_double_1349;
  const SDouble s28 = ext_ident_double_1348;
  const SDouble s29 = ext_ident_double_1350;
