/* File: "ext_ident_double_30_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_23) == (2))) ? (0.0) : (( (((ext_ident_word64_24) == (3))) ? (370.332) : (( (((ext_ident_word64_25) == (4))) ? (648.0048) : (( (((ext_ident_word64_26) == (5))) ? (1018.6416) : (( (((ext_ident_word64_27) == (6))) ? (1481.6328) : (( (((ext_ident_word64_28) == (7))) ? (2036.9784000000002) : (( (((ext_ident_word64_29) == (8))) ? (2036.9784000000002) : (0.0))))))))))))))));
*/
...
{
  const SWord64 s0 = ext_ident_word64_23;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_24;
  const SWord64 s3 = ext_ident_word64_25;
  const SWord64 s4 = ext_ident_word64_26;
  const SWord64 s5 = ext_ident_word64_27;
  const SWord64 s6 = ext_ident_word64_28;
  const SWord64 s7 = ext_ident_word64_29;
