...
2 -> 3
4 [label="ext_ident_word64_43",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_44",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_45",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_46",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_47",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_48",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_49",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_43) == (2))) ? (0.0) : (( (((ext_ident_word64_44) == (3))) ? (370.40000000000003) : (( (((ext_ident_word64_45) == (4))) ? (648.1999999999999) : (( (((ext_ident_word64_46) == (5))) ? (1018.6000000000001) : (( (((ext_ident_word64_47) == (6))) ? (1481.6000000000001) : (( (((ext_ident_word64_48) == (7))) ? (2037.2000000000003) : (( (((ext_ident_word64_49) == (8))) ? (2037.2000000000003) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_50_arg0(const SWord64 ext_ident_word64_43,
...
{
  const SWord64 s0 = ext_ident_word64_43;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_44;
  const SWord64 s3 = ext_ident_word64_45;
