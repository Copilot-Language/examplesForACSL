/* File: "ext_ident_double_865_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_double_844",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_861",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_863",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_864",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_844) < (0.0))) ? (((((ext_ident_double_861) - (ext_ident_double_863))) / (ext_ident_double_864))) : (-1.0))));
*/
SDouble ext_ident_double_865_arg0(const SDouble ext_ident_double_844,
...
{
  const SDouble s0 = ext_ident_double_844;
  ...
  const SDouble s9 = ext_ident_double_861;
  const SDouble s10 = ext_ident_double_852;
  const SWord64 s11 = ext_ident_word64_845;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_846;
  const SWord64 s14 = ext_ident_word64_847;
  const SWord64 s15 = ext_ident_word64_848;
  const SWord64 s16 = ext_ident_word64_849;
  const SWord64 s17 = ext_ident_word64_850;
  const SWord64 s18 = ext_ident_word64_851;
  const SDouble s19 = ext_ident_double_860;
  const SWord64 s20 = ext_ident_word64_853;
  const SWord64 s21 = ext_ident_word64_854;
  const SWord64 s22 = ext_ident_word64_855;
  const SWord64 s23 = ext_ident_word64_856;
  const SWord64 s24 = ext_ident_word64_857;
  const SWord64 s25 = ext_ident_word64_858;
  const SWord64 s26 = ext_ident_word64_859;
  const SDouble s27 = ext_ident_double_863;
  const SDouble s28 = ext_ident_double_862;
  const SDouble s29 = ext_ident_double_864;
