...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_4) == (2))) ? (0.0) : (( (((ext_ident_word64_5) == (3))) ? (370.332) : (( (((ext_ident_word64_6) == (4))) ? (648.0048) : (( (((ext_ident_word64_7) == (5))) ? (1018.6416) : (( (((ext_ident_word64_8) == (6))) ? (1481.6328) : (( (((ext_ident_word64_9) == (7))) ? (2036.9784000000002) : (( (((ext_ident_word64_10) == (8))) ? (2036.9784000000002) : (0.0))))))))))))))));
*/
...
{
  const SWord64 s0 = ext_ident_word64_4;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_5;
  const SWord64 s3 = ext_ident_word64_6;
  const SWord64 s4 = ext_ident_word64_7;
  const SWord64 s5 = ext_ident_word64_8;
  const SWord64 s6 = ext_ident_word64_9;
  const SWord64 s7 = ext_ident_word64_10;
