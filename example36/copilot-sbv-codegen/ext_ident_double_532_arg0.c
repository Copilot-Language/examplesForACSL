...
22 -> 23
24 [label="ext_ident_double_528",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_530",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_531",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_511) < (0.0))) ? (((((ext_ident_double_528) - (ext_ident_double_530))) / (ext_ident_double_531))) : (-1.0))));
*/
SDouble ext_ident_double_532_arg0(const SDouble ext_ident_double_511,
                                  ...
                                  const SDouble ext_ident_double_531)
{
  ...
  const SDouble s9 = ext_ident_double_528;
  const SDouble s10 = ext_ident_double_519;
  const SWord64 s11 = ext_ident_word64_512;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_513;
  const SWord64 s14 = ext_ident_word64_514;
  const SWord64 s15 = ext_ident_word64_515;
  const SWord64 s16 = ext_ident_word64_516;
  const SWord64 s17 = ext_ident_word64_517;
  const SWord64 s18 = ext_ident_word64_518;
  const SDouble s19 = ext_ident_double_527;
  const SWord64 s20 = ext_ident_word64_520;
  const SWord64 s21 = ext_ident_word64_521;
  const SWord64 s22 = ext_ident_word64_522;
  const SWord64 s23 = ext_ident_word64_523;
  const SWord64 s24 = ext_ident_word64_524;
  const SWord64 s25 = ext_ident_word64_525;
  const SWord64 s26 = ext_ident_word64_526;
  const SDouble s27 = ext_ident_double_530;
  const SDouble s28 = ext_ident_double_529;
  const SDouble s29 = ext_ident_double_531;
