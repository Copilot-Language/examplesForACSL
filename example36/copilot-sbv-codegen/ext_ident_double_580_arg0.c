/* File: "ext_ident_double_580_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_579) <= (0.0))) || (((((-1.0) * (ext_ownship_velocity_z))) >= (700.0))))) ? (0.0) : (((((-700.0) - (ext_ownship_velocity_z))) / (-2.0))))));
*/
SDouble ext_ident_double_580_arg0(const SDouble ext_ident_double_579,
...
{
  const SDouble s0 = ext_ident_double_579;
  const SDouble s1 = ext_ident_double_558;
  ...
  const SDouble s10 = ext_ident_double_575;
  const SDouble s11 = ext_ident_double_566;
  const SWord64 s12 = ext_ident_word64_559;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_560;
  const SWord64 s15 = ext_ident_word64_561;
  const SWord64 s16 = ext_ident_word64_562;
  const SWord64 s17 = ext_ident_word64_563;
  const SWord64 s18 = ext_ident_word64_564;
  const SWord64 s19 = ext_ident_word64_565;
  const SDouble s20 = ext_ident_double_574;
  const SWord64 s21 = ext_ident_word64_567;
  const SWord64 s22 = ext_ident_word64_568;
  const SWord64 s23 = ext_ident_word64_569;
  const SWord64 s24 = ext_ident_word64_570;
  const SWord64 s25 = ext_ident_word64_571;
  const SWord64 s26 = ext_ident_word64_572;
  const SWord64 s27 = ext_ident_word64_573;
  const SDouble s28 = ext_ident_double_577;
  const SDouble s29 = ext_ident_double_576;
  const SDouble s30 = ext_ident_double_578;
