/* File: "ext_ident_double_1419_arg0.c". Automatically generated by SBV. Do not edit! */
...
3 -> 4
5 [label="ext_ident_double_1418",color=cyan4, style=filled]
4 -> 5
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_1418) <= (0.0))) || (((((-1.0) * (ext_ownship_velocity_z))) >= (700.0))))) ? (0.0) : (((((-700.0) - (ext_ownship_velocity_z))) / (-2.0))))));
*/
SDouble ext_ident_double_1419_arg0(const SDouble ext_ident_double_1418,
...
{
  const SDouble s0 = ext_ident_double_1418;
  const SDouble s1 = ext_ident_double_1397;
  ...
  const SDouble s10 = ext_ident_double_1414;
  const SDouble s11 = ext_ident_double_1405;
  const SWord64 s12 = ext_ident_word64_1398;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_1399;
  const SWord64 s15 = ext_ident_word64_1400;
  const SWord64 s16 = ext_ident_word64_1401;
  const SWord64 s17 = ext_ident_word64_1402;
  const SWord64 s18 = ext_ident_word64_1403;
  const SWord64 s19 = ext_ident_word64_1404;
  const SDouble s20 = ext_ident_double_1413;
  const SWord64 s21 = ext_ident_word64_1406;
  const SWord64 s22 = ext_ident_word64_1407;
  const SWord64 s23 = ext_ident_word64_1408;
  const SWord64 s24 = ext_ident_word64_1409;
  const SWord64 s25 = ext_ident_word64_1410;
  const SWord64 s26 = ext_ident_word64_1411;
  const SWord64 s27 = ext_ident_word64_1412;
  const SDouble s28 = ext_ident_double_1416;
  const SDouble s29 = ext_ident_double_1415;
  const SDouble s30 = ext_ident_double_1417;
