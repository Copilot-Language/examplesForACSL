...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_65) < (0.0))) ? (((((ext_ident_double_82) - (ext_ident_double_84))) / (ext_ident_double_85))) : (-1.0))));
*/
SDouble ext_ident_double_86_arg0(const SDouble ext_ident_double_65,
                                 ...
                                 const SDouble ext_ident_double_85)
{
  ...
  const SDouble s9 = ext_ident_double_82;
  const SDouble s10 = ext_ident_double_73;
  const SWord64 s11 = ext_ident_word64_66;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_67;
  const SWord64 s14 = ext_ident_word64_68;
  const SWord64 s15 = ext_ident_word64_69;
  const SWord64 s16 = ext_ident_word64_70;
  const SWord64 s17 = ext_ident_word64_71;
  const SWord64 s18 = ext_ident_word64_72;
  const SDouble s19 = ext_ident_double_81;
  const SWord64 s20 = ext_ident_word64_74;
  const SWord64 s21 = ext_ident_word64_75;
  const SWord64 s22 = ext_ident_word64_76;
  const SWord64 s23 = ext_ident_word64_77;
  const SWord64 s24 = ext_ident_word64_78;
  const SWord64 s25 = ext_ident_word64_79;
  const SWord64 s26 = ext_ident_word64_80;
  const SDouble s27 = ext_ident_double_84;
