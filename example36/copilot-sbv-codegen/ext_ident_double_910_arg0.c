/* File: "ext_ident_double_910_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_double_889",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_906",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_908",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_909",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_889) < (0.0))) ? (((((ext_ident_double_906) - (ext_ident_double_908))) / (ext_ident_double_909))) : (-1.0))));
*/
SDouble ext_ident_double_910_arg0(const SDouble ext_ident_double_889,
                                  ...
                                  const SDouble ext_ident_double_909)
{
  ...
  const SDouble s9 = ext_ident_double_906;
  const SDouble s10 = ext_ident_double_897;
  const SWord64 s11 = ext_ident_word64_890;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_891;
  const SWord64 s14 = ext_ident_word64_892;
  const SWord64 s15 = ext_ident_word64_893;
  const SWord64 s16 = ext_ident_word64_894;
  const SWord64 s17 = ext_ident_word64_895;
  const SWord64 s18 = ext_ident_word64_896;
  const SDouble s19 = ext_ident_double_905;
  const SWord64 s20 = ext_ident_word64_898;
  const SWord64 s21 = ext_ident_word64_899;
  const SWord64 s22 = ext_ident_word64_900;
  const SWord64 s23 = ext_ident_word64_901;
  const SWord64 s24 = ext_ident_word64_902;
  const SWord64 s25 = ext_ident_word64_903;
  const SWord64 s26 = ext_ident_word64_904;
  const SDouble s27 = ext_ident_double_908;
  const SDouble s28 = ext_ident_double_907;
  const SDouble s29 = ext_ident_double_909;
