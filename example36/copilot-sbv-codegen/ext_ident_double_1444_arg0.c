/* File: "ext_ident_double_1444_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_double_1423",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_1440",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_1442",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_1443",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_1423) < (0.0))) ? (((((ext_ident_double_1440) - (ext_ident_double_1442))) / (ext_ident_double_1443))) : (-1.0))));
*/
SDouble ext_ident_double_1444_arg0(const SDouble ext_ident_double_1423,
...
{
  const SDouble s0 = ext_ident_double_1423;
  ...
  const SDouble s9 = ext_ident_double_1440;
  const SDouble s10 = ext_ident_double_1431;
  const SWord64 s11 = ext_ident_word64_1424;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_1425;
  const SWord64 s14 = ext_ident_word64_1426;
  const SWord64 s15 = ext_ident_word64_1427;
  const SWord64 s16 = ext_ident_word64_1428;
  const SWord64 s17 = ext_ident_word64_1429;
  const SWord64 s18 = ext_ident_word64_1430;
  const SDouble s19 = ext_ident_double_1439;
  const SWord64 s20 = ext_ident_word64_1432;
  const SWord64 s21 = ext_ident_word64_1433;
  const SWord64 s22 = ext_ident_word64_1434;
  const SWord64 s23 = ext_ident_word64_1435;
  const SWord64 s24 = ext_ident_word64_1436;
  const SWord64 s25 = ext_ident_word64_1437;
  const SWord64 s26 = ext_ident_word64_1438;
  const SDouble s27 = ext_ident_double_1442;
  const SDouble s28 = ext_ident_double_1441;
  const SDouble s29 = ext_ident_double_1443;
