/* File: "ext_ident_double_1418_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_double_1397",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_1414",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_1416",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_1417",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_1397) < (0.0))) ? (((((ext_ident_double_1414) - (ext_ident_double_1416))) / (ext_ident_double_1417))) : (-1.0))));
*/
SDouble ext_ident_double_1418_arg0(const SDouble ext_ident_double_1397,
...
{
  const SDouble s0 = ext_ident_double_1397;
  ...
  const SDouble s9 = ext_ident_double_1414;
  const SDouble s10 = ext_ident_double_1405;
  const SWord64 s11 = ext_ident_word64_1398;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_1399;
  const SWord64 s14 = ext_ident_word64_1400;
  const SWord64 s15 = ext_ident_word64_1401;
  const SWord64 s16 = ext_ident_word64_1402;
  const SWord64 s17 = ext_ident_word64_1403;
  const SWord64 s18 = ext_ident_word64_1404;
  const SDouble s19 = ext_ident_double_1413;
  const SWord64 s20 = ext_ident_word64_1406;
  const SWord64 s21 = ext_ident_word64_1407;
  const SWord64 s22 = ext_ident_word64_1408;
  const SWord64 s23 = ext_ident_word64_1409;
  const SWord64 s24 = ext_ident_word64_1410;
  const SWord64 s25 = ext_ident_word64_1411;
  const SWord64 s26 = ext_ident_word64_1412;
  const SDouble s27 = ext_ident_double_1416;
  const SDouble s28 = ext_ident_double_1415;
  const SDouble s29 = ext_ident_double_1417;
