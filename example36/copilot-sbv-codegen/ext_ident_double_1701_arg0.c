/* File: "ext_ident_double_1701_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_word64_1694",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_1695",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_1696",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_1697",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_1698",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_1699",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_1700",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_1694) == (2))) ? (0.0) : (( (((ext_ident_word64_1695) == (3))) ? (370.332) : (( (((ext_ident_word64_1696) == (4))) ? (648.0048) : (( (((ext_ident_word64_1697) == (5))) ? (1018.6416) : (( (((ext_ident_word64_1698) == (6))) ? (1481.6328) : (( (((ext_ident_word64_1699) == (7))) ? (2036.9784000000002) : (( (((ext_ident_word64_1700) == (8))) ? (2036.9784000000002) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_1701_arg0(const SWord64 ext_ident_word64_1694,
...
{
  const SWord64 s0 = ext_ident_word64_1694;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_1695;
  const SWord64 s3 = ext_ident_word64_1696;
  const SWord64 s4 = ext_ident_word64_1697;
  const SWord64 s5 = ext_ident_word64_1698;
  const SWord64 s6 = ext_ident_word64_1699;
  const SWord64 s7 = ext_ident_word64_1700;
