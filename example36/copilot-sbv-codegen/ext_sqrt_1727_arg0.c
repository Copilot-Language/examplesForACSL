/* File: "ext_sqrt_1727_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (ext_ident_double_1726);
*/
SDouble ext_sqrt_1727_arg0(const SDouble ext_ident_double_1726,
...
{
  const SDouble s0 = ext_ident_double_1726;
  const SDouble s1 = ext_ident_double_1725;
