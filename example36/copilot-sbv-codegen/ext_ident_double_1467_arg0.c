/* File: "ext_ident_double_1467_arg0.c". Automatically generated by SBV. Do not edit! */
...
3 -> 4
5 [label="ext_ident_double_1466",color=cyan4, style=filled]
4 -> 5
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_1466) <= (0.0))) || (((((-1.0) * (ext_ownship_velocity_z))) >= (700.0))))) ? (0.0) : (((((-700.0) - (ext_ownship_velocity_z))) / (-2.0))))));
*/
SDouble ext_ident_double_1467_arg0(const SDouble ext_ident_double_1466,
...
{
  const SDouble s0 = ext_ident_double_1466;
  const SDouble s1 = ext_ident_double_1445;
  ...
  const SDouble s10 = ext_ident_double_1462;
  const SDouble s11 = ext_ident_double_1453;
  const SWord64 s12 = ext_ident_word64_1446;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_1447;
  const SWord64 s15 = ext_ident_word64_1448;
  const SWord64 s16 = ext_ident_word64_1449;
  const SWord64 s17 = ext_ident_word64_1450;
  const SWord64 s18 = ext_ident_word64_1451;
  const SWord64 s19 = ext_ident_word64_1452;
  const SDouble s20 = ext_ident_double_1461;
  const SWord64 s21 = ext_ident_word64_1454;
  const SWord64 s22 = ext_ident_word64_1455;
  const SWord64 s23 = ext_ident_word64_1456;
  const SWord64 s24 = ext_ident_word64_1457;
  const SWord64 s25 = ext_ident_word64_1458;
  const SWord64 s26 = ext_ident_word64_1459;
  const SWord64 s27 = ext_ident_word64_1460;
  const SDouble s28 = ext_ident_double_1464;
  const SDouble s29 = ext_ident_double_1463;
  const SDouble s30 = ext_ident_double_1465;
