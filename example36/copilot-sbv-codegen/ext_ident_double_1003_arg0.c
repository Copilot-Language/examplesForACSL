/* File: "ext_ident_double_1003_arg0.c". Automatically generated by SBV. Do not edit! */
...
3 -> 4
5 [label="ext_ident_double_1002",color=cyan4, style=filled]
4 -> 5
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_1002) <= (0.0))) || (((ext_ownship_velocity_z) >= (700.0))))) ? (0.0) : (((((700.0) - (ext_ownship_velocity_z))) / (2.0))))));
*/
SDouble ext_ident_double_1003_arg0(const SDouble ext_ident_double_1002,
...
{
  const SDouble s0 = ext_ident_double_1002;
  const SDouble s1 = ext_ident_double_981;
  ...
  const SDouble s10 = ext_ident_double_998;
  const SDouble s11 = ext_ident_double_989;
  const SWord64 s12 = ext_ident_word64_982;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_983;
  const SWord64 s15 = ext_ident_word64_984;
  const SWord64 s16 = ext_ident_word64_985;
  const SWord64 s17 = ext_ident_word64_986;
  const SWord64 s18 = ext_ident_word64_987;
  const SWord64 s19 = ext_ident_word64_988;
  const SDouble s20 = ext_ident_double_997;
  const SWord64 s21 = ext_ident_word64_990;
  const SWord64 s22 = ext_ident_word64_991;
  const SWord64 s23 = ext_ident_word64_992;
  const SWord64 s24 = ext_ident_word64_993;
  const SWord64 s25 = ext_ident_word64_994;
  const SWord64 s26 = ext_ident_word64_995;
  const SWord64 s27 = ext_ident_word64_996;
  const SDouble s28 = ext_ident_double_1000;
  const SDouble s29 = ext_ident_double_999;
  const SDouble s30 = ext_ident_double_1001;
