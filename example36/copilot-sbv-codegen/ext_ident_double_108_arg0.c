...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_87) < (0.0))) ? (((((ext_ident_double_104) - (ext_ident_double_106))) / (ext_ident_double_107))) : (-1.0))));
*/
SDouble ext_ident_double_108_arg0(const SDouble ext_ident_double_87,
                                  ...
                                  const SDouble ext_ident_double_107)
{
  ...
  const SDouble s9 = ext_ident_double_104;
  const SDouble s10 = ext_ident_double_95;
  const SWord64 s11 = ext_ident_word64_88;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_89;
  const SWord64 s14 = ext_ident_word64_90;
  const SWord64 s15 = ext_ident_word64_91;
  const SWord64 s16 = ext_ident_word64_92;
  const SWord64 s17 = ext_ident_word64_93;
  const SWord64 s18 = ext_ident_word64_94;
  const SDouble s19 = ext_ident_double_103;
  const SWord64 s20 = ext_ident_word64_96;
  const SWord64 s21 = ext_ident_word64_97;
  const SWord64 s22 = ext_ident_word64_98;
  const SWord64 s23 = ext_ident_word64_99;
  const SWord64 s24 = ext_ident_word64_100;
  const SWord64 s25 = ext_ident_word64_101;
  const SWord64 s26 = ext_ident_word64_102;
  const SDouble s27 = ext_ident_double_106;
  const SDouble s28 = ext_ident_double_105;
  const SDouble s29 = ext_ident_double_107;
