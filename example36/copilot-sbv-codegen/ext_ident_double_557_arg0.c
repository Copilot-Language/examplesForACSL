...
2 -> 3
4 [label="ext_ident_double_536",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_553",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_555",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_556",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_536) < (0.0))) ? (((((ext_ident_double_553) - (ext_ident_double_555))) / (ext_ident_double_556))) : (-1.0))));
*/
SDouble ext_ident_double_557_arg0(const SDouble ext_ident_double_536,
...
{
  const SDouble s0 = ext_ident_double_536;
  ...
  const SDouble s9 = ext_ident_double_553;
  const SDouble s10 = ext_ident_double_544;
  const SWord64 s11 = ext_ident_word64_537;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_538;
  const SWord64 s14 = ext_ident_word64_539;
  const SWord64 s15 = ext_ident_word64_540;
  const SWord64 s16 = ext_ident_word64_541;
  const SWord64 s17 = ext_ident_word64_542;
  const SWord64 s18 = ext_ident_word64_543;
  const SDouble s19 = ext_ident_double_552;
  const SWord64 s20 = ext_ident_word64_545;
  const SWord64 s21 = ext_ident_word64_546;
  const SWord64 s22 = ext_ident_word64_547;
  const SWord64 s23 = ext_ident_word64_548;
  const SWord64 s24 = ext_ident_word64_549;
  const SWord64 s25 = ext_ident_word64_550;
  const SWord64 s26 = ext_ident_word64_551;
  const SDouble s27 = ext_ident_double_555;
  const SDouble s28 = ext_ident_double_554;
  const SDouble s29 = ext_ident_double_556;
