/* File: "ext_ident_double_1703_arg0.c". Automatically generated by SBV. Do not edit! */
...
0 -> 1
2 [label="ext_ident_double_1702",color=cyan4, style=filled]
1 -> 2
...
/*@
 assigns \nothing;
 ensures \result == ((ext_ident_double_1702));
*/
SDouble ext_ident_double_1703_arg0(const SDouble ext_ident_double_1702,
                                   const SDouble ext_ownship_velocity_x,
                                   const SDouble ext_intruder_velocity_x,
                                   const SDouble ext_ownship_velocity_y,
                                   const SDouble ext_intruder_velocity_y)
{
  const SDouble s0 = ext_ident_double_1702;
