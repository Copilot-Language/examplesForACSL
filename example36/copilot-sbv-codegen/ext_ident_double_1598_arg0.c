/* File: "ext_ident_double_1598_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_word64_1591",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_1592",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_1593",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_1594",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_1595",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_1596",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_1597",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_1591) == (2))) ? (0.0) : (( (((ext_ident_word64_1592) == (3))) ? (370.40000000000003) : (( (((ext_ident_word64_1593) == (4))) ? (648.1999999999999) : (( (((ext_ident_word64_1594) == (5))) ? (1018.6000000000001) : (( (((ext_ident_word64_1595) == (6))) ? (1481.6000000000001) : (( (((ext_ident_word64_1596) == (7))) ? (2037.2000000000003) : (( (((ext_ident_word64_1597) == (8))) ? (2037.2000000000003) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_1598_arg0(const SWord64 ext_ident_word64_1591,
...
{
  const SWord64 s0 = ext_ident_word64_1591;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_1592;
  const SWord64 s3 = ext_ident_word64_1593;
  const SWord64 s4 = ext_ident_word64_1594;
  const SWord64 s5 = ext_ident_word64_1595;
  const SWord64 s6 = ext_ident_word64_1596;
  const SWord64 s7 = ext_ident_word64_1597;
