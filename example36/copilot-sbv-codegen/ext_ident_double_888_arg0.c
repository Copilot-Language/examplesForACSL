...
2 -> 3
4 [label="ext_ident_double_867",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_884",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_886",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_887",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_867) < (0.0))) ? (((((ext_ident_double_884) - (ext_ident_double_886))) / (ext_ident_double_887))) : (-1.0))));
*/
SDouble ext_ident_double_888_arg0(const SDouble ext_ident_double_867,
                                  ...
                                  const SDouble ext_ident_double_887)
{
  ...
  const SDouble s9 = ext_ident_double_884;
  const SDouble s10 = ext_ident_double_875;
  const SWord64 s11 = ext_ident_word64_868;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_869;
  const SWord64 s14 = ext_ident_word64_870;
  const SWord64 s15 = ext_ident_word64_871;
  const SWord64 s16 = ext_ident_word64_872;
  const SWord64 s17 = ext_ident_word64_873;
  const SWord64 s18 = ext_ident_word64_874;
  const SDouble s19 = ext_ident_double_883;
  const SWord64 s20 = ext_ident_word64_876;
  const SWord64 s21 = ext_ident_word64_877;
  const SWord64 s22 = ext_ident_word64_878;
  const SWord64 s23 = ext_ident_word64_879;
  const SWord64 s24 = ext_ident_word64_880;
  const SWord64 s25 = ext_ident_word64_881;
  const SWord64 s26 = ext_ident_word64_882;
  const SDouble s27 = ext_ident_double_886;
  const SDouble s28 = ext_ident_double_885;
  const SDouble s29 = ext_ident_double_887;
