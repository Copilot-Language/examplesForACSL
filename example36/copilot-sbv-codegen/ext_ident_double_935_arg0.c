/* File: "ext_ident_double_935_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_double_914",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_931",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_933",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_934",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_914) < (0.0))) ? (((((ext_ident_double_931) - (ext_ident_double_933))) / (ext_ident_double_934))) : (-1.0))));
*/
SDouble ext_ident_double_935_arg0(const SDouble ext_ident_double_914,
...
{
  const SDouble s0 = ext_ident_double_914;
  ...
  const SDouble s9 = ext_ident_double_931;
  const SDouble s10 = ext_ident_double_922;
  const SWord64 s11 = ext_ident_word64_915;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_916;
  const SWord64 s14 = ext_ident_word64_917;
  const SWord64 s15 = ext_ident_word64_918;
  const SWord64 s16 = ext_ident_word64_919;
  const SWord64 s17 = ext_ident_word64_920;
  const SWord64 s18 = ext_ident_word64_921;
  const SDouble s19 = ext_ident_double_930;
  const SWord64 s20 = ext_ident_word64_923;
  const SWord64 s21 = ext_ident_word64_924;
  const SWord64 s22 = ext_ident_word64_925;
  const SWord64 s23 = ext_ident_word64_926;
  const SWord64 s24 = ext_ident_word64_927;
  const SWord64 s25 = ext_ident_word64_928;
  const SWord64 s26 = ext_ident_word64_929;
  const SDouble s27 = ext_ident_double_933;
  const SDouble s28 = ext_ident_double_932;
  const SDouble s29 = ext_ident_double_934;
