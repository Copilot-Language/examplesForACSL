/* File: "ext_ident_double_611_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_word64_604",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_605",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_606",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_607",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_608",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_609",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_610",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_604) == (2))) ? (0.0) : (( (((ext_ident_word64_605) == (3))) ? (370.40000000000003) : (( (((ext_ident_word64_606) == (4))) ? (648.1999999999999) : (( (((ext_ident_word64_607) == (5))) ? (1018.6000000000001) : (( (((ext_ident_word64_608) == (6))) ? (1481.6000000000001) : (( (((ext_ident_word64_609) == (7))) ? (2037.2000000000003) : (( (((ext_ident_word64_610) == (8))) ? (2037.2000000000003) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_611_arg0(const SWord64 ext_ident_word64_604,
...
{
  const SWord64 s0 = ext_ident_word64_604;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_605;
  const SWord64 s3 = ext_ident_word64_606;
  const SWord64 s4 = ext_ident_word64_607;
  const SWord64 s5 = ext_ident_word64_608;
  const SWord64 s6 = ext_ident_word64_609;
  const SWord64 s7 = ext_ident_word64_610;
