/* File: "ext_ident_double_488_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_487) <= (0.0))) || (((((-1.0) * (ext_ownship_velocity_z))) >= (700.0))))) ? (0.0) : (((((-700.0) - (ext_ownship_velocity_z))) / (-2.0))))));
*/
SDouble ext_ident_double_488_arg0(const SDouble ext_ident_double_487,
...
{
  const SDouble s0 = ext_ident_double_487;
  const SDouble s1 = ext_ident_double_466;
  ...
  const SDouble s11 = ext_ident_double_474;
  const SWord64 s12 = ext_ident_word64_467;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_468;
  const SWord64 s15 = ext_ident_word64_469;
  const SWord64 s16 = ext_ident_word64_470;
  const SWord64 s17 = ext_ident_word64_471;
  const SWord64 s18 = ext_ident_word64_472;
  const SWord64 s19 = ext_ident_word64_473;
  const SDouble s20 = ext_ident_double_482;
  const SWord64 s21 = ext_ident_word64_475;
  const SWord64 s22 = ext_ident_word64_476;
  const SWord64 s23 = ext_ident_word64_477;
  const SWord64 s24 = ext_ident_word64_478;
  const SWord64 s25 = ext_ident_word64_479;
  const SWord64 s26 = ext_ident_word64_480;
  const SWord64 s27 = ext_ident_word64_481;
  const SDouble s28 = ext_ident_double_485;
  const SDouble s29 = ext_ident_double_484;
  const SDouble s30 = ext_ident_double_486;
