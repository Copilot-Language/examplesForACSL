/* File: "ext_ident_double_957_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_double_936",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_953",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_955",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_956",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_936) < (0.0))) ? (((((ext_ident_double_953) - (ext_ident_double_955))) / (ext_ident_double_956))) : (-1.0))));
*/
SDouble ext_ident_double_957_arg0(const SDouble ext_ident_double_936,
...
{
  const SDouble s0 = ext_ident_double_936;
  ...
  const SDouble s9 = ext_ident_double_953;
  const SDouble s10 = ext_ident_double_944;
  const SWord64 s11 = ext_ident_word64_937;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_938;
  const SWord64 s14 = ext_ident_word64_939;
  const SWord64 s15 = ext_ident_word64_940;
  const SWord64 s16 = ext_ident_word64_941;
  const SWord64 s17 = ext_ident_word64_942;
  const SWord64 s18 = ext_ident_word64_943;
  const SDouble s19 = ext_ident_double_952;
  const SWord64 s20 = ext_ident_word64_945;
  const SWord64 s21 = ext_ident_word64_946;
  const SWord64 s22 = ext_ident_word64_947;
  const SWord64 s23 = ext_ident_word64_948;
  const SWord64 s24 = ext_ident_word64_949;
  const SWord64 s25 = ext_ident_word64_950;
  const SWord64 s26 = ext_ident_word64_951;
  const SDouble s27 = ext_ident_double_955;
  const SDouble s28 = ext_ident_double_954;
  const SDouble s29 = ext_ident_double_956;
