...
2 -> 3
4 [label="ext_ident_double_250",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_267",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_269",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_270",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_250) < (0.0))) ? (((((ext_ident_double_267) - (ext_ident_double_269))) / (ext_ident_double_270))) : (-1.0))));
*/
SDouble ext_ident_double_271_arg0(const SDouble ext_ident_double_250,
...
{
  const SDouble s0 = ext_ident_double_250;
  ...
  const SDouble s9 = ext_ident_double_267;
  const SDouble s10 = ext_ident_double_258;
  const SWord64 s11 = ext_ident_word64_251;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_252;
  const SWord64 s14 = ext_ident_word64_253;
  const SWord64 s15 = ext_ident_word64_254;
  const SWord64 s16 = ext_ident_word64_255;
  const SWord64 s17 = ext_ident_word64_256;
  const SWord64 s18 = ext_ident_word64_257;
  const SDouble s19 = ext_ident_double_266;
  const SWord64 s20 = ext_ident_word64_259;
  const SWord64 s21 = ext_ident_word64_260;
  const SWord64 s22 = ext_ident_word64_261;
  const SWord64 s23 = ext_ident_word64_262;
  const SWord64 s24 = ext_ident_word64_263;
  const SWord64 s25 = ext_ident_word64_264;
  const SWord64 s26 = ext_ident_word64_265;
  const SDouble s27 = ext_ident_double_269;
  const SDouble s28 = ext_ident_double_268;
  const SDouble s29 = ext_ident_double_270;
