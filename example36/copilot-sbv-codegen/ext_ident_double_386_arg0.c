/* File: "ext_ident_double_386_arg0.c". Automatically generated by SBV. Do not edit! */
...
3 -> 4
5 [label="ext_ident_double_385",color=cyan4, style=filled]
4 -> 5
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_385) <= (0.0))) || (((ext_ownship_velocity_z) >= (700.0))))) ? (0.0) : (((((700.0) - (ext_ownship_velocity_z))) / (2.0))))));
*/
                                  ...
                                  const SDouble ext_ownship_velocity_z)
{
  ...
  const SDouble s10 = ext_ident_double_381;
  const SDouble s11 = ext_ident_double_372;
  const SWord64 s12 = ext_ident_word64_365;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_366;
  const SWord64 s15 = ext_ident_word64_367;
  const SWord64 s16 = ext_ident_word64_368;
  const SWord64 s17 = ext_ident_word64_369;
  const SWord64 s18 = ext_ident_word64_370;
  const SWord64 s19 = ext_ident_word64_371;
  const SDouble s20 = ext_ident_double_380;
  const SWord64 s21 = ext_ident_word64_373;
  const SWord64 s22 = ext_ident_word64_374;
  const SWord64 s23 = ext_ident_word64_375;
  const SWord64 s24 = ext_ident_word64_376;
  const SWord64 s25 = ext_ident_word64_377;
  const SWord64 s26 = ext_ident_word64_378;
  const SWord64 s27 = ext_ident_word64_379;
  const SDouble s28 = ext_ident_double_383;
  const SDouble s29 = ext_ident_double_382;
  const SDouble s30 = ext_ident_double_384;
