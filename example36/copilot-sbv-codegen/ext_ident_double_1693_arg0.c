/* File: "ext_ident_double_1693_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_word64_1686",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_1687",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_1688",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_1689",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_1690",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_1691",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_1692",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_1686) == (2))) ? (0.0) : (( (((ext_ident_word64_1687) == (3))) ? (370.332) : (( (((ext_ident_word64_1688) == (4))) ? (648.0048) : (( (((ext_ident_word64_1689) == (5))) ? (1018.6416) : (( (((ext_ident_word64_1690) == (6))) ? (1481.6328) : (( (((ext_ident_word64_1691) == (7))) ? (2036.9784000000002) : (( (((ext_ident_word64_1692) == (8))) ? (2036.9784000000002) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_1693_arg0(const SWord64 ext_ident_word64_1686,
...
{
  const SWord64 s0 = ext_ident_word64_1686;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_1687;
  const SWord64 s3 = ext_ident_word64_1688;
  const SWord64 s4 = ext_ident_word64_1689;
  const SWord64 s5 = ext_ident_word64_1690;
  const SWord64 s6 = ext_ident_word64_1691;
  const SWord64 s7 = ext_ident_word64_1692;
