/* File: "ext_ident_double_673_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_672) <= (0.0))) || (((((-1.0) * (ext_ownship_velocity_z))) >= (700.0))))) ? (0.0) : (((((-700.0) - (ext_ownship_velocity_z))) / (-2.0))))));
*/
SDouble ext_ident_double_673_arg0(const SDouble ext_ident_double_672,
                                  ...
                                  const SDouble ext_ownship_velocity_z)
{
  ...
  const SDouble s10 = ext_ident_double_668;
  const SDouble s11 = ext_ident_double_659;
  const SWord64 s12 = ext_ident_word64_652;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_653;
  const SWord64 s15 = ext_ident_word64_654;
  const SWord64 s16 = ext_ident_word64_655;
  const SWord64 s17 = ext_ident_word64_656;
  const SWord64 s18 = ext_ident_word64_657;
  const SWord64 s19 = ext_ident_word64_658;
  const SDouble s20 = ext_ident_double_667;
  const SWord64 s21 = ext_ident_word64_660;
  const SWord64 s22 = ext_ident_word64_661;
  const SWord64 s23 = ext_ident_word64_662;
  const SWord64 s24 = ext_ident_word64_663;
  const SWord64 s25 = ext_ident_word64_664;
  const SWord64 s26 = ext_ident_word64_665;
  const SWord64 s27 = ext_ident_word64_666;
  const SDouble s28 = ext_ident_double_670;
  const SDouble s29 = ext_ident_double_669;
  const SDouble s30 = ext_ident_double_671;
