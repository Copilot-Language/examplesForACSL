...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_293) <= (0.0))) || (((ext_ownship_velocity_z) >= (700.0))))) ? (0.0) : (((((700.0) - (ext_ownship_velocity_z))) / (2.0))))));
*/
SDouble ext_ident_double_294_arg0(const SDouble ext_ident_double_293,
...
{
  const SDouble s0 = ext_ident_double_293;
  const SDouble s1 = ext_ident_double_272;
  ...
  const SDouble s11 = ext_ident_double_280;
  const SWord64 s12 = ext_ident_word64_273;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_274;
  const SWord64 s15 = ext_ident_word64_275;
  const SWord64 s16 = ext_ident_word64_276;
  const SWord64 s17 = ext_ident_word64_277;
  const SWord64 s18 = ext_ident_word64_278;
  const SWord64 s19 = ext_ident_word64_279;
  const SDouble s20 = ext_ident_double_288;
  const SWord64 s21 = ext_ident_word64_281;
  const SWord64 s22 = ext_ident_word64_282;
  const SWord64 s23 = ext_ident_word64_283;
  const SWord64 s24 = ext_ident_word64_284;
  const SWord64 s25 = ext_ident_word64_285;
  const SWord64 s26 = ext_ident_word64_286;
  const SWord64 s27 = ext_ident_word64_287;
  const SDouble s28 = ext_ident_double_291;
  const SDouble s29 = ext_ident_double_290;
  const SDouble s30 = ext_ident_double_292;
