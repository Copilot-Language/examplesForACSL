/* File: "ext_ident_double_1766_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_word64_1759",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_1760",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_1761",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_1762",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_1763",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_1764",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_1765",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_1759) == (2))) ? (0.0) : (( (((ext_ident_word64_1760) == (3))) ? (15.0) : (( (((ext_ident_word64_1761) == (4))) ? (20.0) : (( (((ext_ident_word64_1762) == (5))) ? (25.0) : (( (((ext_ident_word64_1763) == (6))) ? (30.0) : (( (((ext_ident_word64_1764) == (7))) ? (35.0) : (( (((ext_ident_word64_1765) == (8))) ? (35.0) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_1766_arg0(const SWord64 ext_ident_word64_1759,
...
{
  const SWord64 s0 = ext_ident_word64_1759;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_1760;
  const SWord64 s3 = ext_ident_word64_1761;
  const SWord64 s4 = ext_ident_word64_1762;
  const SWord64 s5 = ext_ident_word64_1763;
  const SWord64 s6 = ext_ident_word64_1764;
  const SWord64 s7 = ext_ident_word64_1765;
