...
2 -> 3
4 [label="ext_ident_word64_53",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_54",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_55",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_56",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_57",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_58",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_59",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_53) == (2))) ? (0.0) : (( (((ext_ident_word64_54) == (3))) ? (370.332) : (( (((ext_ident_word64_55) == (4))) ? (648.0048) : (( (((ext_ident_word64_56) == (5))) ? (1018.6416) : (( (((ext_ident_word64_57) == (6))) ? (1481.6328) : (( (((ext_ident_word64_58) == (7))) ? (2036.9784000000002) : (( (((ext_ident_word64_59) == (8))) ? (2036.9784000000002) : (0.0))))))))))))))));
*/
...
{
  const SWord64 s0 = ext_ident_word64_53;
  const SWord64 s2 = ext_ident_word64_54;
  const SWord64 s3 = ext_ident_word64_55;
  const SWord64 s4 = ext_ident_word64_56;
  const SWord64 s5 = ext_ident_word64_57;
  const SWord64 s6 = ext_ident_word64_58;
  const SWord64 s7 = ext_ident_word64_59;
