/* File: "ext_ident_double_1671_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_word64_1664",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_1665",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_1666",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_1667",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_1668",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_1669",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_1670",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_1664) == (2))) ? (0.0) : (( (((ext_ident_word64_1665) == (3))) ? (370.332) : (( (((ext_ident_word64_1666) == (4))) ? (648.0048) : (( (((ext_ident_word64_1667) == (5))) ? (1018.6416) : (( (((ext_ident_word64_1668) == (6))) ? (1481.6328) : (( (((ext_ident_word64_1669) == (7))) ? (2036.9784000000002) : (( (((ext_ident_word64_1670) == (8))) ? (2036.9784000000002) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_1671_arg0(const SWord64 ext_ident_word64_1664,
...
{
  const SWord64 s0 = ext_ident_word64_1664;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_1665;
  const SWord64 s3 = ext_ident_word64_1666;
  const SWord64 s4 = ext_ident_word64_1667;
  const SWord64 s5 = ext_ident_word64_1668;
  const SWord64 s6 = ext_ident_word64_1669;
  const SWord64 s7 = ext_ident_word64_1670;
