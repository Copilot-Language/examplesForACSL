...
2 -> 3
4 [label="ext_ident_word64_945",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_946",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_947",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_948",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_949",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_950",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_951",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_945) == (2))) ? (0.0) : (( (((ext_ident_word64_946) == (3))) ? (370.40000000000003) : (( (((ext_ident_word64_947) == (4))) ? (648.1999999999999) : (( (((ext_ident_word64_948) == (5))) ? (1018.6000000000001) : (( (((ext_ident_word64_949) == (6))) ? (1481.6000000000001) : (( (((ext_ident_word64_950) == (7))) ? (2037.2000000000003) : (( (((ext_ident_word64_951) == (8))) ? (2037.2000000000003) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_952_arg0(const SWord64 ext_ident_word64_945,
...
{
  const SWord64 s0 = ext_ident_word64_945;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_946;
  const SWord64 s3 = ext_ident_word64_947;
  const SWord64 s4 = ext_ident_word64_948;
  const SWord64 s5 = ext_ident_word64_949;
  const SWord64 s6 = ext_ident_word64_950;
  const SWord64 s7 = ext_ident_word64_951;
