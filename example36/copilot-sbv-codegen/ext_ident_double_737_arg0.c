...
2 -> 3
4 [label="ext_ident_word64_730",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_731",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_732",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_733",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_734",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_735",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_736",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_730) == (2))) ? (0.0) : (( (((ext_ident_word64_731) == (3))) ? (370.40000000000003) : (( (((ext_ident_word64_732) == (4))) ? (648.1999999999999) : (( (((ext_ident_word64_733) == (5))) ? (1018.6000000000001) : (( (((ext_ident_word64_734) == (6))) ? (1481.6000000000001) : (( (((ext_ident_word64_735) == (7))) ? (2037.2000000000003) : (( (((ext_ident_word64_736) == (8))) ? (2037.2000000000003) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_737_arg0(const SWord64 ext_ident_word64_730,
...
{
  const SWord64 s0 = ext_ident_word64_730;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_731;
  const SWord64 s3 = ext_ident_word64_732;
  const SWord64 s4 = ext_ident_word64_733;
  const SWord64 s5 = ext_ident_word64_734;
  const SWord64 s6 = ext_ident_word64_735;
  const SWord64 s7 = ext_ident_word64_736;
