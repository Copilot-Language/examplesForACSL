/* File: "ext_ident_double_1778_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((((ext_ownship_position_z) - (ext_intruder_position_z))) * (ext_ident_double_1769))) <= (ext_ident_double_1777))) ? (0.0) : (( (((((ext_ownship_velocity_z) - (ext_intruder_velocity_z))) == (0.0))) ? (-1.0) : (((((0.0) - (((ext_ownship_position_z) - (ext_intruder_position_z))))) / (((ext_ownship_velocity_z) - (ext_intruder_velocity_z))))))))));
*/
SDouble ext_ident_double_1778_arg0(const SDouble ext_ownship_position_z,
                                   ...
                                   const SDouble ext_intruder_velocity_z)
{
  ...
  const SDouble s2 = ext_ident_double_1769;
  const SDouble s3 = ext_ident_double_1777;
  const SWord64 s4 = ext_ident_word64_1770;
  const SWord64 s5 = ext_ident_word64_1771;
  const SWord64 s6 = ext_ident_word64_1772;
  const SWord64 s7 = ext_ident_word64_1773;
  const SWord64 s8 = ext_ident_word64_1774;
  const SWord64 s9 = ext_ident_word64_1775;
  const SWord64 s10 = ext_ident_word64_1776;
