/* File: "ext_ident_double_980_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_double_959",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_976",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_978",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_979",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_959) < (0.0))) ? (((((ext_ident_double_976) - (ext_ident_double_978))) / (ext_ident_double_979))) : (-1.0))));
*/
SDouble ext_ident_double_980_arg0(const SDouble ext_ident_double_959,
...
{
  const SDouble s0 = ext_ident_double_959;
  ...
  const SDouble s9 = ext_ident_double_976;
  const SDouble s10 = ext_ident_double_967;
  const SWord64 s11 = ext_ident_word64_960;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_961;
  const SWord64 s14 = ext_ident_word64_962;
  const SWord64 s15 = ext_ident_word64_963;
  const SWord64 s16 = ext_ident_word64_964;
  const SWord64 s17 = ext_ident_word64_965;
  const SWord64 s18 = ext_ident_word64_966;
  const SDouble s19 = ext_ident_double_975;
  const SWord64 s20 = ext_ident_word64_968;
  const SWord64 s21 = ext_ident_word64_969;
  const SWord64 s22 = ext_ident_word64_970;
  const SWord64 s23 = ext_ident_word64_971;
  const SWord64 s24 = ext_ident_word64_972;
  const SWord64 s25 = ext_ident_word64_973;
  const SWord64 s26 = ext_ident_word64_974;
  const SDouble s27 = ext_ident_double_978;
  const SDouble s28 = ext_ident_double_977;
  const SDouble s29 = ext_ident_double_979;
