/* File: "ext_ident_double_1512_arg0.c". Automatically generated by SBV. Do not edit! */
...
3 -> 4
5 [label="ext_ident_double_1511",color=cyan4, style=filled]
4 -> 5
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_1511) <= (0.0))) || (((((-1.0) * (ext_ownship_velocity_z))) >= (700.0))))) ? (0.0) : (((((-700.0) - (ext_ownship_velocity_z))) / (-2.0))))));
*/
SDouble ext_ident_double_1512_arg0(const SDouble ext_ident_double_1511,
...
{
  const SDouble s0 = ext_ident_double_1511;
  const SDouble s1 = ext_ident_double_1490;
  ...
  const SDouble s10 = ext_ident_double_1507;
  const SDouble s11 = ext_ident_double_1498;
  const SWord64 s12 = ext_ident_word64_1491;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_1492;
  const SWord64 s15 = ext_ident_word64_1493;
  const SWord64 s16 = ext_ident_word64_1494;
  const SWord64 s17 = ext_ident_word64_1495;
  const SWord64 s18 = ext_ident_word64_1496;
  const SWord64 s19 = ext_ident_word64_1497;
  const SDouble s20 = ext_ident_double_1506;
  const SWord64 s21 = ext_ident_word64_1499;
  const SWord64 s22 = ext_ident_word64_1500;
  const SWord64 s23 = ext_ident_word64_1501;
  const SWord64 s24 = ext_ident_word64_1502;
  const SWord64 s25 = ext_ident_word64_1503;
  const SWord64 s26 = ext_ident_word64_1504;
  const SWord64 s27 = ext_ident_word64_1505;
  const SDouble s28 = ext_ident_double_1509;
  const SDouble s29 = ext_ident_double_1508;
  const SDouble s30 = ext_ident_double_1510;
