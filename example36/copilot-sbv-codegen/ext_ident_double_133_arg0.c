...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_112) < (0.0))) ? (((((ext_ident_double_129) - (ext_ident_double_131))) / (ext_ident_double_132))) : (-1.0))));
*/
SDouble ext_ident_double_133_arg0(const SDouble ext_ident_double_112,
                                  ...
                                  const SDouble ext_ident_double_132)
{
  ...
  const SDouble s9 = ext_ident_double_129;
  const SDouble s10 = ext_ident_double_120;
  const SWord64 s11 = ext_ident_word64_113;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_114;
  const SWord64 s14 = ext_ident_word64_115;
  const SWord64 s15 = ext_ident_word64_116;
  const SWord64 s16 = ext_ident_word64_117;
  const SWord64 s17 = ext_ident_word64_118;
  const SWord64 s18 = ext_ident_word64_119;
  const SDouble s19 = ext_ident_double_128;
  const SWord64 s20 = ext_ident_word64_121;
  const SWord64 s21 = ext_ident_word64_122;
  const SWord64 s22 = ext_ident_word64_123;
  const SWord64 s23 = ext_ident_word64_124;
  const SWord64 s24 = ext_ident_word64_125;
  const SWord64 s25 = ext_ident_word64_126;
  const SWord64 s26 = ext_ident_word64_127;
  const SDouble s27 = ext_ident_double_131;
  const SDouble s28 = ext_ident_double_130;
  const SDouble s29 = ext_ident_double_132;
