/* File: "ext_ident_double_624_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_double_603",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_620",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_622",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_623",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_603) < (0.0))) ? (((((ext_ident_double_620) - (ext_ident_double_622))) / (ext_ident_double_623))) : (-1.0))));
*/
SDouble ext_ident_double_624_arg0(const SDouble ext_ident_double_603,
                                  ...
                                  const SDouble ext_ident_double_623)
{
  ...
  const SDouble s9 = ext_ident_double_620;
  const SDouble s10 = ext_ident_double_611;
  const SWord64 s11 = ext_ident_word64_604;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_605;
  const SWord64 s14 = ext_ident_word64_606;
  const SWord64 s15 = ext_ident_word64_607;
  const SWord64 s16 = ext_ident_word64_608;
  const SWord64 s17 = ext_ident_word64_609;
  const SWord64 s18 = ext_ident_word64_610;
  const SDouble s19 = ext_ident_double_619;
  const SWord64 s20 = ext_ident_word64_612;
  const SWord64 s21 = ext_ident_word64_613;
  const SWord64 s22 = ext_ident_word64_614;
  const SWord64 s23 = ext_ident_word64_615;
  const SWord64 s24 = ext_ident_word64_616;
  const SWord64 s25 = ext_ident_word64_617;
  const SWord64 s26 = ext_ident_word64_618;
  const SDouble s27 = ext_ident_double_622;
  const SDouble s28 = ext_ident_double_621;
  const SDouble s29 = ext_ident_double_623;
