/* File: "ext_ident_double_602_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_double_581",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_598",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_600",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_601",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_581) < (0.0))) ? (((((ext_ident_double_598) - (ext_ident_double_600))) / (ext_ident_double_601))) : (-1.0))));
*/
SDouble ext_ident_double_602_arg0(const SDouble ext_ident_double_581,
...
{
  const SDouble s0 = ext_ident_double_581;
  ...
  const SDouble s9 = ext_ident_double_598;
  const SDouble s10 = ext_ident_double_589;
  const SWord64 s11 = ext_ident_word64_582;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_583;
  const SWord64 s14 = ext_ident_word64_584;
  const SWord64 s15 = ext_ident_word64_585;
  const SWord64 s16 = ext_ident_word64_586;
  const SWord64 s17 = ext_ident_word64_587;
  const SWord64 s18 = ext_ident_word64_588;
  const SDouble s19 = ext_ident_double_597;
  const SWord64 s20 = ext_ident_word64_590;
  const SWord64 s21 = ext_ident_word64_591;
  const SWord64 s22 = ext_ident_word64_592;
  const SWord64 s23 = ext_ident_word64_593;
  const SWord64 s24 = ext_ident_word64_594;
  const SWord64 s25 = ext_ident_word64_595;
  const SWord64 s26 = ext_ident_word64_596;
  const SDouble s27 = ext_ident_double_600;
  const SDouble s28 = ext_ident_double_599;
  const SDouble s29 = ext_ident_double_601;
