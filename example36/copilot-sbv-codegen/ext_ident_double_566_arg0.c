/* File: "ext_ident_double_566_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_word64_559",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_560",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_561",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_562",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_563",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_564",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_565",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_559) == (2))) ? (0.0) : (( (((ext_ident_word64_560) == (3))) ? (370.40000000000003) : (( (((ext_ident_word64_561) == (4))) ? (648.1999999999999) : (( (((ext_ident_word64_562) == (5))) ? (1018.6000000000001) : (( (((ext_ident_word64_563) == (6))) ? (1481.6000000000001) : (( (((ext_ident_word64_564) == (7))) ? (2037.2000000000003) : (( (((ext_ident_word64_565) == (8))) ? (2037.2000000000003) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_566_arg0(const SWord64 ext_ident_word64_559,
...
{
  const SWord64 s0 = ext_ident_word64_559;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_560;
  const SWord64 s3 = ext_ident_word64_561;
  const SWord64 s4 = ext_ident_word64_562;
  const SWord64 s5 = ext_ident_word64_563;
  const SWord64 s6 = ext_ident_word64_564;
  const SWord64 s7 = ext_ident_word64_565;
