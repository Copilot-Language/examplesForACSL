/* File: "ext_ident_double_1466_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_double_1445",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_1462",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_1464",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_1465",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_1445) < (0.0))) ? (((((ext_ident_double_1462) - (ext_ident_double_1464))) / (ext_ident_double_1465))) : (-1.0))));
*/
SDouble ext_ident_double_1466_arg0(const SDouble ext_ident_double_1445,
...
{
  const SDouble s0 = ext_ident_double_1445;
  ...
  const SDouble s9 = ext_ident_double_1462;
  const SDouble s10 = ext_ident_double_1453;
  const SWord64 s11 = ext_ident_word64_1446;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_1447;
  const SWord64 s14 = ext_ident_word64_1448;
  const SWord64 s15 = ext_ident_word64_1449;
  const SWord64 s16 = ext_ident_word64_1450;
  const SWord64 s17 = ext_ident_word64_1451;
  const SWord64 s18 = ext_ident_word64_1452;
  const SDouble s19 = ext_ident_double_1461;
  const SWord64 s20 = ext_ident_word64_1454;
  const SWord64 s21 = ext_ident_word64_1455;
  const SWord64 s22 = ext_ident_word64_1456;
  const SWord64 s23 = ext_ident_word64_1457;
  const SWord64 s24 = ext_ident_word64_1458;
  const SWord64 s25 = ext_ident_word64_1459;
  const SWord64 s26 = ext_ident_word64_1460;
  const SDouble s27 = ext_ident_double_1464;
  const SDouble s28 = ext_ident_double_1463;
  const SDouble s29 = ext_ident_double_1465;
