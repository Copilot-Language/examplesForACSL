...
2 -> 3
4 [label="ext_ident_word64_365",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_366",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_367",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_368",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_369",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_370",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_371",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_365) == (2))) ? (0.0) : (( (((ext_ident_word64_366) == (3))) ? (370.40000000000003) : (( (((ext_ident_word64_367) == (4))) ? (648.1999999999999) : (( (((ext_ident_word64_368) == (5))) ? (1018.6000000000001) : (( (((ext_ident_word64_369) == (6))) ? (1481.6000000000001) : (( (((ext_ident_word64_370) == (7))) ? (2037.2000000000003) : (( (((ext_ident_word64_371) == (8))) ? (2037.2000000000003) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_372_arg0(const SWord64 ext_ident_word64_365,
...
{
  const SWord64 s0 = ext_ident_word64_365;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_366;
  const SWord64 s3 = ext_ident_word64_367;
  const SWord64 s4 = ext_ident_word64_368;
  const SWord64 s5 = ext_ident_word64_369;
  const SWord64 s6 = ext_ident_word64_370;
  const SWord64 s7 = ext_ident_word64_371;
