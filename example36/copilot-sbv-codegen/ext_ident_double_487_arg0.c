/* File: "ext_ident_double_487_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_double_466",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_483",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_485",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_486",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_466) < (0.0))) ? (((((ext_ident_double_483) - (ext_ident_double_485))) / (ext_ident_double_486))) : (-1.0))));
*/
SDouble ext_ident_double_487_arg0(const SDouble ext_ident_double_466,
...
{
  const SDouble s0 = ext_ident_double_466;
  ...
  const SWord64 s11 = ext_ident_word64_467;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_468;
  const SWord64 s14 = ext_ident_word64_469;
  const SWord64 s15 = ext_ident_word64_470;
  const SWord64 s16 = ext_ident_word64_471;
  const SWord64 s17 = ext_ident_word64_472;
  const SWord64 s18 = ext_ident_word64_473;
  const SDouble s19 = ext_ident_double_482;
  const SWord64 s20 = ext_ident_word64_475;
  const SWord64 s21 = ext_ident_word64_476;
  const SWord64 s22 = ext_ident_word64_477;
  const SWord64 s23 = ext_ident_word64_478;
  const SWord64 s24 = ext_ident_word64_479;
  const SWord64 s25 = ext_ident_word64_480;
  const SWord64 s26 = ext_ident_word64_481;
  const SDouble s27 = ext_ident_double_485;
  const SDouble s28 = ext_ident_double_484;
  const SDouble s29 = ext_ident_double_486;
