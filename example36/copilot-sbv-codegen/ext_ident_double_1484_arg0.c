/* File: "ext_ident_double_1484_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_1477) == (2))) ? (0.0) : (( (((ext_ident_word64_1478) == (3))) ? (370.40000000000003) : (( (((ext_ident_word64_1479) == (4))) ? (648.1999999999999) : (( (((ext_ident_word64_1480) == (5))) ? (1018.6000000000001) : (( (((ext_ident_word64_1481) == (6))) ? (1481.6000000000001) : (( (((ext_ident_word64_1482) == (7))) ? (2037.2000000000003) : (( (((ext_ident_word64_1483) == (8))) ? (2037.2000000000003) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_1484_arg0(const SWord64 ext_ident_word64_1477,
...
{
  const SWord64 s0 = ext_ident_word64_1477;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_1478;
  const SWord64 s3 = ext_ident_word64_1479;
  const SWord64 s4 = ext_ident_word64_1480;
  const SWord64 s5 = ext_ident_word64_1481;
  const SWord64 s6 = ext_ident_word64_1482;
  const SWord64 s7 = ext_ident_word64_1483;
