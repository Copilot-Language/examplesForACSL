...
2 -> 3
4 [label="ext_ident_double_272",color=cyan4, style=filled]
3 -> 4
...
22 -> 23
24 [label="ext_ident_double_289",color=cyan4, style=filled]
23 -> 24
607 [label="ext_ident_double_291",color=cyan4, style=filled]
23 -> 607
626 [label="ext_ident_double_292",color=cyan4, style=filled]
22 -> 626
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_272) < (0.0))) ? (((((ext_ident_double_289) - (ext_ident_double_291))) / (ext_ident_double_292))) : (-1.0))));
*/
SDouble ext_ident_double_293_arg0(const SDouble ext_ident_double_272,
                                  ...
                                  const SDouble ext_ident_double_292)
{
  ...
  const SDouble s9 = ext_ident_double_289;
  const SDouble s10 = ext_ident_double_280;
  const SWord64 s11 = ext_ident_word64_273;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_274;
  const SWord64 s14 = ext_ident_word64_275;
  const SWord64 s15 = ext_ident_word64_276;
  const SWord64 s16 = ext_ident_word64_277;
  const SWord64 s17 = ext_ident_word64_278;
  const SWord64 s18 = ext_ident_word64_279;
  const SDouble s19 = ext_ident_double_288;
  const SWord64 s20 = ext_ident_word64_281;
  const SWord64 s21 = ext_ident_word64_282;
  const SWord64 s22 = ext_ident_word64_283;
  const SWord64 s23 = ext_ident_word64_284;
  const SWord64 s24 = ext_ident_word64_285;
  const SWord64 s25 = ext_ident_word64_286;
  const SWord64 s26 = ext_ident_word64_287;
  const SDouble s27 = ext_ident_double_291;
  const SDouble s28 = ext_ident_double_290;
