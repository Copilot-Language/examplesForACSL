/* File: "ext_ident_double_911_arg0.c". Automatically generated by SBV. Do not edit! */
...
3 -> 4
5 [label="ext_ident_double_910",color=cyan4, style=filled]
4 -> 5
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_910) <= (0.0))) || (((ext_ownship_velocity_z) >= (700.0))))) ? (0.0) : (((((700.0) - (ext_ownship_velocity_z))) / (2.0))))));
*/
SDouble ext_ident_double_911_arg0(const SDouble ext_ident_double_910,
...
{
  const SDouble s0 = ext_ident_double_910;
  const SDouble s1 = ext_ident_double_889;
  ...
  const SDouble s10 = ext_ident_double_906;
  const SDouble s11 = ext_ident_double_897;
  const SWord64 s12 = ext_ident_word64_890;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_891;
  const SWord64 s15 = ext_ident_word64_892;
  const SWord64 s16 = ext_ident_word64_893;
  const SWord64 s17 = ext_ident_word64_894;
  const SWord64 s18 = ext_ident_word64_895;
  const SWord64 s19 = ext_ident_word64_896;
  const SDouble s20 = ext_ident_double_905;
  const SWord64 s21 = ext_ident_word64_898;
  const SWord64 s22 = ext_ident_word64_899;
  const SWord64 s23 = ext_ident_word64_900;
  const SWord64 s24 = ext_ident_word64_901;
  const SWord64 s25 = ext_ident_word64_902;
  const SWord64 s26 = ext_ident_word64_903;
  const SWord64 s27 = ext_ident_word64_904;
  const SDouble s28 = ext_ident_double_908;
  const SDouble s29 = ext_ident_double_907;
  const SDouble s30 = ext_ident_double_909;
