/* File: "ext_ident_double_1002_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_double_981) < (0.0))) ? (((((ext_ident_double_998) - (ext_ident_double_1000))) / (ext_ident_double_1001))) : (-1.0))));
*/
SDouble ext_ident_double_1002_arg0(const SDouble ext_ident_double_981,
...
{
  const SDouble s0 = ext_ident_double_981;
  ...
  const SDouble s9 = ext_ident_double_998;
  const SDouble s10 = ext_ident_double_989;
  const SWord64 s11 = ext_ident_word64_982;
  const SDouble s12 = ext_ownship_position_z;
  const SWord64 s13 = ext_ident_word64_983;
  const SWord64 s14 = ext_ident_word64_984;
  const SWord64 s15 = ext_ident_word64_985;
  const SWord64 s16 = ext_ident_word64_986;
  const SWord64 s17 = ext_ident_word64_987;
  const SWord64 s18 = ext_ident_word64_988;
  const SDouble s19 = ext_ident_double_997;
  const SWord64 s20 = ext_ident_word64_990;
  const SWord64 s21 = ext_ident_word64_991;
  const SWord64 s22 = ext_ident_word64_992;
  const SWord64 s23 = ext_ident_word64_993;
  const SWord64 s24 = ext_ident_word64_994;
  const SWord64 s25 = ext_ident_word64_995;
  const SWord64 s26 = ext_ident_word64_996;
  const SDouble s27 = ext_ident_double_1000;
  const SDouble s28 = ext_ident_double_999;
