/* File: "ext_ident_double_967_arg0.c". Automatically generated by SBV. Do not edit! */
...
2 -> 3
4 [label="ext_ident_word64_960",color=cyan4, style=filled]
3 -> 4
...
43 -> 44
45 [label="ext_ident_word64_961",color=cyan4, style=filled]
44 -> 45
...
84 -> 85
86 [label="ext_ident_word64_962",color=cyan4, style=filled]
85 -> 86
...
125 -> 126
127 [label="ext_ident_word64_963",color=cyan4, style=filled]
126 -> 127
...
166 -> 167
168 [label="ext_ident_word64_964",color=cyan4, style=filled]
167 -> 168
...
207 -> 208
209 [label="ext_ident_word64_965",color=cyan4, style=filled]
208 -> 209
...
248 -> 249
250 [label="ext_ident_word64_966",color=cyan4, style=filled]
249 -> 250
...
/*@
 assigns \nothing;
 ensures \result == ((( (((ext_ident_word64_960) == (2))) ? (0.0) : (( (((ext_ident_word64_961) == (3))) ? (370.40000000000003) : (( (((ext_ident_word64_962) == (4))) ? (648.1999999999999) : (( (((ext_ident_word64_963) == (5))) ? (1018.6000000000001) : (( (((ext_ident_word64_964) == (6))) ? (1481.6000000000001) : (( (((ext_ident_word64_965) == (7))) ? (2037.2000000000003) : (( (((ext_ident_word64_966) == (8))) ? (2037.2000000000003) : (0.0))))))))))))))));
*/
SDouble ext_ident_double_967_arg0(const SWord64 ext_ident_word64_960,
...
{
  const SWord64 s0 = ext_ident_word64_960;
  const SDouble s1 = ext_ownship_position_z;
  const SWord64 s2 = ext_ident_word64_961;
  const SWord64 s3 = ext_ident_word64_962;
  const SWord64 s4 = ext_ident_word64_963;
  const SWord64 s5 = ext_ident_word64_964;
  const SWord64 s6 = ext_ident_word64_965;
  const SWord64 s7 = ext_ident_word64_966;
