...
3 -> 4
5 [label="ext_ident_double_957",color=cyan4, style=filled]
4 -> 5
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_957) <= (0.0))) || (((ext_ownship_velocity_z) >= (700.0))))) ? (0.0) : (((((700.0) - (ext_ownship_velocity_z))) / (2.0))))));
*/
SDouble ext_ident_double_958_arg0(const SDouble ext_ident_double_957,
...
{
  const SDouble s0 = ext_ident_double_957;
  const SDouble s1 = ext_ident_double_936;
  ...
  const SDouble s10 = ext_ident_double_953;
  const SDouble s11 = ext_ident_double_944;
  const SWord64 s12 = ext_ident_word64_937;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_938;
  const SWord64 s15 = ext_ident_word64_939;
  const SWord64 s16 = ext_ident_word64_940;
  const SWord64 s17 = ext_ident_word64_941;
  const SWord64 s18 = ext_ident_word64_942;
  const SWord64 s19 = ext_ident_word64_943;
  const SDouble s20 = ext_ident_double_952;
  const SWord64 s21 = ext_ident_word64_945;
  const SWord64 s22 = ext_ident_word64_946;
  const SWord64 s23 = ext_ident_word64_947;
  const SWord64 s24 = ext_ident_word64_948;
  const SWord64 s25 = ext_ident_word64_949;
  const SWord64 s26 = ext_ident_word64_950;
  const SWord64 s27 = ext_ident_word64_951;
  const SDouble s28 = ext_ident_double_955;
  const SDouble s29 = ext_ident_double_954;
  const SDouble s30 = ext_ident_double_956;
