/* File: "ext_ident_double_866_arg0.c". Automatically generated by SBV. Do not edit! */
...
3 -> 4
5 [label="ext_ident_double_865",color=cyan4, style=filled]
4 -> 5
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_865) <= (0.0))) || (((ext_ownship_velocity_z) >= (700.0))))) ? (0.0) : (((((700.0) - (ext_ownship_velocity_z))) / (2.0))))));
*/
SDouble ext_ident_double_866_arg0(const SDouble ext_ident_double_865,
...
{
  const SDouble s0 = ext_ident_double_865;
  const SDouble s1 = ext_ident_double_844;
  ...
  const SWord64 s12 = ext_ident_word64_845;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_846;
  const SWord64 s15 = ext_ident_word64_847;
  const SWord64 s16 = ext_ident_word64_848;
  const SWord64 s17 = ext_ident_word64_849;
  const SWord64 s18 = ext_ident_word64_850;
  const SWord64 s19 = ext_ident_word64_851;
  const SDouble s20 = ext_ident_double_860;
  const SWord64 s21 = ext_ident_word64_853;
  const SWord64 s22 = ext_ident_word64_854;
  const SWord64 s23 = ext_ident_word64_855;
  const SWord64 s24 = ext_ident_word64_856;
  const SWord64 s25 = ext_ident_word64_857;
  const SWord64 s26 = ext_ident_word64_858;
  const SWord64 s27 = ext_ident_word64_859;
  const SDouble s28 = ext_ident_double_863;
  const SDouble s29 = ext_ident_double_862;
  const SDouble s30 = ext_ident_double_864;
