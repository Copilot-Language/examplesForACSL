/* File: "ext_ident_double_1374_arg0.c". Automatically generated by SBV. Do not edit! */
...
3 -> 4
5 [label="ext_ident_double_1373",color=cyan4, style=filled]
4 -> 5
...
/*@
 assigns \nothing;
 ensures \result == ((( (((((ext_ident_double_1373) <= (0.0))) || (((((-1.0) * (ext_ownship_velocity_z))) >= (700.0))))) ? (0.0) : (((((-700.0) - (ext_ownship_velocity_z))) / (-2.0))))));
*/
SDouble ext_ident_double_1374_arg0(const SDouble ext_ident_double_1373,
...
{
  const SDouble s0 = ext_ident_double_1373;
  const SDouble s1 = ext_ident_double_1352;
  ...
  const SDouble s10 = ext_ident_double_1369;
  const SDouble s11 = ext_ident_double_1360;
  const SWord64 s12 = ext_ident_word64_1353;
  const SDouble s13 = ext_ownship_position_z;
  const SWord64 s14 = ext_ident_word64_1354;
  const SWord64 s15 = ext_ident_word64_1355;
  const SWord64 s16 = ext_ident_word64_1356;
  const SWord64 s17 = ext_ident_word64_1357;
  const SWord64 s18 = ext_ident_word64_1358;
  const SWord64 s19 = ext_ident_word64_1359;
  const SDouble s20 = ext_ident_double_1368;
  const SWord64 s21 = ext_ident_word64_1361;
  const SWord64 s22 = ext_ident_word64_1362;
  const SWord64 s23 = ext_ident_word64_1363;
  const SWord64 s24 = ext_ident_word64_1364;
  const SWord64 s25 = ext_ident_word64_1365;
  const SWord64 s26 = ext_ident_word64_1366;
  const SWord64 s27 = ext_ident_word64_1367;
  const SDouble s28 = ext_ident_double_1371;
  const SDouble s29 = ext_ident_double_1370;
  const SDouble s30 = ext_ident_double_1372;
