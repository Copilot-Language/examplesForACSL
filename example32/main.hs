...
ownVelocityX = label "?ownVelocityX" $ mux (boot) (extownVelocityX) $ [0]++extownVelocityX
ownVelocityY = label "?ownVelocityY" $ mux (boot) (extownVelocityY) $ [0]++extownVelocityY
ownVelocityZ = label "?ownVelocityZ" $ mux (boot) (extownVelocityZ) $ [0]++extownVelocityZ

ownPositionX = label "?ownPositionX" $ mux (boot) (extownPositionX) $ [0]++extownPositionX
ownPositionY = label "?ownPositionY" $ mux (boot) (extownPositionY) $ [0]++extownPositionY
ownPositionZ = label "?ownPositionZ" $ mux (boot) (extownPositionZ) $ [0]++extownPositionZ
...
intVelocityX = label "?intVelocityX" $ mux (boot) (extintVelocityX) $ [0]++extintVelocityX
intVelocityY = label "?intVelocityY" $ mux (boot) (extintVelocityY) $ [0]++extintVelocityY
intVelocityZ = label "?intVelocityZ" $ mux (boot) (extintVelocityZ) $ [0]++extintVelocityZ

intPositionX = label "?intPositionX" $ mux (boot) (extintPositionX) $ [0]++extintPositionX
intPositionY = label "?intPositionY" $ mux (boot) (extintPositionY) $ [0]++extintPositionY
intPositionZ = label "?intPositionZ" $ mux (boot) (extintPositionZ) $ [0]++extintPositionZ
