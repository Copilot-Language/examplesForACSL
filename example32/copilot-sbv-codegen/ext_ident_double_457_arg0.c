/* File: "ext_ident_double_457_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_456) - (((ext_minimal_horizontal_separation) * (ext_minimal_horizontal_separation))))));
*/
SDouble ext_ident_double_457_arg0(const SDouble ext_ident_double_456,
                                  const SDouble ext_ident_double_448, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_456;
  const SDouble s1 = ext_ident_double_448;
  ...
  const SDouble s7 = ext_ident_double_449;
  const SDouble s8 = ext_intruder_position_x;
  const SDouble s9 = queue_2[0];
  const SWord32 s10 = ptr_2;
  const SDouble s11 = ext_ident_double_450;
  const SDouble s12 = ext_ident_double_451;
  ...
  const SDouble s17 = ext_ident_double_453;
  const SDouble s18 = ext_intruder_position_y;
  const SDouble s19 = queue_5[0];
  const SWord32 s20 = ptr_5;
  const SDouble s21 = ext_ident_double_454;
  const SDouble s22 = ext_ident_double_455;
