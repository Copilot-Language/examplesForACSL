...
/*@
 assigns \nothing;
 ensures \result == ((((0.0) - (ext_ident_double_490))));
*/
SDouble ext_ident_double_491_arg0(const SDouble ext_ident_double_490,
                                  ...
                                  const SWord32 ptr_6)
{
  const SDouble s0 = ext_ident_double_490;
  const SDouble s1 = ext_ident_double_482;
