/* File: "ext_ident_double_988_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_977) / (ext_ident_double_987))));
*/
SDouble ext_ident_double_988_arg0(const SDouble ext_ident_double_977,
...
{
  const SDouble s0 = ext_ident_double_977;
  const SDouble s1 = ext_ident_double_920;
  const SDouble s2 = ext_ident_double_919;
  const SDouble s3 = ext_ident_double_911;
  ...
  const SDouble s9 = ext_ident_double_912;
  const SDouble s10 = ext_intruder_position_x;
  const SDouble s11 = queue_2[0];
  const SWord32 s12 = ptr_2;
  const SDouble s13 = ext_ident_double_913;
  const SDouble s14 = ext_ownship_velocity_x;
  const SDouble s15 = queue_7[0];
  const SWord32 s16 = ptr_7;
  const SDouble s17 = ext_ident_double_914;
  const SDouble s18 = ext_intruder_velocity_x;
  const SDouble s19 = queue_3[0];
  const SWord32 s20 = ptr_3;
  const SDouble s21 = ext_ident_double_915;
  const SDouble s22 = ext_ownship_position_y;
  const SDouble s23 = queue_4[0];
  const SWord32 s24 = ptr_4;
  const SDouble s25 = ext_ident_double_916;
  const SDouble s26 = ext_intruder_position_y;
  const SDouble s27 = queue_5[0];
  const SWord32 s28 = ptr_5;
  const SDouble s29 = ext_ident_double_917;
  const SDouble s30 = ext_ownship_velocity_y;
  const SDouble s31 = queue_8[0];
  const SWord32 s32 = ptr_8;
  const SDouble s33 = ext_ident_double_918;
  const SDouble s34 = ext_intruder_velocity_y;
  const SDouble s35 = queue_6[0];
  const SWord32 s36 = ptr_6;
  const SDouble s37 = ext_ident_double_976;
  const SDouble s38 = ext_ident_double_934;
  const SBool   s39 = ext_ident_bool_929;
  const SDouble s40 = ext_ident_double_928;
  const SDouble s41 = ext_ident_double_923;
  const SDouble s42 = ext_ident_double_921;
  const SDouble s43 = ext_ownship_position_z;
  const SDouble s44 = queue_9[0];
  const SWord32 s45 = ptr_9;
  const SDouble s46 = ext_ident_double_922;
  const SDouble s47 = ext_intruder_position_z;
  const SDouble s48 = queue_10[0];
  const SWord32 s49 = ptr_10;
  const SDouble s50 = ext_ident_double_927;
  const SDouble s51 = ext_ident_double_926;
  const SDouble s52 = ext_ident_double_924;
  const SDouble s53 = ext_ident_double_925;
  const SDouble s54 = ext_minimal_vertical_separation;
  const SDouble s55 = ext_ident_double_933;
  const SDouble s56 = ext_direction_parameter_vertical;
  const SDouble s57 = ext_ident_double_932;
  const SDouble s58 = ext_ident_double_930;
  const SDouble s59 = ext_ident_double_931;
  const SDouble s60 = ext_ident_double_975;
  const SDouble s61 = ext_sqrt_974;
  const SDouble s62 = ext_ident_double_943;
  const SDouble s63 = ext_ident_double_935;
  const SDouble s64 = ext_ident_double_936;
  const SDouble s65 = ext_ident_double_937;
  const SDouble s66 = ext_ident_double_938;
  const SDouble s67 = ext_ident_double_939;
  const SDouble s68 = ext_ident_double_940;
  const SDouble s69 = ext_ident_double_941;
  const SDouble s70 = ext_ident_double_942;
  const SDouble s71 = ext_ident_double_952;
  const SDouble s72 = ext_ident_double_944;
  const SDouble s73 = ext_ident_double_945;
  const SDouble s74 = ext_ident_double_946;
  const SDouble s75 = ext_ident_double_947;
  const SDouble s76 = ext_ident_double_948;
  const SDouble s77 = ext_ident_double_949;
  const SDouble s78 = ext_ident_double_950;
  const SDouble s79 = ext_ident_double_951;
  const SDouble s80 = ext_ident_double_973;
  const SDouble s81 = ext_ident_double_962;
  const SDouble s82 = ext_ident_double_961;
  const SDouble s83 = ext_ident_double_953;
  const SDouble s84 = ext_ident_double_954;
  const SDouble s85 = ext_ident_double_955;
  const SDouble s86 = ext_ident_double_956;
  const SDouble s87 = ext_ident_double_957;
  const SDouble s88 = ext_ident_double_958;
  const SDouble s89 = ext_ident_double_959;
  const SDouble s90 = ext_ident_double_960;
  const SDouble s91 = ext_ident_double_972;
  const SDouble s92 = ext_ident_double_971;
  const SDouble s93 = ext_ident_double_963;
  const SDouble s94 = ext_ident_double_964;
  const SDouble s95 = ext_ident_double_965;
  const SDouble s96 = ext_ident_double_966;
  const SDouble s97 = ext_ident_double_967;
  const SDouble s98 = ext_ident_double_968;
  const SDouble s99 = ext_ident_double_969;
  const SDouble s100 = ext_ident_double_970;
  const SDouble s101 = ext_minimal_horizontal_separation;
  const SDouble s102 = ext_ident_double_987;
  const SDouble s103 = ext_ident_double_986;
  const SDouble s104 = ext_ident_double_978;
  const SDouble s105 = ext_ident_double_979;
  const SDouble s106 = ext_ident_double_980;
  const SDouble s107 = ext_ident_double_981;
  const SDouble s108 = ext_ident_double_982;
  const SDouble s109 = ext_ident_double_983;
  const SDouble s110 = ext_ident_double_984;
  const SDouble s111 = ext_ident_double_985;
