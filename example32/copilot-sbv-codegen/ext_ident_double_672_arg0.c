...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_667) * (ext_ident_double_671))));
*/
SDouble ext_ident_double_672_arg0(const SDouble ext_ident_double_667,
...
{
  const SDouble s0 = ext_ident_double_667;
  const SDouble s1 = ext_ident_double_665;
  ...
  const SDouble s7 = ext_ident_double_666;
  const SDouble s8 = ext_intruder_position_z;
  const SDouble s9 = queue_10[0];
  const SWord32 s10 = ptr_10;
  const SDouble s11 = ext_ident_double_671;
  const SDouble s12 = ext_ident_double_670;
  const SDouble s13 = ext_ident_double_668;
  const SDouble s14 = ext_ident_double_669;
