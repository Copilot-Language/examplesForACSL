/* File: "ext_sqrt_1235_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (((((ext_ident_double_1204) * (ext_ident_double_1213))) - (ext_ident_double_1234)));
*/
SDouble ext_sqrt_1235_arg0(const SDouble ext_ident_double_1204,
...
{
  const SDouble s0 = ext_ident_double_1204;
  const SDouble s1 = ext_ident_double_1196;
  ...
  const SDouble s7 = ext_ident_double_1197;
  const SDouble s8 = ext_intruder_position_x;
  const SDouble s9 = queue_2[0];
  const SWord32 s10 = ptr_2;
  const SDouble s11 = ext_ident_double_1198;
  const SDouble s12 = ext_ownship_velocity_x;
  const SDouble s13 = queue_7[0];
  const SWord32 s14 = ptr_7;
  const SDouble s15 = ext_ident_double_1199;
  const SDouble s16 = ext_intruder_velocity_x;
  const SDouble s17 = queue_3[0];
  const SWord32 s18 = ptr_3;
  const SDouble s19 = ext_ident_double_1200;
  const SDouble s20 = ext_ownship_position_y;
  const SDouble s21 = queue_4[0];
  const SWord32 s22 = ptr_4;
  const SDouble s23 = ext_ident_double_1201;
  const SDouble s24 = ext_intruder_position_y;
  const SDouble s25 = queue_5[0];
  const SWord32 s26 = ptr_5;
  const SDouble s27 = ext_ident_double_1202;
  const SDouble s28 = ext_ownship_velocity_y;
  const SDouble s29 = queue_8[0];
  const SWord32 s30 = ptr_8;
  const SDouble s31 = ext_ident_double_1203;
  const SDouble s32 = ext_intruder_velocity_y;
  const SDouble s33 = queue_6[0];
  const SWord32 s34 = ptr_6;
  const SDouble s35 = ext_ident_double_1213;
  const SDouble s36 = ext_ident_double_1205;
  const SDouble s37 = ext_ident_double_1206;
  const SDouble s38 = ext_ident_double_1207;
  const SDouble s39 = ext_ident_double_1208;
  const SDouble s40 = ext_ident_double_1209;
  const SDouble s41 = ext_ident_double_1210;
  const SDouble s42 = ext_ident_double_1211;
  const SDouble s43 = ext_ident_double_1212;
  const SDouble s44 = ext_ident_double_1234;
  const SDouble s45 = ext_ident_double_1223;
  const SDouble s46 = ext_ident_double_1222;
  const SDouble s47 = ext_ident_double_1214;
  const SDouble s48 = ext_ident_double_1215;
  const SDouble s49 = ext_ident_double_1216;
  const SDouble s50 = ext_ident_double_1217;
  const SDouble s51 = ext_ident_double_1218;
  const SDouble s52 = ext_ident_double_1219;
  const SDouble s53 = ext_ident_double_1220;
  const SDouble s54 = ext_ident_double_1221;
  const SDouble s55 = ext_ident_double_1233;
  const SDouble s56 = ext_ident_double_1232;
  const SDouble s57 = ext_ident_double_1224;
  const SDouble s58 = ext_ident_double_1225;
  const SDouble s59 = ext_ident_double_1226;
  const SDouble s60 = ext_ident_double_1227;
  const SDouble s61 = ext_ident_double_1228;
  const SDouble s62 = ext_ident_double_1229;
  const SDouble s63 = ext_ident_double_1230;
  const SDouble s64 = ext_ident_double_1231;
