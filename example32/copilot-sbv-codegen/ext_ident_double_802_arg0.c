...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_801) - (((ext_minimal_horizontal_separation) * (ext_minimal_horizontal_separation))))));
*/
SDouble ext_ident_double_802_arg0(const SDouble ext_ident_double_801,
                                  const SDouble ext_ident_double_793, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_801;
  const SDouble s1 = ext_ident_double_793;
