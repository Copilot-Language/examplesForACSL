/* File: "ext_ident_double_961_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_953) - (ext_ident_double_954))) * (((ext_ident_double_955) - (ext_ident_double_956))))) + (((((ext_ident_double_957) - (ext_ident_double_958))) * (((ext_ident_double_959) - (ext_ident_double_960))))))));
*/
SDouble ext_ident_double_961_arg0(const SDouble ext_ident_double_953,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_velocity_x, const SDouble *queue_7,
                                  const SWord32 ptr_7, const SDouble ext_ident_double_954,
