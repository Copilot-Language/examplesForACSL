...
/*@
 assigns \nothing;
 ensures \result == ((((0.0) - (ext_ident_double_319))));
*/
SDouble ext_ident_double_320_arg0(const SDouble ext_ident_double_319,
                                  ...
                                  const SWord32 ptr_6)
{
  ...
  const SDouble s1 = ext_ident_double_311;
  ...
  const SDouble s7 = ext_ident_double_312;
