/* File: "ext_ident_double_1147_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_1139) - (ext_ident_double_1140))) * (((ext_ident_double_1141) - (ext_ident_double_1142))))) + (((((ext_ident_double_1143) - (ext_ident_double_1144))) * (((ext_ident_double_1145) - (ext_ident_double_1146))))))));
*/
SDouble ext_ident_double_1147_arg0(const SDouble ext_ident_double_1139,
...
{
  const SDouble s0 = ext_ident_double_1139;
  ...
  const SDouble s6 = ext_ident_double_1140;
  const SDouble s7 = ext_intruder_position_x;
  const SDouble s8 = queue_2[0];
  const SWord32 s9 = ptr_2;
  const SDouble s10 = ext_ident_double_1141;
  const SDouble s11 = ext_ident_double_1142;
  const SDouble s12 = ext_ident_double_1143;
  const SDouble s13 = ext_ownship_position_y;
  const SDouble s14 = queue_4[0];
  const SWord32 s15 = ptr_4;
  const SDouble s16 = ext_ident_double_1144;
  const SDouble s17 = ext_intruder_position_y;
  const SDouble s18 = queue_5[0];
  const SWord32 s19 = ptr_5;
  const SDouble s20 = ext_ident_double_1145;
  const SDouble s21 = ext_ident_double_1146;
