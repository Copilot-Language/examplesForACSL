/* File: "ext_sqrt_42_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (ext_ident_double_41);
*/
SDouble ext_sqrt_42_arg0(const SDouble ext_ident_double_41,
                         const SDouble ext_ident_double_33, const SBool *queue_0,
                         ...
                         const SWord32 ptr_2, const SDouble ext_ident_double_35,
                         ...
                         const SWord32 ptr_4, const SDouble ext_ident_double_38,
                         const SDouble ext_intruder_position_y, const SDouble *queue_5,
                         const SWord32 ptr_5, const SDouble ext_ident_double_39,
                         const SDouble ext_ident_double_40)
{
  ...
  const SDouble s7 = ext_ident_double_34;
  ...
  const SDouble s12 = ext_ident_double_36;
  ...
  const SDouble s17 = ext_ident_double_38;
  const SDouble s18 = ext_intruder_position_y;
  const SDouble s19 = queue_5[0];
  const SWord32 s20 = ptr_5;
  const SDouble s21 = ext_ident_double_39;
  const SDouble s22 = ext_ident_double_40;
  return s0;
}
