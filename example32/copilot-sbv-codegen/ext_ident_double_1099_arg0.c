/* File: "ext_ident_double_1099_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_1097) - (ext_ident_double_1098))));
*/
SDouble ext_ident_double_1099_arg0(const SDouble ext_ident_double_1097,
                                   ...
                                   const SWord32 ptr_10)
{
  ...
  const SDouble s6 = ext_ident_double_1098;
