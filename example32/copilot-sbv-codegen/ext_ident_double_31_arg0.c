/* File: "ext_ident_double_31_arg0.c". Automatically generated by SBV. Do not edit! */
...
SDouble ext_ident_double_31_arg0(const SDouble ext_sqrt_30,
                                 ...
                                 const SWord32 ptr_2, const SDouble ext_ident_double_23,
                                 ...
                                 const SWord32 ptr_4, const SDouble ext_ident_double_26,
                                 const SDouble ext_intruder_position_y, const SDouble *queue_5,
                                 const SWord32 ptr_5, const SDouble ext_ident_double_27,
                                 const SDouble ext_ident_double_28)
{
  const SDouble s0 = ext_sqrt_30;
  const SDouble s1 = ext_ident_double_29;
  const SDouble s2 = ext_ident_double_21;
  ...
  const SDouble s8 = ext_ident_double_22;
  const SDouble s9 = ext_intruder_position_x;
  const SDouble s10 = queue_2[0];
  const SWord32 s11 = ptr_2;
  const SDouble s12 = ext_ident_double_23;
  const SDouble s13 = ext_ident_double_24;
  const SDouble s14 = ext_ident_double_25;
  const SDouble s15 = ext_ownship_position_y;
  const SDouble s16 = queue_4[0];
  const SWord32 s17 = ptr_4;
  const SDouble s18 = ext_ident_double_26;
  const SDouble s19 = ext_intruder_position_y;
  const SDouble s20 = queue_5[0];
  const SWord32 s21 = ptr_5;
  const SDouble s22 = ext_ident_double_27;
  const SDouble s23 = ext_ident_double_28;
  const SDouble s24 = s0 /* exitDotMin_dividend */;
