/* File: "ext_ident_bool_194_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_193) >= (0.0))));
*/
SBool ext_ident_bool_194_arg0(const SDouble ext_ident_double_193,
                              const SDouble ext_ident_double_185, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_193;
  const SDouble s1 = ext_ident_double_185;
  ...
  const SDouble s7 = ext_ident_double_186;
  ...
  const SDouble s12 = ext_ident_double_188;
  const SDouble s13 = ext_ident_double_189;
  const SDouble s14 = ext_ownship_position_y;
  const SDouble s15 = queue_4[0];
  const SWord32 s16 = ptr_4;
  const SDouble s17 = ext_ident_double_190;
  const SDouble s18 = ext_intruder_position_y;
  const SDouble s19 = queue_5[0];
  const SWord32 s20 = ptr_5;
  const SDouble s21 = ext_ident_double_191;
  const SDouble s22 = ext_ident_double_192;
  const SBool   s24 = s0 >= 0.0;
  const SBool   s25 = s24 /* verticalCriterionConflict_part1.1.2 */;
