...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_1205) - (ext_ident_double_1206))) * (((ext_ident_double_1207) - (ext_ident_double_1208))))) + (((((ext_ident_double_1209) - (ext_ident_double_1210))) * (((ext_ident_double_1211) - (ext_ident_double_1212))))))));
*/
SDouble ext_ident_double_1213_arg0(const SDouble ext_ident_double_1205,
                                   const SBool *queue_0, const SWord32 ptr_0,
                                   const SDouble ext_ownship_position_x, const SDouble *queue_1,
                                   const SWord32 ptr_1, const SDouble ext_ident_double_1206,
                                   const SDouble ext_intruder_position_x, const SDouble *queue_2,
                                   const SWord32 ptr_2, const SDouble ext_ident_double_1207,
                                   const SDouble ext_ownship_velocity_x, const SDouble *queue_7,
                                   const SWord32 ptr_7, const SDouble ext_ident_double_1208,
                                   const SDouble ext_intruder_velocity_x, const SDouble *queue_3,
                                   const SWord32 ptr_3, const SDouble ext_ident_double_1209,
                                   const SDouble ext_ownship_position_y, const SDouble *queue_4,
                                   const SWord32 ptr_4, const SDouble ext_ident_double_1210,
                                   const SDouble ext_intruder_position_y, const SDouble *queue_5,
                                   const SWord32 ptr_5, const SDouble ext_ident_double_1211,
                                   const SDouble ext_ownship_velocity_y, const SDouble *queue_8,
                                   const SWord32 ptr_8, const SDouble ext_ident_double_1212,
                                   const SDouble ext_intruder_velocity_y, const SDouble *queue_6,
                                   const SWord32 ptr_6)
{
  const SDouble s0 = ext_ident_double_1205;
