/* File: "ext_ident_double_1110_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_1105) ? (ext_ident_double_1109) : (-1.0))));
*/
SDouble ext_ident_double_1110_arg0(const SBool ext_ident_bool_1105,
...
{
  const SBool   s0 = ext_ident_bool_1105;
  const SDouble s1 = ext_ident_double_1104;
  const SDouble s2 = ext_ident_double_1099;
  const SDouble s3 = ext_ident_double_1097;
  ...
  const SDouble s9 = ext_ident_double_1098;
  const SDouble s10 = ext_intruder_position_z;
  const SDouble s11 = queue_10[0];
  const SWord32 s12 = ptr_10;
  const SDouble s13 = ext_ident_double_1103;
  const SDouble s14 = ext_ident_double_1102;
  const SDouble s15 = ext_ident_double_1100;
  const SDouble s16 = ext_ident_double_1101;
  const SDouble s17 = ext_minimal_vertical_separation;
  const SDouble s18 = ext_ident_double_1109;
  const SDouble s19 = ext_direction_parameter_vertical;
  const SDouble s20 = ext_ident_double_1108;
  const SDouble s21 = ext_ident_double_1106;
  const SDouble s22 = ext_ident_double_1107;
