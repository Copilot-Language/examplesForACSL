...
/*@
 assigns \nothing;
 ensures \result == ((((0.0) - (ext_ident_double_404))));
*/
SDouble ext_ident_double_405_arg0(const SDouble ext_ident_double_404,
                                  ...
                                  const SWord32 ptr_6)
{
  const SDouble s0 = ext_ident_double_404;
  const SDouble s1 = ext_ident_double_396;
  ...
  const SDouble s27 = ext_ident_double_402;
