/* File: "ext_ident_double_923_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_921) - (ext_ident_double_922))));
*/
SDouble ext_ident_double_923_arg0(const SDouble ext_ident_double_921,
...
{
  const SDouble s0 = ext_ident_double_921;
  ...
  const SDouble s6 = ext_ident_double_922;
