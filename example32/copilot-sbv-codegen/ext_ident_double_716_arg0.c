/* File: "ext_ident_double_716_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_715) - (((ext_minimal_horizontal_separation) * (ext_minimal_horizontal_separation))))));
*/
SDouble ext_ident_double_716_arg0(const SDouble ext_ident_double_715,
                                  const SDouble ext_ident_double_707, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_715;
  const SDouble s1 = ext_ident_double_707;
