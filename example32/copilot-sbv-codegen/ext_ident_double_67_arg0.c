...
/*test 003*/
/*ACSL to write
 label "zCriterion_part2.2.1" signum (Extf_ident_double(label "ownVelocityZ" (if s0 then Ext_ownship_velocity_z else s12)) - Extf_ident_double(label "intVelocityZ" (if s0 then Ext_intruder_velocity_z else s11)))
*/
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ident_double_65) - (ext_ident_double_66))) > 0)? 1 : ((((ext_ident_double_65) - (ext_ident_double_66))) < 0 ? -1 : 0)));
*/
SDouble ext_ident_double_67_arg0(const SDouble ext_ident_double_65,
                                 ...
                                 const SWord32 ptr_11)
{
  ...
  const SDouble s6 = ext_ident_double_66;
  ...
  const SDouble s18 = s17 /* zCriterion_part2.2.1 */;
