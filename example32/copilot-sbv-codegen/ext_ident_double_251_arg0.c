...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_246) ? (ext_ident_double_250) : (-1.0))));
*/
SDouble ext_ident_double_251_arg0(const SBool ext_ident_bool_246,
...
{
  const SBool   s0 = ext_ident_bool_246;
  const SDouble s1 = ext_ident_double_245;
  const SDouble s2 = ext_ident_double_240;
  const SDouble s3 = ext_ident_double_238;
  ...
  const SDouble s9 = ext_ident_double_239;
  const SDouble s10 = ext_intruder_position_z;
  const SDouble s11 = queue_10[0];
  const SWord32 s12 = ptr_10;
  const SDouble s13 = ext_ident_double_244;
  const SDouble s14 = ext_ident_double_243;
  const SDouble s15 = ext_ident_double_241;
  const SDouble s16 = ext_ident_double_242;
  ...
  const SDouble s21 = ext_ident_double_247;
  const SDouble s22 = ext_ident_double_248;
