/* File: "ext_ident_double_1153_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_1096) + (ext_ident_double_1152))));
*/
SDouble ext_ident_double_1153_arg0(const SDouble ext_ident_double_1096,
...
{
  const SDouble s0 = ext_ident_double_1096;
  const SDouble s1 = ext_ident_double_1095;
  const SDouble s2 = ext_ident_double_1087;
  ...
  const SDouble s32 = ext_ident_double_1094;
  const SDouble s33 = ext_intruder_velocity_y;
  const SDouble s34 = queue_6[0];
  const SWord32 s35 = ptr_6;
  const SDouble s36 = ext_ident_double_1152;
  const SDouble s37 = ext_ident_double_1110;
  const SBool   s38 = ext_ident_bool_1105;
  const SDouble s39 = ext_ident_double_1104;
  const SDouble s40 = ext_ident_double_1099;
  const SDouble s41 = ext_ident_double_1097;
  const SDouble s42 = ext_ownship_position_z;
  const SDouble s43 = queue_9[0];
  const SWord32 s44 = ptr_9;
  const SDouble s45 = ext_ident_double_1098;
  const SDouble s46 = ext_intruder_position_z;
  const SDouble s47 = queue_10[0];
  const SWord32 s48 = ptr_10;
  const SDouble s49 = ext_ident_double_1103;
  const SDouble s50 = ext_ident_double_1102;
  const SDouble s51 = ext_ident_double_1100;
  const SDouble s52 = ext_ident_double_1101;
  const SDouble s53 = ext_minimal_vertical_separation;
  const SDouble s54 = ext_ident_double_1109;
  const SDouble s55 = ext_direction_parameter_vertical;
  const SDouble s56 = ext_ident_double_1108;
  const SDouble s57 = ext_ident_double_1106;
  const SDouble s58 = ext_ident_double_1107;
  const SDouble s59 = ext_ident_double_1151;
  const SDouble s60 = ext_sqrt_1150;
  const SDouble s61 = ext_ident_double_1119;
  const SDouble s62 = ext_ident_double_1111;
  const SDouble s63 = ext_ident_double_1112;
  const SDouble s64 = ext_ident_double_1113;
  const SDouble s65 = ext_ident_double_1114;
  const SDouble s66 = ext_ident_double_1115;
  const SDouble s67 = ext_ident_double_1116;
  const SDouble s68 = ext_ident_double_1117;
  const SDouble s69 = ext_ident_double_1118;
  const SDouble s70 = ext_ident_double_1128;
  const SDouble s71 = ext_ident_double_1120;
  const SDouble s72 = ext_ident_double_1121;
  const SDouble s73 = ext_ident_double_1122;
  const SDouble s74 = ext_ident_double_1123;
  const SDouble s75 = ext_ident_double_1124;
  const SDouble s76 = ext_ident_double_1125;
  const SDouble s77 = ext_ident_double_1126;
  const SDouble s78 = ext_ident_double_1127;
  const SDouble s79 = ext_ident_double_1149;
  const SDouble s80 = ext_ident_double_1138;
  const SDouble s81 = ext_ident_double_1137;
  const SDouble s82 = ext_ident_double_1129;
  const SDouble s83 = ext_ident_double_1130;
  const SDouble s84 = ext_ident_double_1131;
  const SDouble s85 = ext_ident_double_1132;
  const SDouble s86 = ext_ident_double_1133;
  const SDouble s87 = ext_ident_double_1134;
  const SDouble s88 = ext_ident_double_1135;
  const SDouble s89 = ext_ident_double_1136;
  const SDouble s90 = ext_ident_double_1148;
  const SDouble s91 = ext_ident_double_1147;
  const SDouble s92 = ext_ident_double_1139;
  const SDouble s93 = ext_ident_double_1140;
  const SDouble s94 = ext_ident_double_1141;
  const SDouble s95 = ext_ident_double_1142;
  const SDouble s96 = ext_ident_double_1143;
  const SDouble s97 = ext_ident_double_1144;
  const SDouble s98 = ext_ident_double_1145;
  const SDouble s99 = ext_ident_double_1146;
