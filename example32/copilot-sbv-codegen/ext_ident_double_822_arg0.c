/* File: "ext_ident_double_822_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ident_double_739) - (ext_ident_double_740))) + (((ext_ident_double_819) * (((ext_ident_double_820) - (ext_ident_double_821))))))));
*/
SDouble ext_ident_double_822_arg0(const SDouble ext_ident_double_739,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_y, const SDouble *queue_4,
                                  const SWord32 ptr_4, const SDouble ext_ident_double_740,
                                  const SDouble ext_intruder_position_y, const SDouble *queue_5,
                                  const SWord32 ptr_5, const SDouble ext_ident_double_819,
                                  ...
                                  const SWord32 ptr_1, const SDouble ext_ident_double_742,
                                  ...
                                  const SDouble ext_ident_double_821)
{
  ...
  const SDouble s6 = ext_ident_double_740;
  const SDouble s7 = ext_intruder_position_y;
  const SDouble s8 = queue_5[0];
  const SWord32 s9 = ptr_5;
  const SDouble s10 = ext_ident_double_819;
  const SDouble s11 = ext_ident_double_818;
  const SDouble s12 = ext_ident_double_807;
  const SDouble s13 = ext_ident_double_750;
  const SDouble s14 = ext_ident_double_749;
  const SDouble s15 = ext_ident_double_741;
  const SDouble s16 = ext_ownship_position_x;
  const SDouble s17 = queue_1[0];
  const SWord32 s18 = ptr_1;
  const SDouble s19 = ext_ident_double_742;
  const SDouble s20 = ext_intruder_position_x;
  const SDouble s21 = queue_2[0];
  const SWord32 s22 = ptr_2;
  const SDouble s23 = ext_ident_double_743;
  const SDouble s24 = ext_ownship_velocity_x;
  const SDouble s25 = queue_7[0];
  const SWord32 s26 = ptr_7;
  const SDouble s27 = ext_ident_double_744;
  const SDouble s28 = ext_intruder_velocity_x;
  const SDouble s29 = queue_3[0];
  const SWord32 s30 = ptr_3;
  const SDouble s31 = ext_ident_double_745;
  const SDouble s32 = ext_ident_double_746;
  const SDouble s33 = ext_ident_double_747;
  const SDouble s34 = ext_ownship_velocity_y;
  const SDouble s35 = queue_8[0];
  const SWord32 s36 = ptr_8;
  const SDouble s37 = ext_ident_double_748;
  const SDouble s38 = ext_intruder_velocity_y;
  const SDouble s39 = queue_6[0];
  const SWord32 s40 = ptr_6;
  const SDouble s41 = ext_ident_double_806;
  const SDouble s42 = ext_ident_double_764;
  const SBool   s43 = ext_ident_bool_759;
  const SDouble s44 = ext_ident_double_758;
  const SDouble s45 = ext_ident_double_753;
  const SDouble s46 = ext_ident_double_751;
  const SDouble s47 = ext_ownship_position_z;
  const SDouble s48 = queue_9[0];
  const SWord32 s49 = ptr_9;
  const SDouble s50 = ext_ident_double_752;
  const SDouble s51 = ext_intruder_position_z;
  const SDouble s52 = queue_10[0];
  const SWord32 s53 = ptr_10;
  const SDouble s54 = ext_ident_double_757;
  const SDouble s55 = ext_ident_double_756;
  const SDouble s56 = ext_ident_double_754;
  const SDouble s57 = ext_ident_double_755;
  const SDouble s58 = ext_minimal_vertical_separation;
  const SDouble s59 = ext_ident_double_763;
  const SDouble s60 = ext_direction_parameter_vertical;
  const SDouble s61 = ext_ident_double_762;
  const SDouble s62 = ext_ident_double_760;
  const SDouble s63 = ext_ident_double_761;
  const SDouble s64 = ext_ident_double_805;
  const SDouble s65 = ext_sqrt_804;
  const SDouble s66 = ext_ident_double_773;
  const SDouble s67 = ext_ident_double_765;
  const SDouble s68 = ext_ident_double_766;
  const SDouble s69 = ext_ident_double_767;
  const SDouble s70 = ext_ident_double_768;
  const SDouble s71 = ext_ident_double_769;
  const SDouble s72 = ext_ident_double_770;
  const SDouble s73 = ext_ident_double_771;
  const SDouble s74 = ext_ident_double_772;
  const SDouble s75 = ext_ident_double_782;
  const SDouble s76 = ext_ident_double_774;
  const SDouble s77 = ext_ident_double_775;
  const SDouble s78 = ext_ident_double_776;
  const SDouble s79 = ext_ident_double_777;
  const SDouble s80 = ext_ident_double_778;
  const SDouble s81 = ext_ident_double_779;
  const SDouble s82 = ext_ident_double_780;
  const SDouble s83 = ext_ident_double_781;
  const SDouble s84 = ext_ident_double_803;
  const SDouble s85 = ext_ident_double_792;
  const SDouble s86 = ext_ident_double_791;
  const SDouble s87 = ext_ident_double_783;
  const SDouble s88 = ext_ident_double_784;
  const SDouble s89 = ext_ident_double_785;
  const SDouble s90 = ext_ident_double_786;
  const SDouble s91 = ext_ident_double_787;
  const SDouble s92 = ext_ident_double_788;
  const SDouble s93 = ext_ident_double_789;
  const SDouble s94 = ext_ident_double_790;
  const SDouble s95 = ext_ident_double_802;
  const SDouble s96 = ext_ident_double_801;
  const SDouble s97 = ext_ident_double_793;
  const SDouble s98 = ext_ident_double_794;
  const SDouble s99 = ext_ident_double_795;
  const SDouble s100 = ext_ident_double_796;
  const SDouble s101 = ext_ident_double_797;
  const SDouble s102 = ext_ident_double_798;
  const SDouble s103 = ext_ident_double_799;
  const SDouble s104 = ext_ident_double_800;
  const SDouble s105 = ext_minimal_horizontal_separation;
  const SDouble s106 = ext_ident_double_817;
  const SDouble s107 = ext_ident_double_816;
  const SDouble s108 = ext_ident_double_808;
  const SDouble s109 = ext_ident_double_809;
  const SDouble s110 = ext_ident_double_810;
  const SDouble s111 = ext_ident_double_811;
  const SDouble s112 = ext_ident_double_812;
  const SDouble s113 = ext_ident_double_813;
  const SDouble s114 = ext_ident_double_814;
  const SDouble s115 = ext_ident_double_815;
  const SDouble s116 = ext_ident_double_820;
  const SDouble s117 = ext_ident_double_821;
