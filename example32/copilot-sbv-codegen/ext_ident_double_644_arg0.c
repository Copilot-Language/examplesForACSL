/* File: "ext_ident_double_644_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_633) / (ext_ident_double_643))));
*/
SDouble ext_ident_double_644_arg0(const SDouble ext_ident_double_633,
                                  const SDouble ext_ident_double_576,
                                  const SDouble ext_ident_double_575,
                                  const SDouble ext_ident_double_567, const SBool *queue_0,
                                  ...
                                  const SWord32 ptr_4, const SDouble ext_ident_double_572,
                                  const SDouble ext_intruder_position_y, const SDouble *queue_5,
                                  const SWord32 ptr_5, const SDouble ext_ident_double_573,
...
{
  const SDouble s0 = ext_ident_double_633;
  const SDouble s1 = ext_ident_double_576;
  const SDouble s2 = ext_ident_double_575;
  const SDouble s3 = ext_ident_double_567;
  ...
  const SDouble s9 = ext_ident_double_568;
  const SDouble s10 = ext_intruder_position_x;
  const SDouble s11 = queue_2[0];
  const SWord32 s12 = ptr_2;
  const SDouble s13 = ext_ident_double_569;
  const SDouble s14 = ext_ownship_velocity_x;
  const SDouble s15 = queue_7[0];
  const SWord32 s16 = ptr_7;
  const SDouble s17 = ext_ident_double_570;
  const SDouble s18 = ext_intruder_velocity_x;
  const SDouble s19 = queue_3[0];
  const SWord32 s20 = ptr_3;
  const SDouble s21 = ext_ident_double_571;
  const SDouble s22 = ext_ownship_position_y;
  const SDouble s23 = queue_4[0];
  const SWord32 s24 = ptr_4;
  const SDouble s25 = ext_ident_double_572;
  const SDouble s26 = ext_intruder_position_y;
  const SDouble s27 = queue_5[0];
  const SWord32 s28 = ptr_5;
  const SDouble s29 = ext_ident_double_573;
  const SDouble s30 = ext_ownship_velocity_y;
  const SDouble s31 = queue_8[0];
  const SWord32 s32 = ptr_8;
  const SDouble s33 = ext_ident_double_574;
  const SDouble s34 = ext_intruder_velocity_y;
  const SDouble s35 = queue_6[0];
  const SWord32 s36 = ptr_6;
  const SDouble s37 = ext_ident_double_632;
  const SDouble s38 = ext_ident_double_590;
  const SBool   s39 = ext_ident_bool_585;
  const SDouble s40 = ext_ident_double_584;
  const SDouble s41 = ext_ident_double_579;
  const SDouble s42 = ext_ident_double_577;
  const SDouble s43 = ext_ownship_position_z;
  const SDouble s44 = queue_9[0];
  const SWord32 s45 = ptr_9;
  const SDouble s46 = ext_ident_double_578;
  const SDouble s47 = ext_intruder_position_z;
  const SDouble s48 = queue_10[0];
  const SWord32 s49 = ptr_10;
  const SDouble s50 = ext_ident_double_583;
  const SDouble s51 = ext_ident_double_582;
  const SDouble s52 = ext_ident_double_580;
  const SDouble s53 = ext_ident_double_581;
  const SDouble s54 = ext_minimal_vertical_separation;
  const SDouble s55 = ext_ident_double_589;
  const SDouble s56 = ext_direction_parameter_vertical;
  const SDouble s57 = ext_ident_double_588;
  const SDouble s58 = ext_ident_double_586;
  const SDouble s59 = ext_ident_double_587;
  const SDouble s60 = ext_ident_double_631;
  const SDouble s61 = ext_sqrt_630;
  const SDouble s62 = ext_ident_double_599;
  const SDouble s63 = ext_ident_double_591;
  const SDouble s64 = ext_ident_double_592;
  const SDouble s65 = ext_ident_double_593;
  const SDouble s66 = ext_ident_double_594;
  const SDouble s67 = ext_ident_double_595;
  const SDouble s68 = ext_ident_double_596;
  const SDouble s69 = ext_ident_double_597;
  const SDouble s70 = ext_ident_double_598;
  const SDouble s71 = ext_ident_double_608;
  const SDouble s72 = ext_ident_double_600;
  const SDouble s73 = ext_ident_double_601;
  const SDouble s74 = ext_ident_double_602;
  const SDouble s75 = ext_ident_double_603;
  const SDouble s76 = ext_ident_double_604;
  const SDouble s77 = ext_ident_double_605;
  const SDouble s78 = ext_ident_double_606;
  const SDouble s79 = ext_ident_double_607;
  const SDouble s80 = ext_ident_double_629;
  const SDouble s81 = ext_ident_double_618;
  const SDouble s82 = ext_ident_double_617;
  const SDouble s83 = ext_ident_double_609;
  const SDouble s84 = ext_ident_double_610;
  const SDouble s85 = ext_ident_double_611;
  const SDouble s86 = ext_ident_double_612;
  const SDouble s87 = ext_ident_double_613;
  const SDouble s88 = ext_ident_double_614;
  const SDouble s89 = ext_ident_double_615;
  const SDouble s90 = ext_ident_double_616;
  const SDouble s91 = ext_ident_double_628;
  const SDouble s92 = ext_ident_double_627;
  const SDouble s93 = ext_ident_double_619;
  const SDouble s94 = ext_ident_double_620;
  const SDouble s95 = ext_ident_double_621;
  const SDouble s96 = ext_ident_double_622;
  const SDouble s97 = ext_ident_double_623;
  const SDouble s98 = ext_ident_double_624;
  const SDouble s99 = ext_ident_double_625;
  const SDouble s100 = ext_ident_double_626;
  const SDouble s101 = ext_minimal_horizontal_separation;
  const SDouble s102 = ext_ident_double_643;
  const SDouble s103 = ext_ident_double_642;
  const SDouble s104 = ext_ident_double_634;
  const SDouble s105 = ext_ident_double_635;
  const SDouble s106 = ext_ident_double_636;
  const SDouble s107 = ext_ident_double_637;
  const SDouble s108 = ext_ident_double_638;
  const SDouble s109 = ext_ident_double_639;
  const SDouble s110 = ext_ident_double_640;
  const SDouble s111 = ext_ident_double_641;
