...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_627) - (((ext_minimal_horizontal_separation) * (ext_minimal_horizontal_separation))))));
*/
SDouble ext_ident_double_628_arg0(const SDouble ext_ident_double_627,
                                  const SDouble ext_ident_double_619, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_627;
  const SDouble s1 = ext_ident_double_619;
