/* File: "ext_ident_double_1280_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_1275) ? (ext_ident_double_1279) : (-1.0))));
*/
SDouble ext_ident_double_1280_arg0(const SBool ext_ident_bool_1275,
...
{
  const SBool   s0 = ext_ident_bool_1275;
  const SDouble s1 = ext_ident_double_1274;
  const SDouble s2 = ext_ident_double_1269;
  const SDouble s3 = ext_ident_double_1267;
  ...
  const SDouble s9 = ext_ident_double_1268;
  const SDouble s10 = ext_intruder_position_z;
  const SDouble s11 = queue_10[0];
  const SWord32 s12 = ptr_10;
  const SDouble s13 = ext_ident_double_1273;
  const SDouble s14 = ext_ident_double_1272;
  const SDouble s15 = ext_ident_double_1270;
  const SDouble s16 = ext_ident_double_1271;
  const SDouble s17 = ext_minimal_vertical_separation;
  const SDouble s18 = ext_ident_double_1279;
  const SDouble s19 = ext_direction_parameter_vertical;
  const SDouble s20 = ext_ident_double_1278;
  const SDouble s21 = ext_ident_double_1276;
  const SDouble s22 = ext_ident_double_1277;
