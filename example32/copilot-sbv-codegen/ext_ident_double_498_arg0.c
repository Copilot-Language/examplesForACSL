/* File: "ext_ident_double_498_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_497) > 0)? 1 : ((ext_ident_double_497) < 0 ? -1 : 0)));
*/
SDouble ext_ident_double_498_arg0(const SDouble ext_ident_double_497,
                                  const SDouble ext_ident_double_495, const SBool *queue_0,
                                  ...
                                  const SWord32 ptr_10)
{
  ...
  const SDouble s1 = ext_ident_double_495;
  ...
  const SDouble s7 = ext_ident_double_496;
