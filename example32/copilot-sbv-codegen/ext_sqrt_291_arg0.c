/* File: "ext_sqrt_291_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (((((ext_ident_double_260) * (ext_ident_double_269))) - (ext_ident_double_290)));
*/
SDouble ext_sqrt_291_arg0(const SDouble ext_ident_double_260,
...
{
  const SDouble s0 = ext_ident_double_260;
  const SDouble s1 = ext_ident_double_252;
  ...
  const SDouble s35 = ext_ident_double_269;
  const SDouble s36 = ext_ident_double_261;
  const SDouble s37 = ext_ident_double_262;
  const SDouble s38 = ext_ident_double_263;
  const SDouble s39 = ext_ident_double_264;
  const SDouble s40 = ext_ident_double_265;
  const SDouble s41 = ext_ident_double_266;
  const SDouble s42 = ext_ident_double_267;
  const SDouble s43 = ext_ident_double_268;
  const SDouble s44 = ext_ident_double_290;
  const SDouble s45 = ext_ident_double_279;
  const SDouble s46 = ext_ident_double_278;
  const SDouble s47 = ext_ident_double_270;
  const SDouble s48 = ext_ident_double_271;
  const SDouble s49 = ext_ident_double_272;
  const SDouble s50 = ext_ident_double_273;
  const SDouble s51 = ext_ident_double_274;
  const SDouble s52 = ext_ident_double_275;
  const SDouble s53 = ext_ident_double_276;
  const SDouble s54 = ext_ident_double_277;
  const SDouble s55 = ext_ident_double_289;
  const SDouble s56 = ext_ident_double_288;
  const SDouble s57 = ext_ident_double_280;
  const SDouble s58 = ext_ident_double_281;
  const SDouble s59 = ext_ident_double_282;
  const SDouble s60 = ext_ident_double_283;
  const SDouble s61 = ext_ident_double_284;
  const SDouble s62 = ext_ident_double_285;
  const SDouble s63 = ext_ident_double_286;
  const SDouble s64 = ext_ident_double_287;
