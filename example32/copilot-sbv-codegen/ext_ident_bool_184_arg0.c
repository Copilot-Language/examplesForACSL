...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_183) <= (0.0))));
*/
                              ...
                              const SDouble ext_ident_double_182)
{
  ...
  const SDouble s1 = ext_ident_double_175;
  ...
  const SDouble s7 = ext_ident_double_176;
  ...
  const SDouble s12 = ext_ident_double_178;
  const SDouble s13 = ext_ident_double_179;
  ...
  const SDouble s22 = ext_ident_double_182;
  const SBool   s24 = s0 <= 0.0;
  const SBool   s25 = s24 /* verticalCriterionConflict_part1.1.1 */;
