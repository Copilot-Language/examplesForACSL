/* File: "ext_ident_double_1168_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ident_double_1085) - (ext_ident_double_1086))) + (((ext_ident_double_1165) * (((ext_ident_double_1166) - (ext_ident_double_1167))))))));
*/
SDouble ext_ident_double_1168_arg0(const SDouble ext_ident_double_1085,
                                   const SBool *queue_0, const SWord32 ptr_0,
                                   const SDouble ext_ownship_position_y, const SDouble *queue_4,
                                   const SWord32 ptr_4, const SDouble ext_ident_double_1086,
                                   const SDouble ext_intruder_position_y, const SDouble *queue_5,
                                   const SWord32 ptr_5, const SDouble ext_ident_double_1165,
                                   ...
                                   const SWord32 ptr_1, const SDouble ext_ident_double_1088,
                                   const SDouble ext_intruder_position_x, const SDouble *queue_2,
                                   const SWord32 ptr_2, const SDouble ext_ident_double_1089,
                                   const SDouble ext_ownship_velocity_x, const SDouble *queue_7,
                                   const SWord32 ptr_7, const SDouble ext_ident_double_1090,
                                   const SDouble ext_intruder_velocity_x, const SDouble *queue_3,
                                   const SWord32 ptr_3, const SDouble ext_ident_double_1091,
                                   ...
                                   const SWord32 ptr_8, const SDouble ext_ident_double_1094,
                                   const SDouble ext_intruder_velocity_y, const SDouble *queue_6,
                                   const SWord32 ptr_6, const SDouble ext_ident_double_1152,
                                   ...
                                   const SWord32 ptr_9, const SDouble ext_ident_double_1098,
...
{
  const SDouble s0 = ext_ident_double_1085;
  ...
  const SDouble s6 = ext_ident_double_1086;
  const SDouble s7 = ext_intruder_position_y;
  const SDouble s8 = queue_5[0];
  const SWord32 s9 = ptr_5;
  const SDouble s10 = ext_ident_double_1165;
  const SDouble s11 = ext_ident_double_1164;
  const SDouble s12 = ext_ident_double_1153;
  const SDouble s13 = ext_ident_double_1096;
  const SDouble s14 = ext_ident_double_1095;
  const SDouble s15 = ext_ident_double_1087;
  const SDouble s16 = ext_ownship_position_x;
  const SDouble s17 = queue_1[0];
  const SWord32 s18 = ptr_1;
  const SDouble s19 = ext_ident_double_1088;
  const SDouble s20 = ext_intruder_position_x;
  const SDouble s21 = queue_2[0];
  const SWord32 s22 = ptr_2;
  const SDouble s23 = ext_ident_double_1089;
  const SDouble s24 = ext_ownship_velocity_x;
  const SDouble s25 = queue_7[0];
  const SWord32 s26 = ptr_7;
  const SDouble s27 = ext_ident_double_1090;
  const SDouble s28 = ext_intruder_velocity_x;
  const SDouble s29 = queue_3[0];
  const SWord32 s30 = ptr_3;
  const SDouble s31 = ext_ident_double_1091;
  const SDouble s32 = ext_ident_double_1092;
  const SDouble s33 = ext_ident_double_1093;
  const SDouble s34 = ext_ownship_velocity_y;
  const SDouble s35 = queue_8[0];
  const SWord32 s36 = ptr_8;
  const SDouble s37 = ext_ident_double_1094;
  const SDouble s38 = ext_intruder_velocity_y;
  const SDouble s39 = queue_6[0];
  const SWord32 s40 = ptr_6;
  const SDouble s41 = ext_ident_double_1152;
  const SDouble s42 = ext_ident_double_1110;
  const SBool   s43 = ext_ident_bool_1105;
  const SDouble s44 = ext_ident_double_1104;
  const SDouble s45 = ext_ident_double_1099;
  const SDouble s46 = ext_ident_double_1097;
  const SDouble s47 = ext_ownship_position_z;
  const SDouble s48 = queue_9[0];
  const SWord32 s49 = ptr_9;
  const SDouble s50 = ext_ident_double_1098;
  const SDouble s51 = ext_intruder_position_z;
  const SDouble s52 = queue_10[0];
  const SWord32 s53 = ptr_10;
  const SDouble s54 = ext_ident_double_1103;
  const SDouble s55 = ext_ident_double_1102;
  const SDouble s56 = ext_ident_double_1100;
  const SDouble s57 = ext_ident_double_1101;
  const SDouble s58 = ext_minimal_vertical_separation;
  const SDouble s59 = ext_ident_double_1109;
  const SDouble s60 = ext_direction_parameter_vertical;
  const SDouble s61 = ext_ident_double_1108;
  const SDouble s62 = ext_ident_double_1106;
  const SDouble s63 = ext_ident_double_1107;
  const SDouble s64 = ext_ident_double_1151;
  const SDouble s65 = ext_sqrt_1150;
  const SDouble s66 = ext_ident_double_1119;
  const SDouble s67 = ext_ident_double_1111;
  const SDouble s68 = ext_ident_double_1112;
  const SDouble s69 = ext_ident_double_1113;
  const SDouble s70 = ext_ident_double_1114;
  const SDouble s71 = ext_ident_double_1115;
  const SDouble s72 = ext_ident_double_1116;
  const SDouble s73 = ext_ident_double_1117;
  const SDouble s74 = ext_ident_double_1118;
  const SDouble s75 = ext_ident_double_1128;
  const SDouble s76 = ext_ident_double_1120;
  const SDouble s77 = ext_ident_double_1121;
  const SDouble s78 = ext_ident_double_1122;
  const SDouble s79 = ext_ident_double_1123;
  const SDouble s80 = ext_ident_double_1124;
  const SDouble s81 = ext_ident_double_1125;
  const SDouble s82 = ext_ident_double_1126;
  const SDouble s83 = ext_ident_double_1127;
  const SDouble s84 = ext_ident_double_1149;
  const SDouble s85 = ext_ident_double_1138;
  const SDouble s86 = ext_ident_double_1137;
  const SDouble s87 = ext_ident_double_1129;
  const SDouble s88 = ext_ident_double_1130;
  const SDouble s89 = ext_ident_double_1131;
  const SDouble s90 = ext_ident_double_1132;
  const SDouble s91 = ext_ident_double_1133;
  const SDouble s92 = ext_ident_double_1134;
  const SDouble s93 = ext_ident_double_1135;
  const SDouble s94 = ext_ident_double_1136;
  const SDouble s95 = ext_ident_double_1148;
  const SDouble s96 = ext_ident_double_1147;
  const SDouble s97 = ext_ident_double_1139;
  const SDouble s98 = ext_ident_double_1140;
  const SDouble s99 = ext_ident_double_1141;
  const SDouble s100 = ext_ident_double_1142;
  const SDouble s101 = ext_ident_double_1143;
  const SDouble s102 = ext_ident_double_1144;
  const SDouble s103 = ext_ident_double_1145;
  const SDouble s104 = ext_ident_double_1146;
  const SDouble s105 = ext_minimal_horizontal_separation;
  const SDouble s106 = ext_ident_double_1163;
  const SDouble s107 = ext_ident_double_1162;
  const SDouble s108 = ext_ident_double_1154;
  const SDouble s109 = ext_ident_double_1155;
  const SDouble s110 = ext_ident_double_1156;
  const SDouble s111 = ext_ident_double_1157;
  const SDouble s112 = ext_ident_double_1158;
  const SDouble s113 = ext_ident_double_1159;
  const SDouble s114 = ext_ident_double_1160;
  const SDouble s115 = ext_ident_double_1161;
  const SDouble s116 = ext_ident_double_1166;
  const SDouble s117 = ext_ident_double_1167;
