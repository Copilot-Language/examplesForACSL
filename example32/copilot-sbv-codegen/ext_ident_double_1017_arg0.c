/* File: "ext_ident_double_1017_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_1016) > 0)? 1 : ((ext_ident_double_1016) < 0 ? -1 : 0)));
*/
SDouble ext_ident_double_1017_arg0(const SDouble ext_ident_double_1016,
                                   const SDouble ext_ident_double_1014, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_1016;
  const SDouble s1 = ext_ident_double_1014;
  ...
  const SDouble s7 = ext_ident_double_1015;
