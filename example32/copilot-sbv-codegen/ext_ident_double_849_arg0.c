/* File: "ext_ident_double_849_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_844) ? (ext_ident_double_848) : (-1.0))));
*/
SDouble ext_ident_double_849_arg0(const SBool ext_ident_bool_844,
...
{
  const SBool   s0 = ext_ident_bool_844;
  const SDouble s1 = ext_ident_double_843;
  const SDouble s2 = ext_ident_double_838;
  const SDouble s3 = ext_ident_double_836;
  ...
  const SDouble s9 = ext_ident_double_837;
  const SDouble s10 = ext_intruder_position_z;
  const SDouble s11 = queue_10[0];
  const SWord32 s12 = ptr_10;
  const SDouble s13 = ext_ident_double_842;
  const SDouble s14 = ext_ident_double_841;
  const SDouble s15 = ext_ident_double_839;
  const SDouble s16 = ext_ident_double_840;
  const SDouble s17 = ext_minimal_vertical_separation;
  const SDouble s18 = ext_ident_double_848;
  const SDouble s19 = ext_direction_parameter_vertical;
  const SDouble s20 = ext_ident_double_847;
  const SDouble s21 = ext_ident_double_845;
  const SDouble s22 = ext_ident_double_846;
