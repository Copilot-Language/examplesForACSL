/* File: "ext_ident_double_1269_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_1267) - (ext_ident_double_1268))));
*/
SDouble ext_ident_double_1269_arg0(const SDouble ext_ident_double_1267,
...
{
  const SDouble s0 = ext_ident_double_1267;
  ...
  const SDouble s6 = ext_ident_double_1268;
