/* File: "ext_ident_double_1180_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_1172) - (ext_ident_double_1173))) * (((ext_ident_double_1174) - (ext_ident_double_1175))))) + (((((ext_ident_double_1176) - (ext_ident_double_1177))) * (((ext_ident_double_1178) - (ext_ident_double_1179))))))));
*/
SDouble ext_ident_double_1180_arg0(const SDouble ext_ident_double_1172,
                                   const SBool *queue_0, const SWord32 ptr_0,
                                   const SDouble ext_ownship_position_x, const SDouble *queue_1,
                                   const SWord32 ptr_1, const SDouble ext_ident_double_1173,
                                   ...
                                   const SWord32 ptr_6)
{
  const SDouble s0 = ext_ident_double_1172;
  ...
  const SDouble s6 = ext_ident_double_1173;
