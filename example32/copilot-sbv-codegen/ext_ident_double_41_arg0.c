...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_33) - (ext_ident_double_34))) * (((ext_ident_double_35) - (ext_ident_double_36))))) + (((((ext_ident_double_37) - (ext_ident_double_38))) * (((ext_ident_double_39) - (ext_ident_double_40))))))));
*/
SDouble ext_ident_double_41_arg0(const SDouble ext_ident_double_33,
                                 const SBool *queue_0, const SWord32 ptr_0,
                                 const SDouble ext_ownship_position_x, const SDouble *queue_1,
                                 const SWord32 ptr_1, const SDouble ext_ident_double_34,
...
{
  const SDouble s0 = ext_ident_double_33;
  ...
  const SDouble s11 = ext_ident_double_36;
  ...
  const SDouble s16 = ext_ident_double_38;
  ...
  const SDouble s21 = ext_ident_double_40;
