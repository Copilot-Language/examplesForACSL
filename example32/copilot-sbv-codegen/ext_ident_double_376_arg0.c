/* File: "ext_ident_double_376_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_334) * (ext_ident_double_375))));
*/
SDouble ext_ident_double_376_arg0(const SDouble ext_ident_double_334,
                                  ...
                                  const SWord32 ptr_1, const SDouble ext_ident_double_336,
...
{
  const SDouble s0 = ext_ident_double_334;
  const SBool   s1 = ext_ident_bool_329;
  const SDouble s2 = ext_ident_double_328;
  const SDouble s3 = ext_ident_double_323;
  ...
  const SDouble s10 = ext_ident_double_322;
  const SDouble s11 = ext_intruder_position_z;
  const SDouble s12 = queue_10[0];
  const SWord32 s13 = ptr_10;
  const SDouble s14 = ext_ident_double_327;
  const SDouble s15 = ext_ident_double_326;
  const SDouble s16 = ext_ident_double_324;
  const SDouble s17 = ext_ident_double_325;
  const SDouble s18 = ext_minimal_vertical_separation;
  const SDouble s19 = ext_ident_double_333;
  const SDouble s20 = ext_direction_parameter_vertical;
  const SDouble s21 = ext_ident_double_332;
  const SDouble s22 = ext_ident_double_330;
  const SDouble s23 = ext_ident_double_331;
  const SDouble s24 = ext_ident_double_375;
  const SDouble s25 = ext_sqrt_374;
  const SDouble s26 = ext_ident_double_343;
  const SDouble s27 = ext_ident_double_335;
  const SDouble s28 = ext_ownship_position_x;
  const SDouble s29 = queue_1[0];
  const SWord32 s30 = ptr_1;
  const SDouble s31 = ext_ident_double_336;
  const SDouble s32 = ext_intruder_position_x;
  const SDouble s33 = queue_2[0];
  const SWord32 s34 = ptr_2;
  const SDouble s35 = ext_ident_double_337;
  const SDouble s36 = ext_ownship_velocity_x;
  const SDouble s37 = queue_7[0];
  const SWord32 s38 = ptr_7;
  const SDouble s39 = ext_ident_double_338;
  ...
  const SDouble s47 = ext_ident_double_340;
  ...
  const SDouble s55 = ext_ident_double_342;
  const SDouble s56 = ext_intruder_velocity_y;
  const SDouble s57 = queue_6[0];
  const SWord32 s58 = ptr_6;
  const SDouble s59 = ext_ident_double_352;
  const SDouble s60 = ext_ident_double_344;
  const SDouble s61 = ext_ident_double_345;
  const SDouble s62 = ext_ident_double_346;
  const SDouble s63 = ext_ident_double_347;
  const SDouble s64 = ext_ident_double_348;
  const SDouble s65 = ext_ident_double_349;
  const SDouble s66 = ext_ident_double_350;
  const SDouble s67 = ext_ident_double_351;
  const SDouble s68 = ext_ident_double_373;
  const SDouble s69 = ext_ident_double_362;
  const SDouble s70 = ext_ident_double_361;
  const SDouble s71 = ext_ident_double_353;
  const SDouble s72 = ext_ident_double_354;
  const SDouble s73 = ext_ident_double_355;
  const SDouble s74 = ext_ident_double_356;
  const SDouble s75 = ext_ident_double_357;
  const SDouble s76 = ext_ident_double_358;
  const SDouble s77 = ext_ident_double_359;
  const SDouble s78 = ext_ident_double_360;
  const SDouble s79 = ext_ident_double_372;
  const SDouble s80 = ext_ident_double_371;
  const SDouble s81 = ext_ident_double_363;
  const SDouble s82 = ext_ident_double_364;
  const SDouble s83 = ext_ident_double_365;
  const SDouble s84 = ext_ident_double_366;
  const SDouble s85 = ext_ident_double_367;
  const SDouble s86 = ext_ident_double_368;
  const SDouble s87 = ext_ident_double_369;
  const SDouble s88 = ext_ident_double_370;
