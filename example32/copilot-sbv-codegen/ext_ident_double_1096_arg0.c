...
/*@
 assigns \nothing;
 ensures \result == ((((0.0) - (ext_ident_double_1095))));
*/
                                   ...
                                   const SWord32 ptr_6)
{
  ...
  const SDouble s1 = ext_ident_double_1087;
  ...
  const SDouble s31 = ext_ident_double_1094;
