...
/*@
 assigns \nothing;
 ensures \result == ((ext_ident_double_388));
*/
SDouble ext_ident_double_389_arg0(const SDouble ext_ident_double_388,
                                  ...
                                  const SDouble ext_ident_double_385)
{
  ...
  const SDouble s1 = ext_ident_double_377;
  const SDouble s2 = ext_ident_double_320;
  const SDouble s3 = ext_ident_double_319;
  const SDouble s4 = ext_ident_double_311;
  ...
  const SDouble s34 = ext_ident_double_318;
  const SDouble s35 = ext_intruder_velocity_y;
  const SDouble s36 = queue_6[0];
  const SWord32 s37 = ptr_6;
  const SDouble s38 = ext_ident_double_376;
  const SDouble s39 = ext_ident_double_334;
  const SBool   s40 = ext_ident_bool_329;
  const SDouble s41 = ext_ident_double_328;
  const SDouble s42 = ext_ident_double_323;
  const SDouble s43 = ext_ident_double_321;
  const SDouble s44 = ext_ownship_position_z;
  const SDouble s45 = queue_9[0];
  const SWord32 s46 = ptr_9;
  const SDouble s47 = ext_ident_double_322;
  const SDouble s48 = ext_intruder_position_z;
  const SDouble s49 = queue_10[0];
  const SWord32 s50 = ptr_10;
  const SDouble s51 = ext_ident_double_327;
  const SDouble s52 = ext_ident_double_326;
  const SDouble s53 = ext_ident_double_324;
  const SDouble s54 = ext_ident_double_325;
  const SDouble s55 = ext_minimal_vertical_separation;
  const SDouble s56 = ext_ident_double_333;
  const SDouble s57 = ext_direction_parameter_vertical;
  const SDouble s58 = ext_ident_double_332;
  const SDouble s59 = ext_ident_double_330;
  const SDouble s60 = ext_ident_double_331;
  const SDouble s61 = ext_ident_double_375;
  const SDouble s62 = ext_sqrt_374;
  const SDouble s63 = ext_ident_double_343;
  const SDouble s64 = ext_ident_double_335;
  const SDouble s65 = ext_ident_double_336;
  const SDouble s66 = ext_ident_double_337;
  const SDouble s67 = ext_ident_double_338;
  const SDouble s68 = ext_ident_double_339;
  const SDouble s69 = ext_ident_double_340;
  const SDouble s70 = ext_ident_double_341;
  const SDouble s71 = ext_ident_double_342;
  const SDouble s72 = ext_ident_double_352;
  const SDouble s73 = ext_ident_double_344;
  const SDouble s74 = ext_ident_double_345;
  const SDouble s75 = ext_ident_double_346;
  const SDouble s76 = ext_ident_double_347;
  const SDouble s77 = ext_ident_double_348;
  const SDouble s78 = ext_ident_double_349;
  const SDouble s79 = ext_ident_double_350;
  const SDouble s80 = ext_ident_double_351;
  const SDouble s81 = ext_ident_double_373;
  const SDouble s82 = ext_ident_double_362;
  const SDouble s83 = ext_ident_double_361;
  const SDouble s84 = ext_ident_double_353;
  const SDouble s85 = ext_ident_double_354;
  const SDouble s86 = ext_ident_double_355;
  const SDouble s87 = ext_ident_double_356;
  const SDouble s88 = ext_ident_double_357;
  const SDouble s89 = ext_ident_double_358;
  const SDouble s90 = ext_ident_double_359;
  const SDouble s91 = ext_ident_double_360;
  const SDouble s92 = ext_ident_double_372;
  const SDouble s93 = ext_ident_double_371;
  const SDouble s94 = ext_ident_double_363;
  const SDouble s95 = ext_ident_double_364;
  const SDouble s96 = ext_ident_double_365;
  const SDouble s97 = ext_ident_double_366;
  const SDouble s98 = ext_ident_double_367;
  const SDouble s99 = ext_ident_double_368;
  const SDouble s100 = ext_ident_double_369;
  const SDouble s101 = ext_ident_double_370;
  const SDouble s102 = ext_minimal_horizontal_separation;
  const SDouble s103 = ext_ident_double_387;
  const SDouble s104 = ext_ident_double_386;
  const SDouble s105 = ext_ident_double_378;
  const SDouble s106 = ext_ident_double_379;
  const SDouble s107 = ext_ident_double_380;
  const SDouble s108 = ext_ident_double_381;
  const SDouble s109 = ext_ident_double_382;
  const SDouble s110 = ext_ident_double_383;
  const SDouble s111 = ext_ident_double_384;
  const SDouble s112 = ext_ident_double_385;
