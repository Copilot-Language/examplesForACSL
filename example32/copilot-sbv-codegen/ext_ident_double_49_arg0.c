...
/*test 003*/
/*ACSL to write
 label "absolute_value_splitting" signum (Extf_ident_double(label "ownPositionZ" (if s0 then Ext_ownship_position_z else s9)) - Extf_ident_double(label "intPositionZ" (if s0 then Ext_intruder_position_z else s10)))
*/
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ident_double_47) - (ext_ident_double_48))) > 0)? 1 : ((((ext_ident_double_47) - (ext_ident_double_48))) < 0 ? -1 : 0)));
*/
SDouble ext_ident_double_49_arg0(const SDouble ext_ident_double_47,
                                 ...
                                 const SWord32 ptr_9, const SDouble ext_ident_double_48,
                                 ...
                                 const SWord32 ptr_10)
{
  ...
  const SDouble s6 = ext_ident_double_48;
