/* File: "ext_sqrt_545_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (((((ext_ident_double_514) * (ext_ident_double_523))) - (ext_ident_double_544)));
*/
SDouble ext_sqrt_545_arg0(const SDouble ext_ident_double_514,
...
{
  const SDouble s0 = ext_ident_double_514;
  const SDouble s1 = ext_ident_double_506;
  ...
  const SDouble s7 = ext_ident_double_507;
  const SDouble s8 = ext_intruder_position_x;
  const SDouble s9 = queue_2[0];
  const SWord32 s10 = ptr_2;
  const SDouble s11 = ext_ident_double_508;
  const SDouble s12 = ext_ownship_velocity_x;
  const SDouble s13 = queue_7[0];
  const SWord32 s14 = ptr_7;
  const SDouble s15 = ext_ident_double_509;
  const SDouble s16 = ext_intruder_velocity_x;
  const SDouble s17 = queue_3[0];
  const SWord32 s18 = ptr_3;
  const SDouble s19 = ext_ident_double_510;
  const SDouble s20 = ext_ownship_position_y;
  const SDouble s21 = queue_4[0];
  const SWord32 s22 = ptr_4;
  const SDouble s23 = ext_ident_double_511;
  const SDouble s24 = ext_intruder_position_y;
  const SDouble s25 = queue_5[0];
  const SWord32 s26 = ptr_5;
  const SDouble s27 = ext_ident_double_512;
  const SDouble s28 = ext_ownship_velocity_y;
  const SDouble s29 = queue_8[0];
  const SWord32 s30 = ptr_8;
  const SDouble s31 = ext_ident_double_513;
  const SDouble s32 = ext_intruder_velocity_y;
  const SDouble s33 = queue_6[0];
  const SWord32 s34 = ptr_6;
  const SDouble s35 = ext_ident_double_523;
  const SDouble s36 = ext_ident_double_515;
  const SDouble s37 = ext_ident_double_516;
  const SDouble s38 = ext_ident_double_517;
  const SDouble s39 = ext_ident_double_518;
  const SDouble s40 = ext_ident_double_519;
  const SDouble s41 = ext_ident_double_520;
  const SDouble s42 = ext_ident_double_521;
  const SDouble s43 = ext_ident_double_522;
  const SDouble s44 = ext_ident_double_544;
  const SDouble s45 = ext_ident_double_533;
  const SDouble s46 = ext_ident_double_532;
  const SDouble s47 = ext_ident_double_524;
  const SDouble s48 = ext_ident_double_525;
  const SDouble s49 = ext_ident_double_526;
  const SDouble s50 = ext_ident_double_527;
  const SDouble s51 = ext_ident_double_528;
  const SDouble s52 = ext_ident_double_529;
  const SDouble s53 = ext_ident_double_530;
  const SDouble s54 = ext_ident_double_531;
  const SDouble s55 = ext_ident_double_543;
  const SDouble s56 = ext_ident_double_542;
  const SDouble s57 = ext_ident_double_534;
  const SDouble s58 = ext_ident_double_535;
  const SDouble s59 = ext_ident_double_536;
  const SDouble s60 = ext_ident_double_537;
  const SDouble s61 = ext_ident_double_538;
  const SDouble s62 = ext_ident_double_539;
  const SDouble s63 = ext_ident_double_540;
  const SDouble s64 = ext_ident_double_541;
