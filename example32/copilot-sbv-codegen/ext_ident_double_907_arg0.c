/* File: "ext_ident_double_907_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ident_double_824) - (ext_ident_double_825))) + (((ext_ident_double_904) * (((ext_ident_double_905) - (ext_ident_double_906))))))));
*/
SDouble ext_ident_double_907_arg0(const SDouble ext_ident_double_824,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_x, const SDouble *queue_1,
                                  const SWord32 ptr_1, const SDouble ext_ident_double_825,
                                  const SDouble ext_intruder_position_x, const SDouble *queue_2,
                                  const SWord32 ptr_2, const SDouble ext_ident_double_904,
...
{
  const SDouble s0 = ext_ident_double_824;
  ...
  const SDouble s6 = ext_ident_double_825;
  const SDouble s7 = ext_intruder_position_x;
  const SDouble s8 = queue_2[0];
  const SWord32 s9 = ptr_2;
  const SDouble s10 = ext_ident_double_904;
  const SDouble s11 = ext_ident_double_903;
  const SDouble s12 = ext_ident_double_892;
  const SDouble s13 = ext_ident_double_835;
  const SDouble s14 = ext_ident_double_834;
  const SDouble s15 = ext_ident_double_826;
  const SDouble s16 = ext_ident_double_827;
  const SDouble s17 = ext_ident_double_828;
  const SDouble s18 = ext_ownship_velocity_x;
  const SDouble s19 = queue_7[0];
  const SWord32 s20 = ptr_7;
  const SDouble s21 = ext_ident_double_829;
  const SDouble s22 = ext_intruder_velocity_x;
  const SDouble s23 = queue_3[0];
  const SWord32 s24 = ptr_3;
  const SDouble s25 = ext_ident_double_830;
  const SDouble s26 = ext_ownship_position_y;
  const SDouble s27 = queue_4[0];
  const SWord32 s28 = ptr_4;
  const SDouble s29 = ext_ident_double_831;
  const SDouble s30 = ext_intruder_position_y;
  const SDouble s31 = queue_5[0];
  const SWord32 s32 = ptr_5;
  const SDouble s33 = ext_ident_double_832;
  const SDouble s34 = ext_ownship_velocity_y;
  const SDouble s35 = queue_8[0];
  const SWord32 s36 = ptr_8;
  const SDouble s37 = ext_ident_double_833;
  const SDouble s38 = ext_intruder_velocity_y;
  const SDouble s39 = queue_6[0];
  const SWord32 s40 = ptr_6;
  const SDouble s41 = ext_ident_double_891;
  const SDouble s42 = ext_ident_double_849;
  const SBool   s43 = ext_ident_bool_844;
  const SDouble s44 = ext_ident_double_843;
  const SDouble s45 = ext_ident_double_838;
  const SDouble s46 = ext_ident_double_836;
  const SDouble s47 = ext_ownship_position_z;
  const SDouble s48 = queue_9[0];
  const SWord32 s49 = ptr_9;
  const SDouble s50 = ext_ident_double_837;
  const SDouble s51 = ext_intruder_position_z;
  const SDouble s52 = queue_10[0];
  const SWord32 s53 = ptr_10;
  const SDouble s54 = ext_ident_double_842;
  const SDouble s55 = ext_ident_double_841;
  const SDouble s56 = ext_ident_double_839;
  const SDouble s57 = ext_ident_double_840;
  const SDouble s58 = ext_minimal_vertical_separation;
  const SDouble s59 = ext_ident_double_848;
  const SDouble s60 = ext_direction_parameter_vertical;
  const SDouble s61 = ext_ident_double_847;
  const SDouble s62 = ext_ident_double_845;
  const SDouble s63 = ext_ident_double_846;
  const SDouble s64 = ext_ident_double_890;
  const SDouble s65 = ext_sqrt_889;
  const SDouble s66 = ext_ident_double_858;
  const SDouble s67 = ext_ident_double_850;
  const SDouble s68 = ext_ident_double_851;
  const SDouble s69 = ext_ident_double_852;
  const SDouble s70 = ext_ident_double_853;
  const SDouble s71 = ext_ident_double_854;
  const SDouble s72 = ext_ident_double_855;
  const SDouble s73 = ext_ident_double_856;
  const SDouble s74 = ext_ident_double_857;
  const SDouble s75 = ext_ident_double_867;
  const SDouble s76 = ext_ident_double_859;
  const SDouble s77 = ext_ident_double_860;
  const SDouble s78 = ext_ident_double_861;
  const SDouble s79 = ext_ident_double_862;
  const SDouble s80 = ext_ident_double_863;
  const SDouble s81 = ext_ident_double_864;
  const SDouble s82 = ext_ident_double_865;
  const SDouble s83 = ext_ident_double_866;
  const SDouble s84 = ext_ident_double_888;
  const SDouble s85 = ext_ident_double_877;
  const SDouble s86 = ext_ident_double_876;
  const SDouble s87 = ext_ident_double_868;
  const SDouble s88 = ext_ident_double_869;
  const SDouble s89 = ext_ident_double_870;
  const SDouble s90 = ext_ident_double_871;
  const SDouble s91 = ext_ident_double_872;
  const SDouble s92 = ext_ident_double_873;
  const SDouble s93 = ext_ident_double_874;
  const SDouble s94 = ext_ident_double_875;
  const SDouble s95 = ext_ident_double_887;
  const SDouble s96 = ext_ident_double_886;
  const SDouble s97 = ext_ident_double_878;
  const SDouble s98 = ext_ident_double_879;
  const SDouble s99 = ext_ident_double_880;
  const SDouble s100 = ext_ident_double_881;
  const SDouble s101 = ext_ident_double_882;
  const SDouble s102 = ext_ident_double_883;
  const SDouble s103 = ext_ident_double_884;
  const SDouble s104 = ext_ident_double_885;
  const SDouble s105 = ext_minimal_horizontal_separation;
  const SDouble s106 = ext_ident_double_902;
  const SDouble s107 = ext_ident_double_901;
  const SDouble s108 = ext_ident_double_893;
  const SDouble s109 = ext_ident_double_894;
  const SDouble s110 = ext_ident_double_895;
  const SDouble s111 = ext_ident_double_896;
  const SDouble s112 = ext_ident_double_897;
  const SDouble s113 = ext_ident_double_898;
  const SDouble s114 = ext_ident_double_899;
  const SDouble s115 = ext_ident_double_900;
  const SDouble s116 = ext_ident_double_905;
  const SDouble s117 = ext_ident_double_906;
