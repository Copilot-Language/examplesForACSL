...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_155) - (ext_ident_double_156))) * (((ext_ident_double_157) - (ext_ident_double_158))))) + (((((ext_ident_double_159) - (ext_ident_double_160))) * (((ext_ident_double_161) - (ext_ident_double_162))))))));
*/
SDouble ext_ident_double_163_arg0(const SDouble ext_ident_double_155,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_x, const SDouble *queue_1,
                                  const SWord32 ptr_1, const SDouble ext_ident_double_156,
                                  ...
                                  const SDouble ext_ident_double_162)
{
  ...
  const SDouble s6 = ext_ident_double_156;
  const SDouble s7 = ext_intruder_position_x;
  const SDouble s8 = queue_2[0];
  const SWord32 s9 = ptr_2;
  const SDouble s10 = ext_ident_double_157;
  const SDouble s11 = ext_ident_double_158;
  ...
  const SDouble s16 = ext_ident_double_160;
  ...
  const SDouble s21 = ext_ident_double_162;
