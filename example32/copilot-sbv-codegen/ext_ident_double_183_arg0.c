...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_175) - (ext_ident_double_176))) * (((ext_ident_double_177) - (ext_ident_double_178))))) + (((((ext_ident_double_179) - (ext_ident_double_180))) * (((ext_ident_double_181) - (ext_ident_double_182))))))));
*/
SDouble ext_ident_double_183_arg0(const SDouble ext_ident_double_175,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_x, const SDouble *queue_1,
                                  const SWord32 ptr_1, const SDouble ext_ident_double_176,
                                  ...
                                  const SDouble ext_ident_double_182)
{
  ...
  const SDouble s6 = ext_ident_double_176;
  const SDouble s7 = ext_intruder_position_x;
  const SDouble s8 = queue_2[0];
  const SWord32 s9 = ptr_2;
  const SDouble s10 = ext_ident_double_177;
  const SDouble s11 = ext_ident_double_178;
  const SDouble s12 = ext_ident_double_179;
  ...
  const SDouble s21 = ext_ident_double_182;
