/* File: "ext_ident_double_1356_arg0.c". Automatically generated by SBV. Do not edit! */
...
*/
SDouble ext_ident_double_1356_arg0(const SDouble ext_minimal_horizontal_separation)
{
  const SDouble s0 = ext_minimal_horizontal_separation;
  const SDouble s1 = s0 * s0;
  const SDouble s2 = s1 /* criterion3D_part4.1.2 */;
