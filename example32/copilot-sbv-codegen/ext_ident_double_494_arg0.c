/* File: "ext_ident_double_494_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_492) - (ext_ident_double_493))));
*/
SDouble ext_ident_double_494_arg0(const SDouble ext_ident_double_492,
...
{
  const SDouble s0 = ext_ident_double_492;
  ...
  const SDouble s6 = ext_ident_double_493;
