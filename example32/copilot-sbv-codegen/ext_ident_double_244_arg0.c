...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_243) > 0)? 1 : ((ext_ident_double_243) < 0 ? -1 : 0)));
*/
SDouble ext_ident_double_244_arg0(const SDouble ext_ident_double_243,
                                  const SDouble ext_ident_double_241, const SBool *queue_0,
                                  ...
                                  const SWord32 ptr_10)
{
  ...
  const SDouble s1 = ext_ident_double_241;
  ...
  const SDouble s7 = ext_ident_double_242;
