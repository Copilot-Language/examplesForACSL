/* File: "ext_ident_double_731_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((ext_ident_double_730));
*/
SDouble ext_ident_double_731_arg0(const SDouble ext_ident_double_730,
                                  const SDouble ext_ident_double_722, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_730;
  const SDouble s1 = ext_ident_double_722;
  ...
  const SDouble s7 = ext_ident_double_723;
  ...
  const SDouble s12 = ext_ident_double_725;
  const SDouble s13 = ext_ident_double_726;
  const SDouble s14 = ext_ownship_velocity_y;
  const SDouble s15 = queue_8[0];
  const SWord32 s16 = ptr_8;
  const SDouble s17 = ext_ident_double_727;
  const SDouble s18 = ext_intruder_velocity_y;
  const SDouble s19 = queue_6[0];
  const SWord32 s20 = ptr_6;
  const SDouble s21 = ext_ident_double_728;
  const SDouble s22 = ext_ident_double_729;
