...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_665) - (ext_ident_double_666))));
*/
SDouble ext_ident_double_667_arg0(const SDouble ext_ident_double_665,
...
{
  const SDouble s0 = ext_ident_double_665;
