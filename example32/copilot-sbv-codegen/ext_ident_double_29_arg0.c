...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_21) - (ext_ident_double_22))) * (((ext_ident_double_23) - (ext_ident_double_24))))) + (((((ext_ident_double_25) - (ext_ident_double_26))) * (((ext_ident_double_27) - (ext_ident_double_28))))))));
*/
SDouble ext_ident_double_29_arg0(const SDouble ext_ident_double_21,
                                 const SBool *queue_0, const SWord32 ptr_0,
                                 const SDouble ext_ownship_position_x, const SDouble *queue_1,
                                 const SWord32 ptr_1, const SDouble ext_ident_double_22,
                                 ...
                                 const SDouble ext_ident_double_28)
{
  ...
  const SDouble s11 = ext_ident_double_24;
  const SDouble s12 = ext_ident_double_25;
  const SDouble s13 = ext_ownship_position_y;
  const SDouble s14 = queue_4[0];
  const SWord32 s15 = ptr_4;
  const SDouble s16 = ext_ident_double_26;
  const SDouble s17 = ext_intruder_position_y;
  const SDouble s18 = queue_5[0];
  const SWord32 s19 = ptr_5;
  const SDouble s20 = ext_ident_double_27;
  const SDouble s21 = ext_ident_double_28;
