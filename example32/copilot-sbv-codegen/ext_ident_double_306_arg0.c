/* File: "ext_ident_double_306_arg0.c". Automatically generated by SBV. Do not edit! */
                                  ...
                                  const SDouble ext_ident_double_302)
{
  ...
  const SDouble s3 = ext_ident_double_236;
  const SDouble s4 = ext_ident_double_228;
  ...
  const SDouble s58 = ext_ident_double_249;
  const SDouble s59 = ext_ident_double_247;
  const SDouble s60 = ext_ident_double_248;
  const SDouble s61 = ext_ident_double_292;
  const SDouble s62 = ext_sqrt_291;
  const SDouble s63 = ext_ident_double_260;
  const SDouble s64 = ext_ident_double_252;
  const SDouble s65 = ext_ident_double_253;
  const SDouble s66 = ext_ident_double_254;
  const SDouble s67 = ext_ident_double_255;
  const SDouble s68 = ext_ident_double_256;
  const SDouble s69 = ext_ident_double_257;
  const SDouble s70 = ext_ident_double_258;
  const SDouble s71 = ext_ident_double_259;
  const SDouble s72 = ext_ident_double_269;
  const SDouble s73 = ext_ident_double_261;
  const SDouble s74 = ext_ident_double_262;
  const SDouble s75 = ext_ident_double_263;
  const SDouble s76 = ext_ident_double_264;
  const SDouble s77 = ext_ident_double_265;
  const SDouble s78 = ext_ident_double_266;
  const SDouble s79 = ext_ident_double_267;
  const SDouble s80 = ext_ident_double_268;
  const SDouble s81 = ext_ident_double_290;
  const SDouble s82 = ext_ident_double_279;
  const SDouble s83 = ext_ident_double_278;
  const SDouble s84 = ext_ident_double_270;
  const SDouble s85 = ext_ident_double_271;
  const SDouble s86 = ext_ident_double_272;
  const SDouble s87 = ext_ident_double_273;
  const SDouble s88 = ext_ident_double_274;
  const SDouble s89 = ext_ident_double_275;
  const SDouble s90 = ext_ident_double_276;
  const SDouble s91 = ext_ident_double_277;
  const SDouble s92 = ext_ident_double_289;
  const SDouble s93 = ext_ident_double_288;
  const SDouble s94 = ext_ident_double_280;
  const SDouble s95 = ext_ident_double_281;
  const SDouble s96 = ext_ident_double_282;
  const SDouble s97 = ext_ident_double_283;
  const SDouble s98 = ext_ident_double_284;
  const SDouble s99 = ext_ident_double_285;
  const SDouble s100 = ext_ident_double_286;
  const SDouble s101 = ext_ident_double_287;
  const SDouble s102 = ext_minimal_horizontal_separation;
  const SDouble s103 = ext_ident_double_304;
  const SDouble s104 = ext_ident_double_303;
  const SDouble s105 = ext_ident_double_295;
  const SDouble s106 = ext_ident_double_296;
  const SDouble s107 = ext_ident_double_297;
  const SDouble s108 = ext_ident_double_298;
  const SDouble s109 = ext_ident_double_299;
  const SDouble s110 = ext_ident_double_300;
  const SDouble s111 = ext_ident_double_301;
  const SDouble s112 = ext_ident_double_302;
  const SDouble s113 = s0 /* theta_dir_1 */;
