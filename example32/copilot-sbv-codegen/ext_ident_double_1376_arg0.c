/* File: "ext_ident_double_1376_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_1368) - (ext_ident_double_1369))) * (((ext_ident_double_1370) - (ext_ident_double_1371))))) + (((((ext_ident_double_1372) - (ext_ident_double_1373))) * (((ext_ident_double_1374) - (ext_ident_double_1375))))))));
*/
SDouble ext_ident_double_1376_arg0(const SDouble ext_ident_double_1368,
                                   const SBool *queue_0, const SWord32 ptr_0,
                                   const SDouble ext_ownship_position_x, const SDouble *queue_1,
                                   const SWord32 ptr_1, const SDouble ext_ident_double_1369,
...
{
  const SDouble s0 = ext_ident_double_1368;
  ...
  const SDouble s6 = ext_ident_double_1369;
  const SDouble s7 = ext_intruder_position_x;
  const SDouble s8 = queue_2[0];
  const SWord32 s9 = ptr_2;
  const SDouble s10 = ext_ident_double_1370;
  const SDouble s11 = ext_ident_double_1371;
  const SDouble s12 = ext_ident_double_1372;
  const SDouble s13 = ext_ownship_position_y;
  const SDouble s14 = queue_4[0];
  const SWord32 s15 = ptr_4;
  const SDouble s16 = ext_ident_double_1373;
  const SDouble s17 = ext_intruder_position_y;
  const SDouble s18 = queue_5[0];
  const SWord32 s19 = ptr_5;
  const SDouble s20 = ext_ident_double_1374;
  const SDouble s21 = ext_ident_double_1375;
