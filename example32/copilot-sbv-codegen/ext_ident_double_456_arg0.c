/* File: "ext_ident_double_456_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_448) - (ext_ident_double_449))) * (((ext_ident_double_450) - (ext_ident_double_451))))) + (((((ext_ident_double_452) - (ext_ident_double_453))) * (((ext_ident_double_454) - (ext_ident_double_455))))))));
*/
SDouble ext_ident_double_456_arg0(const SDouble ext_ident_double_448,
...
{
  const SDouble s0 = ext_ident_double_448;
  ...
  const SDouble s16 = ext_ident_double_453;
  const SDouble s17 = ext_intruder_position_y;
  const SDouble s18 = queue_5[0];
  const SWord32 s19 = ptr_5;
  const SDouble s20 = ext_ident_double_454;
  const SDouble s21 = ext_ident_double_455;
