/* File: "ext_ident_double_278_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_270) - (ext_ident_double_271))) * (((ext_ident_double_272) - (ext_ident_double_273))))) + (((((ext_ident_double_274) - (ext_ident_double_275))) * (((ext_ident_double_276) - (ext_ident_double_277))))))));
*/
SDouble ext_ident_double_278_arg0(const SDouble ext_ident_double_270,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_velocity_x, const SDouble *queue_7,
                                  const SWord32 ptr_7, const SDouble ext_ident_double_271,
...
{
  const SDouble s0 = ext_ident_double_270;
  ...
  const SDouble s6 = ext_ident_double_271;
  const SDouble s7 = ext_intruder_velocity_x;
  const SDouble s8 = queue_3[0];
  const SWord32 s9 = ptr_3;
  const SDouble s10 = ext_ident_double_272;
  const SDouble s11 = ext_ident_double_273;
