...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_378) - (ext_ident_double_379))) * (((ext_ident_double_380) - (ext_ident_double_381))))) + (((((ext_ident_double_382) - (ext_ident_double_383))) * (((ext_ident_double_384) - (ext_ident_double_385))))))));
*/
SDouble ext_ident_double_386_arg0(const SDouble ext_ident_double_378,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_velocity_x, const SDouble *queue_7,
                                  const SWord32 ptr_7, const SDouble ext_ident_double_379,
                                  const SDouble ext_intruder_velocity_x, const SDouble *queue_3,
                                  const SWord32 ptr_3, const SDouble ext_ident_double_380,
                                  ...
                                  const SWord32 ptr_8, const SDouble ext_ident_double_383,
                                  const SDouble ext_intruder_velocity_y, const SDouble *queue_6,
                                  const SWord32 ptr_6, const SDouble ext_ident_double_384,
                                  const SDouble ext_ident_double_385)
{
  ...
  const SDouble s6 = ext_ident_double_379;
  ...
  const SDouble s11 = ext_ident_double_381;
  const SDouble s12 = ext_ident_double_382;
  const SDouble s13 = ext_ownship_velocity_y;
  const SDouble s14 = queue_8[0];
  const SWord32 s15 = ptr_8;
  const SDouble s16 = ext_ident_double_383;
  const SDouble s17 = ext_intruder_velocity_y;
  const SDouble s18 = queue_6[0];
  const SWord32 s19 = ptr_6;
  const SDouble s20 = ext_ident_double_384;
  const SDouble s21 = ext_ident_double_385;
