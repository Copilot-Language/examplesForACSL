...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_759) ? (ext_ident_double_763) : (-1.0))));
*/
SDouble ext_ident_double_764_arg0(const SBool ext_ident_bool_759,
...
{
  const SBool   s0 = ext_ident_bool_759;
  const SDouble s1 = ext_ident_double_758;
  const SDouble s2 = ext_ident_double_753;
  const SDouble s3 = ext_ident_double_751;
  ...
  const SDouble s9 = ext_ident_double_752;
  const SDouble s10 = ext_intruder_position_z;
  const SDouble s11 = queue_10[0];
  const SWord32 s12 = ptr_10;
  const SDouble s13 = ext_ident_double_757;
  const SDouble s14 = ext_ident_double_756;
  const SDouble s15 = ext_ident_double_754;
  const SDouble s16 = ext_ident_double_755;
  const SDouble s17 = ext_minimal_vertical_separation;
  const SDouble s18 = ext_ident_double_763;
  const SDouble s19 = ext_direction_parameter_vertical;
  const SDouble s20 = ext_ident_double_762;
  const SDouble s21 = ext_ident_double_760;
  const SDouble s22 = ext_ident_double_761;
