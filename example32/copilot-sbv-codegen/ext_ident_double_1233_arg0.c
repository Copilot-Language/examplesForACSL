/* File: "ext_ident_double_1233_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_1232) - (((ext_minimal_horizontal_separation) * (ext_minimal_horizontal_separation))))));
*/
SDouble ext_ident_double_1233_arg0(const SDouble ext_ident_double_1232,
                                   const SDouble ext_ident_double_1224, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_1232;
  const SDouble s1 = ext_ident_double_1224;
