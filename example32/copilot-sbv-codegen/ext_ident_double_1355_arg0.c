/* File: "ext_ident_double_1355_arg0.c". Automatically generated by SBV. Do not edit! */
...
{
  const SDouble s0 = ext_ident_double_1354;
  const SDouble s1 = ext_ident_double_1346;
  ...
  const SDouble s7 = ext_ident_double_1347;
  const SDouble s8 = ext_intruder_position_x;
  const SDouble s9 = queue_2[0];
  const SWord32 s10 = ptr_2;
  const SDouble s11 = ext_ident_double_1348;
  const SDouble s12 = ext_ident_double_1349;
  const SDouble s13 = ext_ident_double_1350;
  const SDouble s14 = ext_ownship_position_y;
  const SDouble s15 = queue_4[0];
  const SWord32 s16 = ptr_4;
  const SDouble s17 = ext_ident_double_1351;
  const SDouble s18 = ext_intruder_position_y;
  const SDouble s19 = queue_5[0];
  const SWord32 s20 = ptr_5;
  const SDouble s21 = ext_ident_double_1352;
  const SDouble s22 = ext_ident_double_1353;
  const SDouble s23 = s0 /* criterion3D_part4.1.1 */;
