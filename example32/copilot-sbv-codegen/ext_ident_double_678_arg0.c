/* File: "ext_ident_double_678_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_673) ? (ext_ident_double_677) : (-1.0))));
*/
SDouble ext_ident_double_678_arg0(const SBool ext_ident_bool_673,
...
{
  const SBool   s0 = ext_ident_bool_673;
  const SDouble s1 = ext_ident_double_672;
  const SDouble s2 = ext_ident_double_667;
  const SDouble s3 = ext_ident_double_665;
  ...
  const SDouble s9 = ext_ident_double_666;
  const SDouble s10 = ext_intruder_position_z;
  const SDouble s11 = queue_10[0];
  const SWord32 s12 = ptr_10;
  const SDouble s13 = ext_ident_double_671;
  const SDouble s14 = ext_ident_double_670;
  const SDouble s15 = ext_ident_double_668;
  const SDouble s16 = ext_ident_double_669;
  const SDouble s17 = ext_minimal_vertical_separation;
  const SDouble s18 = ext_ident_double_677;
  const SDouble s19 = ext_direction_parameter_vertical;
  const SDouble s20 = ext_ident_double_676;
  const SDouble s21 = ext_ident_double_674;
  const SDouble s22 = ext_ident_double_675;
