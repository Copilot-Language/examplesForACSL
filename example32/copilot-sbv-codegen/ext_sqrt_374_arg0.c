/* File: "ext_sqrt_374_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (((((ext_ident_double_343) * (ext_ident_double_352))) - (ext_ident_double_373)));
*/
SDouble ext_sqrt_374_arg0(const SDouble ext_ident_double_343,
...
{
  const SDouble s0 = ext_ident_double_343;
  const SDouble s1 = ext_ident_double_335;
  ...
  const SDouble s7 = ext_ident_double_336;
  const SDouble s8 = ext_intruder_position_x;
  const SDouble s9 = queue_2[0];
  const SWord32 s10 = ptr_2;
  const SDouble s11 = ext_ident_double_337;
  const SDouble s12 = ext_ownship_velocity_x;
  const SDouble s13 = queue_7[0];
  const SWord32 s14 = ptr_7;
  const SDouble s15 = ext_ident_double_338;
  const SDouble s16 = ext_intruder_velocity_x;
  const SDouble s17 = queue_3[0];
  const SWord32 s18 = ptr_3;
  const SDouble s19 = ext_ident_double_339;
  const SDouble s20 = ext_ownship_position_y;
  const SDouble s21 = queue_4[0];
  const SWord32 s22 = ptr_4;
  const SDouble s23 = ext_ident_double_340;
  const SDouble s24 = ext_intruder_position_y;
  const SDouble s25 = queue_5[0];
  const SWord32 s26 = ptr_5;
  const SDouble s27 = ext_ident_double_341;
  const SDouble s28 = ext_ownship_velocity_y;
  const SDouble s29 = queue_8[0];
  const SWord32 s30 = ptr_8;
  const SDouble s31 = ext_ident_double_342;
  const SDouble s32 = ext_intruder_velocity_y;
  const SDouble s33 = queue_6[0];
  const SWord32 s34 = ptr_6;
  const SDouble s35 = ext_ident_double_352;
  const SDouble s36 = ext_ident_double_344;
  const SDouble s37 = ext_ident_double_345;
  const SDouble s38 = ext_ident_double_346;
  const SDouble s39 = ext_ident_double_347;
  const SDouble s40 = ext_ident_double_348;
  const SDouble s41 = ext_ident_double_349;
  const SDouble s42 = ext_ident_double_350;
  const SDouble s43 = ext_ident_double_351;
  const SDouble s44 = ext_ident_double_373;
  const SDouble s45 = ext_ident_double_362;
  const SDouble s46 = ext_ident_double_361;
  const SDouble s47 = ext_ident_double_353;
  const SDouble s48 = ext_ident_double_354;
  const SDouble s49 = ext_ident_double_355;
  const SDouble s50 = ext_ident_double_356;
  const SDouble s51 = ext_ident_double_357;
  const SDouble s52 = ext_ident_double_358;
  const SDouble s53 = ext_ident_double_359;
  const SDouble s54 = ext_ident_double_360;
  const SDouble s55 = ext_ident_double_372;
  const SDouble s56 = ext_ident_double_371;
  const SDouble s57 = ext_ident_double_363;
  const SDouble s58 = ext_ident_double_364;
  const SDouble s59 = ext_ident_double_365;
  const SDouble s60 = ext_ident_double_366;
  const SDouble s61 = ext_ident_double_367;
  const SDouble s62 = ext_ident_double_368;
  const SDouble s63 = ext_ident_double_369;
  const SDouble s64 = ext_ident_double_370;
