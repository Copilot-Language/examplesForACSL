/* File: "ext_ident_double_1317_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_1309) - (ext_ident_double_1310))) * (((ext_ident_double_1311) - (ext_ident_double_1312))))) + (((((ext_ident_double_1313) - (ext_ident_double_1314))) * (((ext_ident_double_1315) - (ext_ident_double_1316))))))));
*/
SDouble ext_ident_double_1317_arg0(const SDouble ext_ident_double_1309,
...
{
  const SDouble s0 = ext_ident_double_1309;
  ...
  const SDouble s6 = ext_ident_double_1310;
  const SDouble s7 = ext_intruder_position_x;
  const SDouble s8 = queue_2[0];
  const SWord32 s9 = ptr_2;
  const SDouble s10 = ext_ident_double_1311;
  const SDouble s11 = ext_ident_double_1312;
  const SDouble s12 = ext_ident_double_1313;
  const SDouble s13 = ext_ownship_position_y;
  const SDouble s14 = queue_4[0];
  const SWord32 s15 = ptr_4;
  const SDouble s16 = ext_ident_double_1314;
  const SDouble s17 = ext_intruder_position_y;
  const SDouble s18 = queue_5[0];
  const SWord32 s19 = ptr_5;
  const SDouble s20 = ext_ident_double_1315;
  const SDouble s21 = ext_ident_double_1316;
