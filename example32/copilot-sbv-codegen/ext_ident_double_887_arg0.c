...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_886) - (((ext_minimal_horizontal_separation) * (ext_minimal_horizontal_separation))))));
*/
SDouble ext_ident_double_887_arg0(const SDouble ext_ident_double_886,
                                  const SDouble ext_ident_double_878, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_886;
  const SDouble s1 = ext_ident_double_878;
