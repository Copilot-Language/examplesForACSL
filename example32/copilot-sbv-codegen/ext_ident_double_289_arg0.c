...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_288) - (((ext_minimal_horizontal_separation) * (ext_minimal_horizontal_separation))))));
*/
SDouble ext_ident_double_289_arg0(const SDouble ext_ident_double_288,
                                  const SDouble ext_ident_double_280, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_288;
  const SDouble s1 = ext_ident_double_280;
