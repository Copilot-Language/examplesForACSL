...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_1019) ? (ext_ident_double_1023) : (-1.0))));
*/
SDouble ext_ident_double_1024_arg0(const SBool ext_ident_bool_1019,
...
{
  const SBool   s0 = ext_ident_bool_1019;
  const SDouble s1 = ext_ident_double_1018;
  const SDouble s2 = ext_ident_double_1013;
  const SDouble s3 = ext_ident_double_1011;
  ...
  const SDouble s9 = ext_ident_double_1012;
  const SDouble s10 = ext_intruder_position_z;
  const SDouble s11 = queue_10[0];
  const SWord32 s12 = ptr_10;
  const SDouble s13 = ext_ident_double_1017;
  const SDouble s14 = ext_ident_double_1016;
  const SDouble s15 = ext_ident_double_1014;
  const SDouble s16 = ext_ident_double_1015;
  const SDouble s17 = ext_minimal_vertical_separation;
  const SDouble s18 = ext_ident_double_1023;
  const SDouble s19 = ext_direction_parameter_vertical;
  const SDouble s20 = ext_ident_double_1022;
  const SDouble s21 = ext_ident_double_1020;
  const SDouble s22 = ext_ident_double_1021;
