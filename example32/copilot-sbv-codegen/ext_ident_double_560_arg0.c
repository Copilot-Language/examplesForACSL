/* File: "ext_ident_double_560_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((ext_ident_double_559));
*/
SDouble ext_ident_double_560_arg0(const SDouble ext_ident_double_559,
...
{
  const SDouble s0 = ext_ident_double_559;
  const SDouble s1 = ext_ident_double_548;
  const SDouble s2 = ext_ident_double_491;
  const SDouble s3 = ext_ident_double_490;
  const SDouble s4 = ext_ident_double_482;
  ...
  const SDouble s10 = ext_ident_double_483;
  const SDouble s11 = ext_intruder_position_x;
  const SDouble s12 = queue_2[0];
  const SWord32 s13 = ptr_2;
  const SDouble s14 = ext_ident_double_484;
  const SDouble s15 = ext_ownship_velocity_x;
  const SDouble s16 = queue_7[0];
  const SWord32 s17 = ptr_7;
  const SDouble s18 = ext_ident_double_485;
  const SDouble s19 = ext_intruder_velocity_x;
  const SDouble s20 = queue_3[0];
  const SWord32 s21 = ptr_3;
  const SDouble s22 = ext_ident_double_486;
  const SDouble s23 = ext_ownship_position_y;
  const SDouble s24 = queue_4[0];
  const SWord32 s25 = ptr_4;
  const SDouble s26 = ext_ident_double_487;
  const SDouble s27 = ext_intruder_position_y;
  const SDouble s28 = queue_5[0];
  const SWord32 s29 = ptr_5;
  const SDouble s30 = ext_ident_double_488;
  const SDouble s31 = ext_ownship_velocity_y;
  const SDouble s32 = queue_8[0];
  const SWord32 s33 = ptr_8;
  const SDouble s34 = ext_ident_double_489;
  const SDouble s35 = ext_intruder_velocity_y;
  const SDouble s36 = queue_6[0];
  const SWord32 s37 = ptr_6;
  const SDouble s38 = ext_ident_double_547;
  const SDouble s39 = ext_ident_double_505;
  const SBool   s40 = ext_ident_bool_500;
  const SDouble s41 = ext_ident_double_499;
  const SDouble s42 = ext_ident_double_494;
  const SDouble s43 = ext_ident_double_492;
  const SDouble s44 = ext_ownship_position_z;
  const SDouble s45 = queue_9[0];
  const SWord32 s46 = ptr_9;
  const SDouble s47 = ext_ident_double_493;
  const SDouble s48 = ext_intruder_position_z;
  const SDouble s49 = queue_10[0];
  const SWord32 s50 = ptr_10;
  const SDouble s51 = ext_ident_double_498;
  const SDouble s52 = ext_ident_double_497;
  const SDouble s53 = ext_ident_double_495;
  const SDouble s54 = ext_ident_double_496;
  const SDouble s55 = ext_minimal_vertical_separation;
  const SDouble s56 = ext_ident_double_504;
  const SDouble s57 = ext_direction_parameter_vertical;
  const SDouble s58 = ext_ident_double_503;
  const SDouble s59 = ext_ident_double_501;
  const SDouble s60 = ext_ident_double_502;
  const SDouble s61 = ext_ident_double_546;
  const SDouble s62 = ext_sqrt_545;
  const SDouble s63 = ext_ident_double_514;
  const SDouble s64 = ext_ident_double_506;
  const SDouble s65 = ext_ident_double_507;
  const SDouble s66 = ext_ident_double_508;
  const SDouble s67 = ext_ident_double_509;
  const SDouble s68 = ext_ident_double_510;
  const SDouble s69 = ext_ident_double_511;
  const SDouble s70 = ext_ident_double_512;
  const SDouble s71 = ext_ident_double_513;
  const SDouble s72 = ext_ident_double_523;
  const SDouble s73 = ext_ident_double_515;
  const SDouble s74 = ext_ident_double_516;
  const SDouble s75 = ext_ident_double_517;
  const SDouble s76 = ext_ident_double_518;
  const SDouble s77 = ext_ident_double_519;
  const SDouble s78 = ext_ident_double_520;
  const SDouble s79 = ext_ident_double_521;
  const SDouble s80 = ext_ident_double_522;
  const SDouble s81 = ext_ident_double_544;
  const SDouble s82 = ext_ident_double_533;
  const SDouble s83 = ext_ident_double_532;
  const SDouble s84 = ext_ident_double_524;
  const SDouble s85 = ext_ident_double_525;
  const SDouble s86 = ext_ident_double_526;
  const SDouble s87 = ext_ident_double_527;
  const SDouble s88 = ext_ident_double_528;
  const SDouble s89 = ext_ident_double_529;
  const SDouble s90 = ext_ident_double_530;
  const SDouble s91 = ext_ident_double_531;
  const SDouble s92 = ext_ident_double_543;
  const SDouble s93 = ext_ident_double_542;
  const SDouble s94 = ext_ident_double_534;
  const SDouble s95 = ext_ident_double_535;
  const SDouble s96 = ext_ident_double_536;
  const SDouble s97 = ext_ident_double_537;
  const SDouble s98 = ext_ident_double_538;
  const SDouble s99 = ext_ident_double_539;
  const SDouble s100 = ext_ident_double_540;
  const SDouble s101 = ext_ident_double_541;
  const SDouble s102 = ext_minimal_horizontal_separation;
  const SDouble s103 = ext_ident_double_558;
  const SDouble s104 = ext_ident_double_557;
  const SDouble s105 = ext_ident_double_549;
  const SDouble s106 = ext_ident_double_550;
  const SDouble s107 = ext_ident_double_551;
  const SDouble s108 = ext_ident_double_552;
  const SDouble s109 = ext_ident_double_553;
  const SDouble s110 = ext_ident_double_554;
  const SDouble s111 = ext_ident_double_555;
  const SDouble s112 = ext_ident_double_556;
