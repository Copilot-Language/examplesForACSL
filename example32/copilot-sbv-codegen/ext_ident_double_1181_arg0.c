/* File: "ext_ident_double_1181_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((0.0) - (ext_ident_double_1180))));
*/
SDouble ext_ident_double_1181_arg0(const SDouble ext_ident_double_1180,
                                   ...
                                   const SWord32 ptr_6)
{
  const SDouble s0 = ext_ident_double_1180;
  const SDouble s1 = ext_ident_double_1172;
  ...
  const SDouble s7 = ext_ident_double_1173;
