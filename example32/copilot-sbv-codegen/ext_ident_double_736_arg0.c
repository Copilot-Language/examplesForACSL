...
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ident_double_653) - (ext_ident_double_654))) + (((ext_ident_double_733) * (((ext_ident_double_734) - (ext_ident_double_735))))))));
*/
SDouble ext_ident_double_736_arg0(const SDouble ext_ident_double_653,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_x, const SDouble *queue_1,
                                  const SWord32 ptr_1, const SDouble ext_ident_double_654,
                                  const SDouble ext_intruder_position_x, const SDouble *queue_2,
                                  const SWord32 ptr_2, const SDouble ext_ident_double_733,
...
{
  const SDouble s0 = ext_ident_double_653;
  ...
  const SDouble s6 = ext_ident_double_654;
  ...
  const SDouble s11 = ext_ident_double_732;
  const SDouble s12 = ext_ident_double_721;
  const SDouble s13 = ext_ident_double_664;
  const SDouble s14 = ext_ident_double_663;
  const SDouble s15 = ext_ident_double_655;
  const SDouble s16 = ext_ident_double_656;
  const SDouble s17 = ext_ident_double_657;
  const SDouble s18 = ext_ownship_velocity_x;
  const SDouble s19 = queue_7[0];
  const SWord32 s20 = ptr_7;
  const SDouble s21 = ext_ident_double_658;
  const SDouble s22 = ext_intruder_velocity_x;
  const SDouble s23 = queue_3[0];
  const SWord32 s24 = ptr_3;
  const SDouble s25 = ext_ident_double_659;
  const SDouble s26 = ext_ownship_position_y;
  const SDouble s27 = queue_4[0];
  const SWord32 s28 = ptr_4;
  const SDouble s29 = ext_ident_double_660;
  const SDouble s30 = ext_intruder_position_y;
  const SDouble s31 = queue_5[0];
  const SWord32 s32 = ptr_5;
  const SDouble s33 = ext_ident_double_661;
  const SDouble s34 = ext_ownship_velocity_y;
  const SDouble s35 = queue_8[0];
  const SWord32 s36 = ptr_8;
  const SDouble s37 = ext_ident_double_662;
  const SDouble s38 = ext_intruder_velocity_y;
  const SDouble s39 = queue_6[0];
  const SWord32 s40 = ptr_6;
  const SDouble s41 = ext_ident_double_720;
  const SDouble s42 = ext_ident_double_678;
  const SBool   s43 = ext_ident_bool_673;
  const SDouble s44 = ext_ident_double_672;
  const SDouble s45 = ext_ident_double_667;
  const SDouble s46 = ext_ident_double_665;
  const SDouble s47 = ext_ownship_position_z;
  const SDouble s48 = queue_9[0];
  const SWord32 s49 = ptr_9;
  const SDouble s50 = ext_ident_double_666;
  ...
  const SDouble s55 = ext_ident_double_670;
  const SDouble s56 = ext_ident_double_668;
  const SDouble s57 = ext_ident_double_669;
  const SDouble s58 = ext_minimal_vertical_separation;
  const SDouble s59 = ext_ident_double_677;
  const SDouble s60 = ext_direction_parameter_vertical;
  const SDouble s61 = ext_ident_double_676;
  const SDouble s62 = ext_ident_double_674;
  const SDouble s63 = ext_ident_double_675;
  const SDouble s64 = ext_ident_double_719;
  const SDouble s65 = ext_sqrt_718;
  const SDouble s66 = ext_ident_double_687;
  const SDouble s67 = ext_ident_double_679;
  const SDouble s68 = ext_ident_double_680;
  const SDouble s69 = ext_ident_double_681;
  const SDouble s70 = ext_ident_double_682;
  const SDouble s71 = ext_ident_double_683;
  const SDouble s72 = ext_ident_double_684;
  const SDouble s73 = ext_ident_double_685;
  const SDouble s74 = ext_ident_double_686;
  const SDouble s75 = ext_ident_double_696;
  const SDouble s76 = ext_ident_double_688;
  const SDouble s77 = ext_ident_double_689;
  const SDouble s78 = ext_ident_double_690;
  const SDouble s79 = ext_ident_double_691;
  const SDouble s80 = ext_ident_double_692;
  const SDouble s81 = ext_ident_double_693;
  const SDouble s82 = ext_ident_double_694;
  const SDouble s83 = ext_ident_double_695;
  const SDouble s84 = ext_ident_double_717;
  const SDouble s85 = ext_ident_double_706;
  const SDouble s86 = ext_ident_double_705;
  const SDouble s87 = ext_ident_double_697;
  const SDouble s88 = ext_ident_double_698;
  const SDouble s89 = ext_ident_double_699;
  const SDouble s90 = ext_ident_double_700;
  const SDouble s91 = ext_ident_double_701;
  const SDouble s92 = ext_ident_double_702;
  const SDouble s93 = ext_ident_double_703;
  const SDouble s94 = ext_ident_double_704;
  const SDouble s95 = ext_ident_double_716;
  const SDouble s96 = ext_ident_double_715;
  const SDouble s97 = ext_ident_double_707;
  const SDouble s98 = ext_ident_double_708;
  const SDouble s99 = ext_ident_double_709;
  const SDouble s100 = ext_ident_double_710;
  const SDouble s101 = ext_ident_double_711;
  const SDouble s102 = ext_ident_double_712;
  const SDouble s103 = ext_ident_double_713;
  const SDouble s104 = ext_ident_double_714;
  const SDouble s105 = ext_minimal_horizontal_separation;
  const SDouble s106 = ext_ident_double_731;
  const SDouble s107 = ext_ident_double_730;
  const SDouble s108 = ext_ident_double_722;
  const SDouble s109 = ext_ident_double_723;
  const SDouble s110 = ext_ident_double_724;
  const SDouble s111 = ext_ident_double_725;
  const SDouble s112 = ext_ident_double_726;
  const SDouble s113 = ext_ident_double_727;
  const SDouble s114 = ext_ident_double_728;
  const SDouble s115 = ext_ident_double_729;
  const SDouble s116 = ext_ident_double_734;
  const SDouble s117 = ext_ident_double_735;
