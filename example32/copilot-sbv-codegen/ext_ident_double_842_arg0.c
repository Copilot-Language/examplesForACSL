/* File: "ext_ident_double_842_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_841) > 0)? 1 : ((ext_ident_double_841) < 0 ? -1 : 0)));
*/
SDouble ext_ident_double_842_arg0(const SDouble ext_ident_double_841,
                                  const SDouble ext_ident_double_839, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_841;
  const SDouble s1 = ext_ident_double_839;
  ...
  const SDouble s7 = ext_ident_double_840;
