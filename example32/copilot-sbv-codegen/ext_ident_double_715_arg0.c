/* File: "ext_ident_double_715_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_707) - (ext_ident_double_708))) * (((ext_ident_double_709) - (ext_ident_double_710))))) + (((((ext_ident_double_711) - (ext_ident_double_712))) * (((ext_ident_double_713) - (ext_ident_double_714))))))));
*/
SDouble ext_ident_double_715_arg0(const SDouble ext_ident_double_707,
...
{
  const SDouble s0 = ext_ident_double_707;
  ...
  const SDouble s6 = ext_ident_double_708;
