/* File: "ext_ident_double_1063_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_1052) * (ext_ident_double_1062))));
*/
SDouble ext_ident_double_1063_arg0(const SDouble ext_ident_double_1052,
                                   const SDouble ext_ident_double_1051,
                                   const SDouble ext_ident_double_1043, const SBool *queue_0,
                                   ...
                                   const SWord32 ptr_3, const SDouble ext_ident_double_1045,
                                   ...
                                   const SWord32 ptr_8, const SDouble ext_ident_double_1048,
                                   const SDouble ext_intruder_velocity_y, const SDouble *queue_6,
                                   const SWord32 ptr_6, const SDouble ext_ident_double_1049,
                                   ...
                                   const SWord32 ptr_1, const SDouble ext_ident_double_1054,
                                   const SDouble ext_intruder_position_x, const SDouble *queue_2,
                                   const SWord32 ptr_2, const SDouble ext_ident_double_1055,
                                   ...
                                   const SWord32 ptr_4, const SDouble ext_ident_double_1058,
                                   const SDouble ext_intruder_position_y, const SDouble *queue_5,
                                   const SWord32 ptr_5, const SDouble ext_ident_double_1059,
                                   const SDouble ext_ident_double_1060,
                                   const SDouble ext_minimal_horizontal_separation)
{
  const SDouble s0 = ext_ident_double_1052;
  const SDouble s1 = ext_ident_double_1051;
  const SDouble s2 = ext_ident_double_1043;
  ...
  const SDouble s8 = ext_ident_double_1044;
  const SDouble s9 = ext_intruder_velocity_x;
  const SDouble s10 = queue_3[0];
  const SWord32 s11 = ptr_3;
  const SDouble s12 = ext_ident_double_1045;
  const SDouble s13 = ext_ident_double_1046;
  const SDouble s14 = ext_ident_double_1047;
  const SDouble s15 = ext_ownship_velocity_y;
  const SDouble s16 = queue_8[0];
  const SWord32 s17 = ptr_8;
  const SDouble s18 = ext_ident_double_1048;
  const SDouble s19 = ext_intruder_velocity_y;
  const SDouble s20 = queue_6[0];
  const SWord32 s21 = ptr_6;
  const SDouble s22 = ext_ident_double_1049;
  const SDouble s23 = ext_ident_double_1050;
  const SDouble s24 = ext_ident_double_1062;
  const SDouble s25 = ext_ident_double_1061;
  const SDouble s26 = ext_ident_double_1053;
  const SDouble s27 = ext_ownship_position_x;
  const SDouble s28 = queue_1[0];
  const SWord32 s29 = ptr_1;
  const SDouble s30 = ext_ident_double_1054;
  const SDouble s31 = ext_intruder_position_x;
  const SDouble s32 = queue_2[0];
  const SWord32 s33 = ptr_2;
  const SDouble s34 = ext_ident_double_1055;
  const SDouble s35 = ext_ident_double_1056;
  const SDouble s36 = ext_ident_double_1057;
  const SDouble s37 = ext_ownship_position_y;
  const SDouble s38 = queue_4[0];
  const SWord32 s39 = ptr_4;
  const SDouble s40 = ext_ident_double_1058;
  const SDouble s41 = ext_intruder_position_y;
  const SDouble s42 = queue_5[0];
  const SWord32 s43 = ptr_5;
  const SDouble s44 = ext_ident_double_1059;
  const SDouble s45 = ext_ident_double_1060;
