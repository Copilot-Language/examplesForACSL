/* File: "ext_sqrt_974_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (((((ext_ident_double_943) * (ext_ident_double_952))) - (ext_ident_double_973)));
*/
SDouble ext_sqrt_974_arg0(const SDouble ext_ident_double_943,
...
{
  const SDouble s0 = ext_ident_double_943;
  ...
  const SDouble s7 = ext_ident_double_936;
  const SDouble s8 = ext_intruder_position_x;
  const SDouble s9 = queue_2[0];
  const SWord32 s10 = ptr_2;
  const SDouble s11 = ext_ident_double_937;
  const SDouble s12 = ext_ownship_velocity_x;
  const SDouble s13 = queue_7[0];
  const SWord32 s14 = ptr_7;
  const SDouble s15 = ext_ident_double_938;
  const SDouble s16 = ext_intruder_velocity_x;
  const SDouble s17 = queue_3[0];
  const SWord32 s18 = ptr_3;
  const SDouble s19 = ext_ident_double_939;
  const SDouble s20 = ext_ownship_position_y;
  const SDouble s21 = queue_4[0];
  const SWord32 s22 = ptr_4;
  const SDouble s23 = ext_ident_double_940;
  const SDouble s24 = ext_intruder_position_y;
  const SDouble s25 = queue_5[0];
  const SWord32 s26 = ptr_5;
  const SDouble s27 = ext_ident_double_941;
  const SDouble s28 = ext_ownship_velocity_y;
  const SDouble s29 = queue_8[0];
  const SWord32 s30 = ptr_8;
  const SDouble s31 = ext_ident_double_942;
  const SDouble s32 = ext_intruder_velocity_y;
  const SDouble s33 = queue_6[0];
  const SWord32 s34 = ptr_6;
  const SDouble s35 = ext_ident_double_952;
  const SDouble s36 = ext_ident_double_944;
  const SDouble s37 = ext_ident_double_945;
  const SDouble s38 = ext_ident_double_946;
  const SDouble s39 = ext_ident_double_947;
  const SDouble s40 = ext_ident_double_948;
  const SDouble s41 = ext_ident_double_949;
  const SDouble s42 = ext_ident_double_950;
  const SDouble s43 = ext_ident_double_951;
  const SDouble s44 = ext_ident_double_973;
  const SDouble s45 = ext_ident_double_962;
  const SDouble s46 = ext_ident_double_961;
  const SDouble s47 = ext_ident_double_953;
  const SDouble s48 = ext_ident_double_954;
  const SDouble s49 = ext_ident_double_955;
  const SDouble s50 = ext_ident_double_956;
  const SDouble s51 = ext_ident_double_957;
  const SDouble s52 = ext_ident_double_958;
  const SDouble s53 = ext_ident_double_959;
  const SDouble s54 = ext_ident_double_960;
  const SDouble s55 = ext_ident_double_972;
  const SDouble s56 = ext_ident_double_971;
  const SDouble s57 = ext_ident_double_963;
  const SDouble s58 = ext_ident_double_964;
  const SDouble s59 = ext_ident_double_965;
  const SDouble s60 = ext_ident_double_966;
  const SDouble s61 = ext_ident_double_967;
  const SDouble s62 = ext_ident_double_968;
  const SDouble s63 = ext_ident_double_969;
  const SDouble s64 = ext_ident_double_970;
