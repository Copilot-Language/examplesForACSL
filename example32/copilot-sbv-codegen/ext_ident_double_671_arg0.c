...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_670) > 0)? 1 : ((ext_ident_double_670) < 0 ? -1 : 0)));
*/
SDouble ext_ident_double_671_arg0(const SDouble ext_ident_double_670,
                                  const SDouble ext_ident_double_668, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_670;
  const SDouble s1 = ext_ident_double_668;
  ...
  const SDouble s7 = ext_ident_double_669;
