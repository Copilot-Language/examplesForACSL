...
/*@
 assigns \nothing;
 ensures \result == ((ext_sqrt_889));
*/
SDouble ext_ident_double_890_arg0(const SDouble ext_sqrt_889,
...
{
  const SDouble s0 = ext_sqrt_889;
  const SDouble s1 = ext_ident_double_858;
  const SDouble s2 = ext_ident_double_850;
  ...
  const SDouble s8 = ext_ident_double_851;
  const SDouble s9 = ext_intruder_position_x;
  const SDouble s10 = queue_2[0];
  const SWord32 s11 = ptr_2;
  const SDouble s12 = ext_ident_double_852;
  const SDouble s13 = ext_ownship_velocity_x;
  const SDouble s14 = queue_7[0];
  const SWord32 s15 = ptr_7;
  const SDouble s16 = ext_ident_double_853;
  const SDouble s17 = ext_intruder_velocity_x;
  const SDouble s18 = queue_3[0];
  const SWord32 s19 = ptr_3;
  const SDouble s20 = ext_ident_double_854;
  const SDouble s21 = ext_ownship_position_y;
  const SDouble s22 = queue_4[0];
  const SWord32 s23 = ptr_4;
  const SDouble s24 = ext_ident_double_855;
  const SDouble s25 = ext_intruder_position_y;
  const SDouble s26 = queue_5[0];
  const SWord32 s27 = ptr_5;
  const SDouble s28 = ext_ident_double_856;
  const SDouble s29 = ext_ownship_velocity_y;
  const SDouble s30 = queue_8[0];
  const SWord32 s31 = ptr_8;
  const SDouble s32 = ext_ident_double_857;
  const SDouble s33 = ext_intruder_velocity_y;
  const SDouble s34 = queue_6[0];
  const SWord32 s35 = ptr_6;
  const SDouble s36 = ext_ident_double_867;
  const SDouble s37 = ext_ident_double_859;
  const SDouble s38 = ext_ident_double_860;
  const SDouble s39 = ext_ident_double_861;
  const SDouble s40 = ext_ident_double_862;
  const SDouble s41 = ext_ident_double_863;
  const SDouble s42 = ext_ident_double_864;
  const SDouble s43 = ext_ident_double_865;
  const SDouble s44 = ext_ident_double_866;
  const SDouble s45 = ext_ident_double_888;
  const SDouble s46 = ext_ident_double_877;
  const SDouble s47 = ext_ident_double_876;
  const SDouble s48 = ext_ident_double_868;
  const SDouble s49 = ext_ident_double_869;
  const SDouble s50 = ext_ident_double_870;
  const SDouble s51 = ext_ident_double_871;
  const SDouble s52 = ext_ident_double_872;
  const SDouble s53 = ext_ident_double_873;
  const SDouble s54 = ext_ident_double_874;
  const SDouble s55 = ext_ident_double_875;
  const SDouble s56 = ext_ident_double_887;
  const SDouble s57 = ext_ident_double_886;
  const SDouble s58 = ext_ident_double_878;
  const SDouble s59 = ext_ident_double_879;
  const SDouble s60 = ext_ident_double_880;
  const SDouble s61 = ext_ident_double_881;
  const SDouble s62 = ext_ident_double_882;
  const SDouble s63 = ext_ident_double_883;
  const SDouble s64 = ext_ident_double_884;
  const SDouble s65 = ext_ident_double_885;
