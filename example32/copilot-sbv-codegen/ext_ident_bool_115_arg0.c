/* File: "ext_ident_bool_115_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ident_double_113) - (ext_ident_double_114))) < (0.0))));
*/
SBool ext_ident_bool_115_arg0(const SDouble ext_ident_double_113,
                              const SBool *queue_0, const SWord32 ptr_0,
                              const SDouble ext_ownship_velocity_z, const SDouble *queue_12,
                              const SWord32 ptr_12, const SDouble ext_ident_double_114,
