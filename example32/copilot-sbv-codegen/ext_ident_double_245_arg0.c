...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_240) * (ext_ident_double_244))));
*/
SDouble ext_ident_double_245_arg0(const SDouble ext_ident_double_240,
                                  ...
                                  const SDouble ext_ident_double_242)
{
  ...
  const SDouble s1 = ext_ident_double_238;
  ...
  const SDouble s7 = ext_ident_double_239;
  const SDouble s8 = ext_intruder_position_z;
  const SDouble s9 = queue_10[0];
  const SWord32 s10 = ptr_10;
  const SDouble s11 = ext_ident_double_244;
  const SDouble s12 = ext_ident_double_243;
