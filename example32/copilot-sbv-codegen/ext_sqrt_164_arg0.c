...
/*@
 assigns \nothing;
 ensures \result == (((ext_ident_double_163) - (((ext_minimal_horizontal_separation) * (ext_minimal_horizontal_separation)))));
*/
                          ...
                          const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s1 = ext_ident_double_155;
  ...
  const SDouble s17 = ext_ident_double_160;
  ...
  const SDouble s22 = ext_ident_double_162;
