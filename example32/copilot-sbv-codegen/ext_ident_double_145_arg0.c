...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_137) - (ext_ident_double_138))) * (((ext_ident_double_139) - (ext_ident_double_140))))) + (((((ext_ident_double_141) - (ext_ident_double_142))) * (((ext_ident_double_143) - (ext_ident_double_144))))))));
*/
SDouble ext_ident_double_145_arg0(const SDouble ext_ident_double_137,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_x, const SDouble *queue_1,
                                  const SWord32 ptr_1, const SDouble ext_ident_double_138,
                                  ...
                                  const SDouble ext_ident_double_144)
{
  ...
  const SDouble s6 = ext_ident_double_138;
  const SDouble s7 = ext_intruder_position_x;
  const SDouble s8 = queue_2[0];
  const SWord32 s9 = ptr_2;
  const SDouble s10 = ext_ident_double_139;
  const SDouble s11 = ext_ident_double_140;
  const SDouble s12 = ext_ident_double_141;
  ...
  const SDouble s21 = ext_ident_double_144;
