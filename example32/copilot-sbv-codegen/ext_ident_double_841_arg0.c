/* File: "ext_ident_double_841_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_839) - (ext_ident_double_840))));
*/
SDouble ext_ident_double_841_arg0(const SDouble ext_ident_double_839,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_z, const SDouble *queue_9,
                                  const SWord32 ptr_9, const SDouble ext_ident_double_840,
                                  ...
                                  const SWord32 ptr_10)
{
  ...
  const SDouble s6 = ext_ident_double_840;
