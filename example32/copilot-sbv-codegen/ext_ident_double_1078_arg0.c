/* File: "ext_ident_double_1078_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_1067) / (ext_ident_double_1077))));
*/
SDouble ext_ident_double_1078_arg0(const SDouble ext_ident_double_1067,
...
{
  const SDouble s0 = ext_ident_double_1067;
  const SDouble s1 = ext_ident_double_1010;
  const SDouble s2 = ext_ident_double_1009;
  const SDouble s3 = ext_ident_double_1001;
  ...
  const SDouble s9 = ext_ident_double_1002;
  const SDouble s10 = ext_intruder_position_x;
  const SDouble s11 = queue_2[0];
  const SWord32 s12 = ptr_2;
  const SDouble s13 = ext_ident_double_1003;
  const SDouble s14 = ext_ownship_velocity_x;
  const SDouble s15 = queue_7[0];
  const SWord32 s16 = ptr_7;
  const SDouble s17 = ext_ident_double_1004;
  const SDouble s18 = ext_intruder_velocity_x;
  const SDouble s19 = queue_3[0];
  const SWord32 s20 = ptr_3;
  const SDouble s21 = ext_ident_double_1005;
  const SDouble s22 = ext_ownship_position_y;
  const SDouble s23 = queue_4[0];
  const SWord32 s24 = ptr_4;
  const SDouble s25 = ext_ident_double_1006;
  const SDouble s26 = ext_intruder_position_y;
  const SDouble s27 = queue_5[0];
  const SWord32 s28 = ptr_5;
  const SDouble s29 = ext_ident_double_1007;
  const SDouble s30 = ext_ownship_velocity_y;
  const SDouble s31 = queue_8[0];
  const SWord32 s32 = ptr_8;
  const SDouble s33 = ext_ident_double_1008;
  const SDouble s34 = ext_intruder_velocity_y;
  const SDouble s35 = queue_6[0];
  const SWord32 s36 = ptr_6;
  const SDouble s37 = ext_ident_double_1066;
  const SDouble s38 = ext_ident_double_1024;
  const SBool   s39 = ext_ident_bool_1019;
  const SDouble s40 = ext_ident_double_1018;
  const SDouble s41 = ext_ident_double_1013;
  const SDouble s42 = ext_ident_double_1011;
  const SDouble s43 = ext_ownship_position_z;
  const SDouble s44 = queue_9[0];
  const SWord32 s45 = ptr_9;
  const SDouble s46 = ext_ident_double_1012;
  const SDouble s47 = ext_intruder_position_z;
  const SDouble s48 = queue_10[0];
  const SWord32 s49 = ptr_10;
  const SDouble s50 = ext_ident_double_1017;
  const SDouble s51 = ext_ident_double_1016;
  const SDouble s52 = ext_ident_double_1014;
  const SDouble s53 = ext_ident_double_1015;
  const SDouble s54 = ext_minimal_vertical_separation;
  const SDouble s55 = ext_ident_double_1023;
  const SDouble s56 = ext_direction_parameter_vertical;
  const SDouble s57 = ext_ident_double_1022;
  const SDouble s58 = ext_ident_double_1020;
  const SDouble s59 = ext_ident_double_1021;
  const SDouble s60 = ext_ident_double_1065;
  const SDouble s61 = ext_sqrt_1064;
  const SDouble s62 = ext_ident_double_1033;
  const SDouble s63 = ext_ident_double_1025;
  const SDouble s64 = ext_ident_double_1026;
  const SDouble s65 = ext_ident_double_1027;
  const SDouble s66 = ext_ident_double_1028;
  const SDouble s67 = ext_ident_double_1029;
  const SDouble s68 = ext_ident_double_1030;
  const SDouble s69 = ext_ident_double_1031;
  const SDouble s70 = ext_ident_double_1032;
  const SDouble s71 = ext_ident_double_1042;
  const SDouble s72 = ext_ident_double_1034;
  const SDouble s73 = ext_ident_double_1035;
  const SDouble s74 = ext_ident_double_1036;
  const SDouble s75 = ext_ident_double_1037;
  const SDouble s76 = ext_ident_double_1038;
  const SDouble s77 = ext_ident_double_1039;
  const SDouble s78 = ext_ident_double_1040;
  const SDouble s79 = ext_ident_double_1041;
  const SDouble s80 = ext_ident_double_1063;
  const SDouble s81 = ext_ident_double_1052;
  const SDouble s82 = ext_ident_double_1051;
  const SDouble s83 = ext_ident_double_1043;
  const SDouble s84 = ext_ident_double_1044;
  const SDouble s85 = ext_ident_double_1045;
  const SDouble s86 = ext_ident_double_1046;
  const SDouble s87 = ext_ident_double_1047;
  const SDouble s88 = ext_ident_double_1048;
  const SDouble s89 = ext_ident_double_1049;
  const SDouble s90 = ext_ident_double_1050;
  const SDouble s91 = ext_ident_double_1062;
  const SDouble s92 = ext_ident_double_1061;
  const SDouble s93 = ext_ident_double_1053;
  const SDouble s94 = ext_ident_double_1054;
  const SDouble s95 = ext_ident_double_1055;
  const SDouble s96 = ext_ident_double_1056;
  const SDouble s97 = ext_ident_double_1057;
  const SDouble s98 = ext_ident_double_1058;
  const SDouble s99 = ext_ident_double_1059;
  const SDouble s100 = ext_ident_double_1060;
  const SDouble s101 = ext_minimal_horizontal_separation;
  const SDouble s102 = ext_ident_double_1077;
  const SDouble s103 = ext_ident_double_1076;
  const SDouble s104 = ext_ident_double_1068;
  const SDouble s105 = ext_ident_double_1069;
  const SDouble s106 = ext_ident_double_1070;
  const SDouble s107 = ext_ident_double_1071;
  const SDouble s108 = ext_ident_double_1072;
  const SDouble s109 = ext_ident_double_1073;
  const SDouble s110 = ext_ident_double_1074;
  const SDouble s111 = ext_ident_double_1075;
