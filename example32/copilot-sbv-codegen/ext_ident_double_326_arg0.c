...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_324) - (ext_ident_double_325))));
*/
SDouble ext_ident_double_326_arg0(const SDouble ext_ident_double_324,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_z, const SDouble *queue_9,
                                  const SWord32 ptr_9, const SDouble ext_ident_double_325,
