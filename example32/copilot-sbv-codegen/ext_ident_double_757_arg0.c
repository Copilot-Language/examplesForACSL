...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_756) > 0)? 1 : ((ext_ident_double_756) < 0 ? -1 : 0)));
*/
SDouble ext_ident_double_757_arg0(const SDouble ext_ident_double_756,
                                  const SDouble ext_ident_double_754, const SBool *queue_0,
...
{
  const SDouble s0 = ext_ident_double_756;
  const SDouble s1 = ext_ident_double_754;
  ...
  const SDouble s7 = ext_ident_double_755;
