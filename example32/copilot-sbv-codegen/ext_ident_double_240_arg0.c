...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_238) - (ext_ident_double_239))));
*/
SDouble ext_ident_double_240_arg0(const SDouble ext_ident_double_238,
...
{
  const SDouble s0 = ext_ident_double_238;
  ...
  const SDouble s6 = ext_ident_double_239;
