/* File: "ext_ident_double_962_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((ext_ident_double_961));
*/
SDouble ext_ident_double_962_arg0(const SDouble ext_ident_double_961,
...
{
  const SDouble s0 = ext_ident_double_961;
  const SDouble s1 = ext_ident_double_953;
