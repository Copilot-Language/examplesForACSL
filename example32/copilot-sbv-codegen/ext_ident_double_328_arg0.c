...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_323) * (ext_ident_double_327))));
*/
SDouble ext_ident_double_328_arg0(const SDouble ext_ident_double_323,
                                  ...
                                  const SDouble ext_ident_double_325)
{
  ...
  const SDouble s1 = ext_ident_double_321;
  ...
  const SDouble s7 = ext_ident_double_322;
  ...
  const SDouble s12 = ext_ident_double_326;
  const SDouble s13 = ext_ident_double_324;
  const SDouble s14 = ext_ident_double_325;
