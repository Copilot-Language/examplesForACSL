/* File: "ext_ident_double_1204_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*test 003*/
/*ACSL to write
 label "thetaVert_part2.1" (((Extf_ident_double(label "ownPositionX" (if s0 then Ext_ownship_position_x else s1)) - Extf_ident_double(label "intPositionX" (if s0 then Ext_intruder_position_x else s2))) * (Extf_ident_double(label "ownVelocityX" (if s0 then Ext_ownship_velocity_x else s7)) - Extf_ident_double(label "intVelocityX" (if s0 then Ext_intruder_velocity_x else s3)))) + ((Extf_ident_double(label "ownPositionY" (if s0 then Ext_ownship_position_y else s4)) - Extf_ident_double(label "intPositionY" (if s0 then Ext_intruder_position_y else s5))) * (Extf_ident_double(label "ownVelocityY" (if s0 then Ext_ownship_velocity_y else s8)) - Extf_ident_double(label "intVelocityY" (if s0 then Ext_intruder_velocity_y else s6)))))
*/
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_1196) - (ext_ident_double_1197))) * (((ext_ident_double_1198) - (ext_ident_double_1199))))) + (((((ext_ident_double_1200) - (ext_ident_double_1201))) * (((ext_ident_double_1202) - (ext_ident_double_1203))))))));
*/
SDouble ext_ident_double_1204_arg0(const SDouble ext_ident_double_1196,
                                   ...
                                   const SWord32 ptr_6)
{
  const SDouble s0 = ext_ident_double_1196;
  ...
  const SDouble s41 = s40 /* thetaVert_part2.1 */;
