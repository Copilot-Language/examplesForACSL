...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_495) - (ext_ident_double_496))));
*/
SDouble ext_ident_double_497_arg0(const SDouble ext_ident_double_495,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_z, const SDouble *queue_9,
                                  const SWord32 ptr_9, const SDouble ext_ident_double_496,
                                  const SDouble ext_intruder_position_z, const SDouble *queue_10,
                                  const SWord32 ptr_10)
{
  const SDouble s0 = ext_ident_double_495;
