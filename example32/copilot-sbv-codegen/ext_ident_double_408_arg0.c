...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_406) - (ext_ident_double_407))));
*/
SDouble ext_ident_double_408_arg0(const SDouble ext_ident_double_406,
                                  ...
                                  const SWord32 ptr_10)
{
  ...
  const SDouble s6 = ext_ident_double_407;
