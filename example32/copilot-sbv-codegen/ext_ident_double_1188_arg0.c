...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_1187) > 0)? 1 : ((ext_ident_double_1187) < 0 ? -1 : 0)));
*/
SDouble ext_ident_double_1188_arg0(const SDouble ext_ident_double_1187,
                                   const SDouble ext_ident_double_1185, const SBool *queue_0,
                                   ...
                                   const SWord32 ptr_10)
{
  ...
  const SDouble s1 = ext_ident_double_1185;
  ...
  const SDouble s7 = ext_ident_double_1186;
