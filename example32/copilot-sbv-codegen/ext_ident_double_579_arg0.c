...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_577) - (ext_ident_double_578))));
*/
SDouble ext_ident_double_579_arg0(const SDouble ext_ident_double_577,
...
{
  const SDouble s0 = ext_ident_double_577;
