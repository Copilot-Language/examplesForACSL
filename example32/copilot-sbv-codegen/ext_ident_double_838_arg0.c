...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_836) - (ext_ident_double_837))));
*/
SDouble ext_ident_double_838_arg0(const SDouble ext_ident_double_836,
...
{
  const SDouble s0 = ext_ident_double_836;
  ...
  const SDouble s6 = ext_ident_double_837;
