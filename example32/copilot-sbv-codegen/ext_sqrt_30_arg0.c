...
/*@
 assigns \nothing;
 ensures \result == (ext_ident_double_29);
*/
SDouble ext_sqrt_30_arg0(const SDouble ext_ident_double_29,
...
{
  const SDouble s0 = ext_ident_double_29;
