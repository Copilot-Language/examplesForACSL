...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_311) - (ext_ident_double_312))) * (((ext_ident_double_313) - (ext_ident_double_314))))) + (((((ext_ident_double_315) - (ext_ident_double_316))) * (((ext_ident_double_317) - (ext_ident_double_318))))))));
*/
SDouble ext_ident_double_319_arg0(const SDouble ext_ident_double_311,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_x, const SDouble *queue_1,
                                  const SWord32 ptr_1, const SDouble ext_ident_double_312,
                                  ...
                                  const SWord32 ptr_6)
{
  const SDouble s0 = ext_ident_double_311;
  ...
  const SDouble s10 = ext_ident_double_313;
