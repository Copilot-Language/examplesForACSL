...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_409) - (ext_ident_double_410))));
*/
SDouble ext_ident_double_411_arg0(const SDouble ext_ident_double_409,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_z, const SDouble *queue_9,
                                  const SWord32 ptr_9, const SDouble ext_ident_double_410,
                                  const SDouble ext_intruder_position_z, const SDouble *queue_10,
                                  const SWord32 ptr_10)
{
  const SDouble s0 = ext_ident_double_409;
  ...
  const SDouble s6 = ext_ident_double_410;
