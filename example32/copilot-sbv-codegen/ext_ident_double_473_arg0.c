/* File: "ext_ident_double_473_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_462) / (ext_ident_double_472))));
*/
SDouble ext_ident_double_473_arg0(const SDouble ext_ident_double_462,
                                  ...
                                  const SDouble ext_ident_double_470)
{
  ...
  const SDouble s1 = ext_ident_double_405;
  const SDouble s2 = ext_ident_double_404;
  const SDouble s3 = ext_ident_double_396;
  ...
  const SDouble s9 = ext_ident_double_397;
  const SDouble s10 = ext_intruder_position_x;
  const SDouble s11 = queue_2[0];
  const SWord32 s12 = ptr_2;
  const SDouble s13 = ext_ident_double_398;
  const SDouble s14 = ext_ownship_velocity_x;
  const SDouble s15 = queue_7[0];
  const SWord32 s16 = ptr_7;
  const SDouble s17 = ext_ident_double_399;
  const SDouble s18 = ext_intruder_velocity_x;
  const SDouble s19 = queue_3[0];
  const SWord32 s20 = ptr_3;
  const SDouble s21 = ext_ident_double_400;
  const SDouble s22 = ext_ownship_position_y;
  const SDouble s23 = queue_4[0];
  const SWord32 s24 = ptr_4;
  const SDouble s25 = ext_ident_double_401;
  const SDouble s26 = ext_intruder_position_y;
  const SDouble s27 = queue_5[0];
  const SWord32 s28 = ptr_5;
  const SDouble s29 = ext_ident_double_402;
  const SDouble s30 = ext_ownship_velocity_y;
  const SDouble s31 = queue_8[0];
  const SWord32 s32 = ptr_8;
  const SDouble s33 = ext_ident_double_403;
  const SDouble s34 = ext_intruder_velocity_y;
  const SDouble s35 = queue_6[0];
  const SWord32 s36 = ptr_6;
  const SDouble s37 = ext_ident_double_461;
  const SDouble s38 = ext_ident_double_419;
  const SBool   s39 = ext_ident_bool_414;
  const SDouble s40 = ext_ident_double_413;
  const SDouble s41 = ext_ident_double_408;
  const SDouble s42 = ext_ident_double_406;
  const SDouble s43 = ext_ownship_position_z;
  const SDouble s44 = queue_9[0];
  const SWord32 s45 = ptr_9;
  const SDouble s46 = ext_ident_double_407;
  const SDouble s47 = ext_intruder_position_z;
  const SDouble s48 = queue_10[0];
  const SWord32 s49 = ptr_10;
  const SDouble s50 = ext_ident_double_412;
  const SDouble s51 = ext_ident_double_411;
  const SDouble s52 = ext_ident_double_409;
  const SDouble s53 = ext_ident_double_410;
  const SDouble s54 = ext_minimal_vertical_separation;
  const SDouble s55 = ext_ident_double_418;
  const SDouble s56 = ext_direction_parameter_vertical;
  const SDouble s57 = ext_ident_double_417;
  const SDouble s58 = ext_ident_double_415;
  const SDouble s59 = ext_ident_double_416;
  const SDouble s60 = ext_ident_double_460;
  const SDouble s61 = ext_sqrt_459;
  const SDouble s62 = ext_ident_double_428;
  const SDouble s63 = ext_ident_double_420;
  const SDouble s64 = ext_ident_double_421;
  const SDouble s65 = ext_ident_double_422;
  const SDouble s66 = ext_ident_double_423;
  const SDouble s67 = ext_ident_double_424;
  const SDouble s68 = ext_ident_double_425;
  const SDouble s69 = ext_ident_double_426;
  const SDouble s70 = ext_ident_double_427;
  const SDouble s71 = ext_ident_double_437;
  const SDouble s72 = ext_ident_double_429;
  const SDouble s73 = ext_ident_double_430;
  const SDouble s74 = ext_ident_double_431;
  const SDouble s75 = ext_ident_double_432;
  const SDouble s76 = ext_ident_double_433;
  const SDouble s77 = ext_ident_double_434;
  const SDouble s78 = ext_ident_double_435;
  const SDouble s79 = ext_ident_double_436;
  const SDouble s80 = ext_ident_double_458;
  const SDouble s81 = ext_ident_double_447;
  const SDouble s82 = ext_ident_double_446;
  const SDouble s83 = ext_ident_double_438;
  const SDouble s84 = ext_ident_double_439;
  const SDouble s85 = ext_ident_double_440;
  const SDouble s86 = ext_ident_double_441;
  const SDouble s87 = ext_ident_double_442;
  const SDouble s88 = ext_ident_double_443;
  const SDouble s89 = ext_ident_double_444;
  const SDouble s90 = ext_ident_double_445;
  const SDouble s91 = ext_ident_double_457;
  const SDouble s92 = ext_ident_double_456;
  const SDouble s93 = ext_ident_double_448;
  const SDouble s94 = ext_ident_double_449;
  const SDouble s95 = ext_ident_double_450;
  const SDouble s96 = ext_ident_double_451;
  const SDouble s97 = ext_ident_double_452;
  const SDouble s98 = ext_ident_double_453;
  const SDouble s99 = ext_ident_double_454;
  const SDouble s100 = ext_ident_double_455;
  const SDouble s101 = ext_minimal_horizontal_separation;
  const SDouble s102 = ext_ident_double_472;
  const SDouble s103 = ext_ident_double_471;
  const SDouble s104 = ext_ident_double_463;
  const SDouble s105 = ext_ident_double_464;
  const SDouble s106 = ext_ident_double_465;
  const SDouble s107 = ext_ident_double_466;
  const SDouble s108 = ext_ident_double_467;
  const SDouble s109 = ext_ident_double_468;
  const SDouble s110 = ext_ident_double_469;
  const SDouble s111 = ext_ident_double_470;
