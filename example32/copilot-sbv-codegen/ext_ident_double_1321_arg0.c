/* File: "ext_ident_double_1321_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((ext_sqrt_1320));
*/
SDouble ext_ident_double_1321_arg0(const SDouble ext_sqrt_1320,
...
{
  const SDouble s0 = ext_sqrt_1320;
  const SDouble s1 = ext_ident_double_1289;
  const SDouble s2 = ext_ident_double_1281;
  ...
  const SDouble s8 = ext_ident_double_1282;
  const SDouble s9 = ext_intruder_position_x;
  const SDouble s10 = queue_2[0];
  const SWord32 s11 = ptr_2;
  const SDouble s12 = ext_ident_double_1283;
  const SDouble s13 = ext_ownship_velocity_x;
  const SDouble s14 = queue_7[0];
  const SWord32 s15 = ptr_7;
  const SDouble s16 = ext_ident_double_1284;
  const SDouble s17 = ext_intruder_velocity_x;
  const SDouble s18 = queue_3[0];
  const SWord32 s19 = ptr_3;
  const SDouble s20 = ext_ident_double_1285;
  const SDouble s21 = ext_ownship_position_y;
  const SDouble s22 = queue_4[0];
  const SWord32 s23 = ptr_4;
  const SDouble s24 = ext_ident_double_1286;
  const SDouble s25 = ext_intruder_position_y;
  const SDouble s26 = queue_5[0];
  const SWord32 s27 = ptr_5;
  const SDouble s28 = ext_ident_double_1287;
  const SDouble s29 = ext_ownship_velocity_y;
  const SDouble s30 = queue_8[0];
  const SWord32 s31 = ptr_8;
  const SDouble s32 = ext_ident_double_1288;
  const SDouble s33 = ext_intruder_velocity_y;
  const SDouble s34 = queue_6[0];
  const SWord32 s35 = ptr_6;
  const SDouble s36 = ext_ident_double_1298;
  const SDouble s37 = ext_ident_double_1290;
  const SDouble s38 = ext_ident_double_1291;
  const SDouble s39 = ext_ident_double_1292;
  const SDouble s40 = ext_ident_double_1293;
  const SDouble s41 = ext_ident_double_1294;
  const SDouble s42 = ext_ident_double_1295;
  const SDouble s43 = ext_ident_double_1296;
  const SDouble s44 = ext_ident_double_1297;
  const SDouble s45 = ext_ident_double_1319;
  const SDouble s46 = ext_ident_double_1308;
  const SDouble s47 = ext_ident_double_1307;
  const SDouble s48 = ext_ident_double_1299;
  const SDouble s49 = ext_ident_double_1300;
  const SDouble s50 = ext_ident_double_1301;
  const SDouble s51 = ext_ident_double_1302;
  const SDouble s52 = ext_ident_double_1303;
  const SDouble s53 = ext_ident_double_1304;
  const SDouble s54 = ext_ident_double_1305;
  const SDouble s55 = ext_ident_double_1306;
  const SDouble s56 = ext_ident_double_1318;
  const SDouble s57 = ext_ident_double_1317;
  const SDouble s58 = ext_ident_double_1309;
  const SDouble s59 = ext_ident_double_1310;
  const SDouble s60 = ext_ident_double_1311;
  const SDouble s61 = ext_ident_double_1312;
  const SDouble s62 = ext_ident_double_1313;
  const SDouble s63 = ext_ident_double_1314;
  const SDouble s64 = ext_ident_double_1315;
  const SDouble s65 = ext_ident_double_1316;
