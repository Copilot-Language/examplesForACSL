/* File: "ext_ident_double_1184_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_1182) - (ext_ident_double_1183))));
*/
SDouble ext_ident_double_1184_arg0(const SDouble ext_ident_double_1182,
...
{
  const SDouble s0 = ext_ident_double_1182;
  ...
  const SDouble s6 = ext_ident_double_1183;
