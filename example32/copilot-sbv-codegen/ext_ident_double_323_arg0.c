...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_321) - (ext_ident_double_322))));
*/
SDouble ext_ident_double_323_arg0(const SDouble ext_ident_double_321,
                                  ...
                                  const SWord32 ptr_10)
{
  ...
  const SDouble s6 = ext_ident_double_322;
