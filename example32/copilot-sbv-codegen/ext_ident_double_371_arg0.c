...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_363) - (ext_ident_double_364))) * (((ext_ident_double_365) - (ext_ident_double_366))))) + (((((ext_ident_double_367) - (ext_ident_double_368))) * (((ext_ident_double_369) - (ext_ident_double_370))))))));
*/
SDouble ext_ident_double_371_arg0(const SDouble ext_ident_double_363,
...
{
  const SDouble s0 = ext_ident_double_363;
  ...
  const SDouble s10 = ext_ident_double_365;
  const SDouble s11 = ext_ident_double_366;
  const SDouble s12 = ext_ident_double_367;
  const SDouble s13 = ext_ownship_position_y;
  const SDouble s14 = queue_4[0];
  const SWord32 s15 = ptr_4;
  const SDouble s16 = ext_ident_double_368;
  const SDouble s17 = ext_intruder_position_y;
  const SDouble s18 = queue_5[0];
  const SWord32 s19 = ptr_5;
  const SDouble s20 = ext_ident_double_369;
  const SDouble s21 = ext_ident_double_370;
