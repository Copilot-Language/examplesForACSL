...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_751) - (ext_ident_double_752))));
*/
SDouble ext_ident_double_753_arg0(const SDouble ext_ident_double_751,
                                  ...
                                  const SWord32 ptr_10)
{
  ...
  const SDouble s6 = ext_ident_double_752;
