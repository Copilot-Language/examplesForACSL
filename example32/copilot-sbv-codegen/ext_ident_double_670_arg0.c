/* File: "ext_ident_double_670_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_668) - (ext_ident_double_669))));
*/
SDouble ext_ident_double_670_arg0(const SDouble ext_ident_double_668,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_z, const SDouble *queue_9,
                                  const SWord32 ptr_9, const SDouble ext_ident_double_669,
                                  const SDouble ext_intruder_position_z, const SDouble *queue_10,
                                  const SWord32 ptr_10)
{
  const SDouble s0 = ext_ident_double_668;
  ...
  const SDouble s6 = ext_ident_double_669;
