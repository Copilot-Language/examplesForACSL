/* File: "ext_ident_double_629_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_618) * (ext_ident_double_628))));
*/
SDouble ext_ident_double_629_arg0(const SDouble ext_ident_double_618,
                                  const SDouble ext_ident_double_617,
                                  const SDouble ext_ident_double_609, const SBool *queue_0,
                                  ...
                                  const SWord32 ptr_3, const SDouble ext_ident_double_611,
                                  ...
                                  const SWord32 ptr_8, const SDouble ext_ident_double_614,
                                  const SDouble ext_intruder_velocity_y, const SDouble *queue_6,
                                  const SWord32 ptr_6, const SDouble ext_ident_double_615,
                                  ...
                                  const SWord32 ptr_1, const SDouble ext_ident_double_620,
                                  const SDouble ext_intruder_position_x, const SDouble *queue_2,
                                  const SWord32 ptr_2, const SDouble ext_ident_double_621,
                                  ...
                                  const SWord32 ptr_4, const SDouble ext_ident_double_624,
                                  const SDouble ext_intruder_position_y, const SDouble *queue_5,
                                  const SWord32 ptr_5, const SDouble ext_ident_double_625,
                                  const SDouble ext_ident_double_626,
                                  const SDouble ext_minimal_horizontal_separation)
{
  const SDouble s0 = ext_ident_double_618;
  const SDouble s1 = ext_ident_double_617;
  const SDouble s2 = ext_ident_double_609;
  ...
  const SDouble s8 = ext_ident_double_610;
  const SDouble s9 = ext_intruder_velocity_x;
  const SDouble s10 = queue_3[0];
  const SWord32 s11 = ptr_3;
  const SDouble s12 = ext_ident_double_611;
  const SDouble s13 = ext_ident_double_612;
  const SDouble s14 = ext_ident_double_613;
  const SDouble s15 = ext_ownship_velocity_y;
  const SDouble s16 = queue_8[0];
  const SWord32 s17 = ptr_8;
  const SDouble s18 = ext_ident_double_614;
  const SDouble s19 = ext_intruder_velocity_y;
  const SDouble s20 = queue_6[0];
  const SWord32 s21 = ptr_6;
  const SDouble s22 = ext_ident_double_615;
  const SDouble s23 = ext_ident_double_616;
  const SDouble s24 = ext_ident_double_628;
  const SDouble s25 = ext_ident_double_627;
  const SDouble s26 = ext_ident_double_619;
  const SDouble s27 = ext_ownship_position_x;
  const SDouble s28 = queue_1[0];
  const SWord32 s29 = ptr_1;
  const SDouble s30 = ext_ident_double_620;
  const SDouble s31 = ext_intruder_position_x;
  const SDouble s32 = queue_2[0];
  const SWord32 s33 = ptr_2;
  const SDouble s34 = ext_ident_double_621;
  const SDouble s35 = ext_ident_double_622;
  const SDouble s36 = ext_ident_double_623;
  const SDouble s37 = ext_ownship_position_y;
  const SDouble s38 = queue_4[0];
  const SWord32 s39 = ptr_4;
  const SDouble s40 = ext_ident_double_624;
  const SDouble s41 = ext_intruder_position_y;
  const SDouble s42 = queue_5[0];
  const SWord32 s43 = ptr_5;
  const SDouble s44 = ext_ident_double_625;
  const SDouble s45 = ext_ident_double_626;
