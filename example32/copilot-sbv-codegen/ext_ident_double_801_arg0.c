...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_ident_double_793) - (ext_ident_double_794))) * (((ext_ident_double_795) - (ext_ident_double_796))))) + (((((ext_ident_double_797) - (ext_ident_double_798))) * (((ext_ident_double_799) - (ext_ident_double_800))))))));
*/
SDouble ext_ident_double_801_arg0(const SDouble ext_ident_double_793,
...
{
  const SDouble s0 = ext_ident_double_793;
