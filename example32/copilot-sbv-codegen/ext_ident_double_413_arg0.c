...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_408) * (ext_ident_double_412))));
*/
SDouble ext_ident_double_413_arg0(const SDouble ext_ident_double_408,
...
{
  const SDouble s0 = ext_ident_double_408;
  const SDouble s1 = ext_ident_double_406;
  ...
  const SDouble s7 = ext_ident_double_407;
  const SDouble s8 = ext_intruder_position_z;
  const SDouble s9 = queue_10[0];
  const SWord32 s10 = ptr_10;
  const SDouble s11 = ext_ident_double_412;
  const SDouble s12 = ext_ident_double_411;
  const SDouble s13 = ext_ident_double_409;
  const SDouble s14 = ext_ident_double_410;
