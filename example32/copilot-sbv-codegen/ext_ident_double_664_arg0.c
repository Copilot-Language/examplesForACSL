/* File: "ext_ident_double_664_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((0.0) - (ext_ident_double_663))));
*/
SDouble ext_ident_double_664_arg0(const SDouble ext_ident_double_663,
                                  ...
                                  const SWord32 ptr_6)
{
  const SDouble s0 = ext_ident_double_663;
  const SDouble s1 = ext_ident_double_655;
