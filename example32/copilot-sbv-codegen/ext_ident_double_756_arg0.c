...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_754) - (ext_ident_double_755))));
*/
SDouble ext_ident_double_756_arg0(const SDouble ext_ident_double_754,
                                  const SBool *queue_0, const SWord32 ptr_0,
                                  const SDouble ext_ownship_position_z, const SDouble *queue_9,
                                  const SWord32 ptr_9, const SDouble ext_ident_double_755,
                                  const SDouble ext_intruder_position_z, const SDouble *queue_10,
                                  const SWord32 ptr_10)
{
  const SDouble s0 = ext_ident_double_754;
  ...
  const SDouble s6 = ext_ident_double_755;
