...
/*ACSL to write
 ((not (local "local_28" = false
       in local "local_29" = (if var "local_28" then (extern "tmp_probe_1" > 250) else (extern "tmp_probe_0" > 250))
          in local "local_30" = (if (var "local_28" || ((extern "tmp_probe_1" > 250) == (extern "tmp_probe_0" > 250))) then 2 else 0)
             in local "local_31" = (var "local_30" == 0)
                in local "local_32" = (if var "local_31" then (extern "tmp_probe_2" > 250) else var "local_29")
                   in local "local_33" = (if (var "local_31" || ((extern "tmp_probe_2" > 250) == var "local_29")) then (var "local_30" + 1) else (var "local_30" - 1))
                      in var "local_32" && ((local "local_34" = (if ((extern "tmp_probe_0" > 250) == local "local_35" = false
                                                                                                     in local "local_36" = (if var "local_35" then (extern "tmp_probe_1" > 250) else (extern "tmp_probe_0" > 250))
                                                                                                        in local "local_37" = (if (var "local_35" || ((extern "tmp_probe_1" > 250) == (extern "tmp_probe_0" > 250))) then 2 else 0)
                                                                                                           in local "local_38" = (var "local_37" == 0)
                                                                                                              in local "local_39" = (if var "local_38" then (extern "tmp_probe_2" > 250) else var "local_36")
                                                                                                                 in local "local_40" = (if (var "local_38" || ((extern "tmp_probe_2" > 250) == var "local_36")) then (var "local_37" + 1) else (var "local_37" - 1))
                                                                                                                    in var "local_39") then 1 else 0)
                                             in local "local_41" = (if ((extern "tmp_probe_1" > 250) == local "local_42" = false
                                                                                                        in local "local_43" = (if var "local_42" then (extern "tmp_probe_1" > 250) else (extern "tmp_probe_0" > 250))
                                                                                                           in local "local_44" = (if (var "local_42" || ((extern "tmp_probe_1" > 250) == (extern "tmp_probe_0" > 250))) then 2 else 0)
                                                                                                              in local "local_45" = (var "local_44" == 0)
                                                                                                                 in local "local_46" = (if var "local_45" then (extern "tmp_probe_2" > 250) else var "local_43")
                                                                                                                    in local "local_47" = (if (var "local_45" || ((extern "tmp_probe_2" > 250) == var "local_43")) then (var "local_44" + 1) else (var "local_44" - 1))
                                                                                                                       in var "local_46") then (var "local_34" + 1) else var "local_34")
                                                in local "local_48" = (if ((extern "tmp_probe_2" > 250) == local "local_49" = false
                                                                                                           in local "local_50" = (if var "local_49" then (extern "tmp_probe_1" > 250) else (extern "tmp_probe_0" > 250))
                                                                                                              in local "local_51" = (if (var "local_49" || ((extern "tmp_probe_1" > 250) == (extern "tmp_probe_0" > 250))) then 2 else 0)
                                                                                                                 in local "local_52" = (var "local_51" == 0)
                                                                                                                    in local "local_53" = (if var "local_52" then (extern "tmp_probe_2" > 250) else var "local_50")
                                                                                                                       in local "local_54" = (if (var "local_52" || ((extern "tmp_probe_2" > 250) == var "local_50")) then (var "local_51" + 1) else (var "local_51" - 1))
                                                                                                                          in var "local_53") then (var "local_41" + 1) else var "local_41")
                                                   in var "local_48" * 2) > 3)) || extern "cooler") && s27)
*/
/*@
 assigns \nothing;
