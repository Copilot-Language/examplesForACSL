...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_115) + (ext_ident_double_133))));
*/
...
{
  const SDouble s0 = ext_ident_double_115;
  const SDouble s1 = ext_ident_double_114;
  ...
  const SDouble s10 = ext_ident_double_133;
  const SDouble s11 = ext_ident_double_123;
  const SBool   s12 = ext_ident_bool_120;
  const SDouble s13 = ext_ident_double_119;
  const SDouble s14 = ext_ident_double_116;
  const SDouble s15 = ext_ownship_position_z;
  const SDouble s16 = ext_intruder_position_z;
  const SDouble s17 = ext_ident_double_118;
  const SDouble s18 = ext_ident_double_117;
  const SDouble s19 = ext_minimal_vertical_separation;
  const SDouble s20 = ext_ident_double_122;
  const SDouble s21 = ext_direction_parameter_vertical;
  const SDouble s22 = ext_ident_double_121;
  const SDouble s23 = ext_ident_double_132;
  const SDouble s24 = ext_sqrt_131;
  const SDouble s25 = ext_ident_double_124;
  const SDouble s26 = ext_ident_double_125;
  const SDouble s27 = ext_ident_double_130;
  const SDouble s28 = ext_ident_double_127;
  const SDouble s29 = ext_ident_double_126;
  const SDouble s30 = ext_ident_double_129;
  const SDouble s31 = ext_ident_double_128;
