...
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ownship_position_x) - (ext_intruder_position_x))) + (((ext_ident_double_350) * (((ext_ownship_velocity_x) - (ext_intruder_velocity_x))))))));
*/
                                  ...
                                  const SDouble ext_ident_double_347)
{
  ...
  const SDouble s2 = ext_ident_double_350;
  const SDouble s3 = ext_ident_double_349;
  const SDouble s4 = ext_ident_double_346;
  const SDouble s5 = ext_ident_double_327;
  const SDouble s6 = ext_ident_double_326;
  ...
  const SDouble s13 = ext_ident_double_345;
  const SDouble s14 = ext_ident_double_335;
  const SBool   s15 = ext_ident_bool_332;
  const SDouble s16 = ext_ident_double_331;
  const SDouble s17 = ext_ident_double_328;
  const SDouble s18 = ext_ownship_position_z;
  const SDouble s19 = ext_intruder_position_z;
  const SDouble s20 = ext_ident_double_330;
  const SDouble s21 = ext_ident_double_329;
  const SDouble s22 = ext_minimal_vertical_separation;
  const SDouble s23 = ext_ident_double_334;
  const SDouble s24 = ext_direction_parameter_vertical;
  const SDouble s25 = ext_ident_double_333;
  const SDouble s26 = ext_ident_double_344;
  const SDouble s27 = ext_sqrt_343;
  const SDouble s28 = ext_ident_double_336;
  const SDouble s29 = ext_ident_double_337;
  const SDouble s30 = ext_ident_double_342;
  const SDouble s31 = ext_ident_double_339;
  const SDouble s32 = ext_ident_double_338;
  const SDouble s33 = ext_ident_double_341;
  const SDouble s34 = ext_ident_double_340;
  const SDouble s35 = ext_minimal_horizontal_separation;
  const SDouble s36 = ext_ident_double_348;
  const SDouble s37 = ext_ident_double_347;
