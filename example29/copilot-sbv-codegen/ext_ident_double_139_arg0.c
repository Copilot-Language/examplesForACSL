/* File: "ext_ident_double_139_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ownship_position_x) - (ext_intruder_position_x))) + (((ext_ident_double_138) * (((ext_ownship_velocity_x) - (ext_intruder_velocity_x))))))));
*/
                                  ...
                                  const SDouble ext_ident_double_135)
{
  ...
  const SDouble s4 = ext_ident_double_134;
  const SDouble s5 = ext_ident_double_115;
  const SDouble s6 = ext_ident_double_114;
  ...
  const SDouble s13 = ext_ident_double_133;
  const SDouble s14 = ext_ident_double_123;
  const SBool   s15 = ext_ident_bool_120;
  ...
  const SDouble s23 = ext_ident_double_122;
  const SDouble s24 = ext_direction_parameter_vertical;
  const SDouble s25 = ext_ident_double_121;
  const SDouble s26 = ext_ident_double_132;
  const SDouble s27 = ext_sqrt_131;
  const SDouble s28 = ext_ident_double_124;
  const SDouble s29 = ext_ident_double_125;
  const SDouble s30 = ext_ident_double_130;
  const SDouble s31 = ext_ident_double_127;
  const SDouble s32 = ext_ident_double_126;
  const SDouble s33 = ext_ident_double_129;
  const SDouble s34 = ext_ident_double_128;
  const SDouble s35 = ext_minimal_horizontal_separation;
  const SDouble s36 = ext_ident_double_136;
