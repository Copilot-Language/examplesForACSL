/* File: "ext_ident_bool_306_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_305) >= (ext_minimal_vertical_separation))));
*/
