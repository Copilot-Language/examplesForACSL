/* File: "ext_sqrt_157_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (((((ext_ident_double_150) * (ext_ident_double_151))) - (ext_ident_double_156)));
*/
...
{
  const SDouble s0 = ext_ident_double_150;
  ...
  const SDouble s11 = ext_ident_double_153;
  const SDouble s12 = ext_ident_double_152;
  const SDouble s13 = ext_ident_double_155;
