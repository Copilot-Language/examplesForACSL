...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_354) * (ext_ident_double_356))));
*/
...
{
  const SDouble s0 = ext_ident_double_354;
  const SDouble s1 = ext_ownship_position_z;
  const SDouble s2 = ext_intruder_position_z;
  const SDouble s3 = ext_ident_double_356;
  const SDouble s4 = ext_ident_double_355;
