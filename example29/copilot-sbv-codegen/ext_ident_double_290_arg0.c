...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_287) * (ext_ident_double_289))));
*/
...
{
  const SDouble s0 = ext_ident_double_287;
  ...
  const SDouble s6 = ext_ident_double_289;
  const SDouble s7 = ext_ident_double_288;
