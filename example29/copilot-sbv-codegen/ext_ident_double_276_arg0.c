/* File: "ext_ident_double_276_arg0.c". Automatically generated by SBV. Do not edit! */
...
{
  const SDouble s0 = ext_sqrt_275;
  const SDouble s1 = ext_ident_double_268;
  ...
  const SDouble s10 = ext_ident_double_269;
  const SDouble s11 = ext_ident_double_274;
  const SDouble s12 = ext_ident_double_271;
  const SDouble s13 = ext_ident_double_270;
  const SDouble s14 = ext_ident_double_273;
  const SDouble s15 = ext_ident_double_272;
