/* File: "ext_ident_bool_396_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_395) >= (ext_minimal_vertical_separation))));
*/
...
{
  const SDouble s0 = ext_ident_double_395;
  const SDouble s1 = ext_ident_double_392;
  const SDouble s2 = ext_ownship_position_z;
  const SDouble s3 = ext_intruder_position_z;
  const SDouble s4 = ext_ident_double_394;
  const SDouble s5 = ext_ident_double_393;
