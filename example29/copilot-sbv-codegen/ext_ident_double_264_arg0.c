/* File: "ext_ident_double_264_arg0.c". Automatically generated by SBV. Do not edit! */
...
{
  const SDouble s0 = ext_sqrt_263;
  const SDouble s1 = ext_ident_double_256;
  ...
  const SDouble s10 = ext_ident_double_257;
  const SDouble s11 = ext_ident_double_262;
  const SDouble s12 = ext_ident_double_259;
  const SDouble s13 = ext_ident_double_258;
  const SDouble s14 = ext_ident_double_261;
