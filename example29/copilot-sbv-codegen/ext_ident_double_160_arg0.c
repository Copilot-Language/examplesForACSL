/* File: "ext_ident_double_160_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_141) + (ext_ident_double_159))));
*/
...
{
  const SDouble s0 = ext_ident_double_141;
  ...
  const SDouble s11 = ext_ident_double_149;
  const SBool   s12 = ext_ident_bool_146;
  const SDouble s13 = ext_ident_double_145;
  const SDouble s14 = ext_ident_double_142;
  const SDouble s15 = ext_ownship_position_z;
  const SDouble s16 = ext_intruder_position_z;
  const SDouble s17 = ext_ident_double_144;
  const SDouble s18 = ext_ident_double_143;
  ...
  const SDouble s22 = ext_ident_double_147;
  const SDouble s23 = ext_ident_double_158;
  const SDouble s24 = ext_sqrt_157;
  const SDouble s25 = ext_ident_double_150;
  const SDouble s26 = ext_ident_double_151;
  const SDouble s27 = ext_ident_double_156;
  const SDouble s28 = ext_ident_double_153;
  const SDouble s29 = ext_ident_double_152;
  const SDouble s30 = ext_ident_double_155;
  const SDouble s31 = ext_ident_double_154;
