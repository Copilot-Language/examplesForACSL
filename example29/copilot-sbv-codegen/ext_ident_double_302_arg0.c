                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s10 = ext_ident_double_295;
  const SDouble s11 = ext_ident_double_300;
  const SDouble s12 = ext_ident_double_297;
  const SDouble s13 = ext_ident_double_296;
  const SDouble s14 = ext_ident_double_299;
  const SDouble s15 = ext_ident_double_298;
