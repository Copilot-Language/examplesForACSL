                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s1 = ext_ident_double_338;
  ...
  const SDouble s11 = ext_ident_double_347;
  const SBool   s12 = ext_ident_bool_344;
  const SDouble s13 = ext_ident_double_343;
  const SDouble s14 = ext_ident_double_340;
  const SDouble s15 = ext_ownship_position_z;
  const SDouble s16 = ext_intruder_position_z;
  const SDouble s17 = ext_ident_double_342;
  const SDouble s18 = ext_ident_double_341;
  const SDouble s19 = ext_minimal_vertical_separation;
  const SDouble s20 = ext_ident_double_346;
  const SDouble s21 = ext_direction_parameter_vertical;
  const SDouble s22 = ext_ident_double_345;
  const SDouble s23 = ext_ident_double_356;
  const SDouble s24 = ext_sqrt_355;
  const SDouble s25 = ext_ident_double_348;
  const SDouble s26 = ext_ident_double_349;
  const SDouble s27 = ext_ident_double_354;
  const SDouble s28 = ext_ident_double_351;
  const SDouble s29 = ext_ident_double_350;
  const SDouble s30 = ext_ident_double_353;
  const SDouble s31 = ext_ident_double_352;
