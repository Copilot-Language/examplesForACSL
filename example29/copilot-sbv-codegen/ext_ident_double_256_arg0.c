                                  ...
                                  const SDouble ext_ident_double_253)
{
  ...
  const SDouble s2 = ext_ident_double_233;
  const SDouble s3 = ext_ident_double_232;
  ...
  const SDouble s12 = ext_ident_double_251;
  const SDouble s13 = ext_ident_double_241;
  const SBool   s14 = ext_ident_bool_238;
  const SDouble s15 = ext_ident_double_237;
  const SDouble s16 = ext_ident_double_234;
  const SDouble s17 = ext_ownship_position_z;
  const SDouble s18 = ext_intruder_position_z;
  const SDouble s19 = ext_ident_double_236;
  const SDouble s20 = ext_ident_double_235;
  const SDouble s21 = ext_minimal_vertical_separation;
  const SDouble s22 = ext_ident_double_240;
  const SDouble s23 = ext_direction_parameter_vertical;
  const SDouble s24 = ext_ident_double_239;
  const SDouble s25 = ext_ident_double_250;
  const SDouble s26 = ext_sqrt_249;
  const SDouble s27 = ext_ident_double_242;
  const SDouble s28 = ext_ident_double_243;
  const SDouble s29 = ext_ident_double_248;
  const SDouble s30 = ext_ident_double_245;
  const SDouble s31 = ext_ident_double_244;
  const SDouble s32 = ext_ident_double_247;
  const SDouble s33 = ext_ident_double_246;
  const SDouble s34 = ext_minimal_horizontal_separation;
  const SDouble s35 = ext_ident_double_254;
  const SDouble s36 = ext_ident_double_253;
