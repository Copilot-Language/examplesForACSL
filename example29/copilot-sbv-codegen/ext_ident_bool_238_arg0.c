/* File: "ext_ident_bool_238_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_237) >= (ext_minimal_vertical_separation))));
*/
