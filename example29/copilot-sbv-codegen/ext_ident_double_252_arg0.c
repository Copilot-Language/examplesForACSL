...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_233) + (ext_ident_double_251))));
*/
...
{
  const SDouble s0 = ext_ident_double_233;
  const SDouble s1 = ext_ident_double_232;
  ...
  const SDouble s10 = ext_ident_double_251;
  const SDouble s11 = ext_ident_double_241;
  const SBool   s12 = ext_ident_bool_238;
  const SDouble s13 = ext_ident_double_237;
  const SDouble s14 = ext_ident_double_234;
  const SDouble s15 = ext_ownship_position_z;
  const SDouble s16 = ext_intruder_position_z;
  const SDouble s17 = ext_ident_double_236;
  const SDouble s18 = ext_ident_double_235;
  const SDouble s19 = ext_minimal_vertical_separation;
  const SDouble s20 = ext_ident_double_240;
  const SDouble s21 = ext_direction_parameter_vertical;
  const SDouble s22 = ext_ident_double_239;
  const SDouble s23 = ext_ident_double_250;
  const SDouble s24 = ext_sqrt_249;
  const SDouble s25 = ext_ident_double_242;
  const SDouble s26 = ext_ident_double_243;
  const SDouble s27 = ext_ident_double_248;
  const SDouble s28 = ext_ident_double_245;
  const SDouble s29 = ext_ident_double_244;
  const SDouble s30 = ext_ident_double_247;
  const SDouble s31 = ext_ident_double_246;
