...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_120) ? (ext_ident_double_122) : (-1.0))));
*/
                                  ...
                                  const SDouble ext_ident_double_121)
{
  ...
  const SDouble s10 = ext_ident_double_121;
