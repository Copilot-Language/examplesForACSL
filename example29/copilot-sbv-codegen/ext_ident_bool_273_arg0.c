/* File: "ext_ident_bool_273_arg0.c". Automatically generated by SBV. Do not edit! */
                              ...
                              const SDouble ext_ident_double_267)
{
  ...
  const SDouble s5 = ext_ident_double_192;
  const SDouble s6 = ext_ident_double_191;
  const SDouble s7 = ext_ident_double_188;
  const SDouble s8 = ext_ident_double_169;
  const SDouble s9 = ext_ident_double_168;
  ...
  const SDouble s16 = ext_ident_double_187;
  const SDouble s17 = ext_ident_double_177;
  const SBool   s18 = ext_ident_bool_174;
  const SDouble s19 = ext_ident_double_173;
  const SDouble s20 = ext_ident_double_170;
  const SDouble s21 = ext_ownship_position_z;
  const SDouble s22 = ext_intruder_position_z;
  const SDouble s23 = ext_ident_double_172;
  const SDouble s24 = ext_ident_double_171;
  const SDouble s25 = ext_minimal_vertical_separation;
  const SDouble s26 = ext_ident_double_176;
  const SDouble s27 = ext_direction_parameter_vertical;
  const SDouble s28 = ext_ident_double_175;
  const SDouble s29 = ext_ident_double_186;
  const SDouble s30 = ext_sqrt_185;
  const SDouble s31 = ext_ident_double_178;
  const SDouble s32 = ext_ident_double_179;
  const SDouble s33 = ext_ident_double_184;
  const SDouble s34 = ext_ident_double_181;
  const SDouble s35 = ext_ident_double_180;
  const SDouble s36 = ext_ident_double_183;
  const SDouble s37 = ext_ident_double_182;
  const SDouble s38 = ext_ident_double_190;
  const SDouble s39 = ext_ident_double_189;
  const SDouble s40 = ext_ident_double_219;
  const SDouble s41 = ext_ident_double_218;
  const SDouble s42 = ext_ident_double_217;
  const SDouble s43 = ext_ident_double_214;
  const SDouble s44 = ext_ident_double_195;
  const SDouble s45 = ext_ident_double_194;
  const SDouble s46 = ext_ident_double_213;
  const SDouble s47 = ext_ident_double_203;
  const SBool   s48 = ext_ident_bool_200;
  const SDouble s49 = ext_ident_double_199;
  const SDouble s50 = ext_ident_double_196;
  const SDouble s51 = ext_ident_double_198;
  const SDouble s52 = ext_ident_double_197;
  const SDouble s53 = ext_ident_double_202;
  const SDouble s54 = ext_ident_double_201;
  const SDouble s55 = ext_ident_double_212;
  const SDouble s56 = ext_sqrt_211;
  const SDouble s57 = ext_ident_double_204;
  const SDouble s58 = ext_ident_double_205;
  const SDouble s59 = ext_ident_double_210;
  const SDouble s60 = ext_ident_double_207;
  const SDouble s61 = ext_ident_double_206;
  const SDouble s62 = ext_ident_double_209;
  const SDouble s63 = ext_ident_double_208;
  const SDouble s64 = ext_ident_double_216;
  const SDouble s65 = ext_ident_double_215;
  const SDouble s66 = ext_ownship_planned_velocity_x;
  const SDouble s67 = ext_ident_double_245;
  const SDouble s68 = ext_ident_double_244;
  const SDouble s69 = ext_ident_double_243;
  const SDouble s70 = ext_ident_double_240;
  const SDouble s71 = ext_ident_double_221;
  const SDouble s72 = ext_ident_double_220;
  const SDouble s73 = ext_ident_double_239;
  const SDouble s74 = ext_ident_double_229;
  const SBool   s75 = ext_ident_bool_226;
  const SDouble s76 = ext_ident_double_225;
  const SDouble s77 = ext_ident_double_222;
  const SDouble s78 = ext_ident_double_224;
  const SDouble s79 = ext_ident_double_223;
  const SDouble s80 = ext_ident_double_228;
  const SDouble s81 = ext_ident_double_227;
  const SDouble s82 = ext_ident_double_238;
  const SDouble s83 = ext_sqrt_237;
  const SDouble s84 = ext_ident_double_230;
  const SDouble s85 = ext_ident_double_231;
  const SDouble s86 = ext_ident_double_236;
  const SDouble s87 = ext_ident_double_233;
  const SDouble s88 = ext_ident_double_232;
  const SDouble s89 = ext_ident_double_235;
  const SDouble s90 = ext_ident_double_234;
  const SDouble s91 = ext_ident_double_242;
  const SDouble s92 = ext_ident_double_241;
  const SDouble s93 = ext_ownship_planned_velocity_y;
  const SDouble s94 = ext_ident_double_271;
  const SDouble s95 = ext_ident_double_270;
  const SDouble s96 = ext_ident_double_269;
  const SDouble s97 = ext_ident_double_266;
  const SDouble s98 = ext_ident_double_247;
  const SDouble s99 = ext_ident_double_246;
  const SDouble s100 = ext_ident_double_265;
  const SDouble s101 = ext_ident_double_255;
  const SBool   s102 = ext_ident_bool_252;
  const SDouble s103 = ext_ident_double_251;
  const SDouble s104 = ext_ident_double_248;
  const SDouble s105 = ext_ident_double_250;
  const SDouble s106 = ext_ident_double_249;
  const SDouble s107 = ext_ident_double_254;
  const SDouble s108 = ext_ident_double_253;
  const SDouble s109 = ext_ident_double_264;
  const SDouble s110 = ext_sqrt_263;
  const SDouble s111 = ext_ident_double_256;
  const SDouble s112 = ext_ident_double_257;
  const SDouble s113 = ext_ident_double_262;
  const SDouble s114 = ext_ident_double_259;
  const SDouble s115 = ext_ident_double_258;
  const SDouble s116 = ext_ident_double_261;
  const SDouble s117 = ext_ident_double_260;
  const SDouble s118 = ext_ident_double_268;
  const SDouble s119 = ext_ident_double_267;
