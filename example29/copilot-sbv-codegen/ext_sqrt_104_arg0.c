/* File: "ext_sqrt_104_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (((((ext_ident_double_97) * (ext_ident_double_98))) - (ext_ident_double_103)));
*/
                          ...
                          const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s9 = ext_ident_double_98;
  const SDouble s10 = ext_ident_double_103;
  const SDouble s11 = ext_ident_double_100;
  const SDouble s12 = ext_ident_double_99;
  const SDouble s13 = ext_ident_double_102;
