                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s11 = ext_ident_double_168;
  const SDouble s12 = ext_ident_double_165;
  const SDouble s13 = ext_ident_double_164;
  const SDouble s14 = ext_ident_double_167;
  const SDouble s15 = ext_ident_double_166;
