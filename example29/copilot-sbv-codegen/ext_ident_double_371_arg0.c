/* File: "ext_ident_double_371_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_361) * (ext_ident_double_370))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SBool   s1 = ext_ident_bool_358;
  const SDouble s2 = ext_ident_double_357;
  const SDouble s3 = ext_ident_double_354;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_356;
  const SDouble s7 = ext_ident_double_355;
  const SDouble s8 = ext_minimal_vertical_separation;
  const SDouble s9 = ext_ident_double_360;
  const SDouble s10 = ext_direction_parameter_vertical;
  const SDouble s11 = ext_ident_double_359;
  const SDouble s12 = ext_ident_double_370;
  const SDouble s13 = ext_sqrt_369;
  const SDouble s14 = ext_ident_double_362;
  ...
  const SDouble s23 = ext_ident_double_363;
  const SDouble s24 = ext_ident_double_368;
  const SDouble s25 = ext_ident_double_365;
  const SDouble s26 = ext_ident_double_364;
  const SDouble s27 = ext_ident_double_367;
  const SDouble s28 = ext_ident_double_366;
