...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_16) >= (ext_ident_double_17))));
*/
...
{
  const SDouble s0 = ext_ident_double_16;
  const SDouble s1 = ext_ident_double_15;
  ...
  const SDouble s6 = ext_ident_double_17;
