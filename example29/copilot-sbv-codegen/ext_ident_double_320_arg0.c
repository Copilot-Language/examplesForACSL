/* File: "ext_ident_double_320_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_301) + (ext_ident_double_319))));
*/
...
{
  const SDouble s0 = ext_ident_double_301;
  const SDouble s1 = ext_ident_double_300;
  ...
  const SBool   s12 = ext_ident_bool_306;
  const SDouble s13 = ext_ident_double_305;
  const SDouble s14 = ext_ident_double_302;
  const SDouble s15 = ext_ownship_position_z;
  const SDouble s16 = ext_intruder_position_z;
  const SDouble s17 = ext_ident_double_304;
  const SDouble s18 = ext_ident_double_303;
  const SDouble s19 = ext_minimal_vertical_separation;
  const SDouble s20 = ext_ident_double_308;
  const SDouble s21 = ext_direction_parameter_vertical;
  const SDouble s22 = ext_ident_double_307;
  const SDouble s23 = ext_ident_double_318;
  const SDouble s24 = ext_sqrt_317;
  const SDouble s25 = ext_ident_double_310;
  const SDouble s26 = ext_ident_double_311;
  const SDouble s27 = ext_ident_double_316;
  const SDouble s28 = ext_ident_double_313;
  const SDouble s29 = ext_ident_double_312;
  const SDouble s30 = ext_ident_double_315;
  const SDouble s31 = ext_ident_double_314;
