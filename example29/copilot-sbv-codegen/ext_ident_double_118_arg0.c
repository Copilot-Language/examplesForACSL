                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SBool   s1 = ext_ident_bool_105;
  const SDouble s2 = ext_ident_double_104;
  const SDouble s3 = ext_ident_double_101;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_103;
  const SDouble s7 = ext_ident_double_102;
  const SDouble s8 = ext_minimal_vertical_separation;
  const SDouble s9 = ext_ident_double_107;
  ...
  const SDouble s13 = ext_sqrt_116;
  const SDouble s14 = ext_ident_double_109;
  ...
  const SDouble s23 = ext_ident_double_110;
  const SDouble s24 = ext_ident_double_115;
  const SDouble s25 = ext_ident_double_112;
  const SDouble s26 = ext_ident_double_111;
  const SDouble s27 = ext_ident_double_114;
  const SDouble s28 = ext_ident_double_113;
