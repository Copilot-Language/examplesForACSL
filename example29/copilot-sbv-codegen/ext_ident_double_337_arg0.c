                                  ...
                                  const SDouble ext_ident_double_333)
{
  ...
  const SDouble s3 = ext_ident_double_335;
  const SDouble s4 = ext_ident_double_332;
  const SDouble s5 = ext_ident_double_313;
  const SDouble s6 = ext_ident_double_312;
  ...
  const SDouble s13 = ext_ident_double_331;
  const SDouble s14 = ext_ident_double_321;
  const SBool   s15 = ext_ident_bool_318;
  const SDouble s16 = ext_ident_double_317;
  const SDouble s17 = ext_ident_double_314;
  const SDouble s18 = ext_ownship_position_z;
  const SDouble s19 = ext_intruder_position_z;
  const SDouble s20 = ext_ident_double_316;
  const SDouble s21 = ext_ident_double_315;
  const SDouble s22 = ext_minimal_vertical_separation;
  const SDouble s23 = ext_ident_double_320;
  const SDouble s24 = ext_direction_parameter_vertical;
  const SDouble s25 = ext_ident_double_319;
  const SDouble s26 = ext_ident_double_330;
  const SDouble s27 = ext_sqrt_329;
  const SDouble s28 = ext_ident_double_322;
  const SDouble s29 = ext_ident_double_323;
  const SDouble s30 = ext_ident_double_328;
  const SDouble s31 = ext_ident_double_325;
  const SDouble s32 = ext_ident_double_324;
  const SDouble s33 = ext_ident_double_327;
  const SDouble s34 = ext_ident_double_326;
  const SDouble s35 = ext_minimal_horizontal_separation;
  const SDouble s36 = ext_ident_double_334;
  const SDouble s37 = ext_ident_double_333;
