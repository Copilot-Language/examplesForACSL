/* File: "ext_sqrt_369_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (((((ext_ident_double_362) * (ext_ident_double_363))) - (ext_ident_double_368)));
*/
                          ...
                          const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s9 = ext_ident_double_363;
  const SDouble s10 = ext_ident_double_368;
  const SDouble s11 = ext_ident_double_365;
  const SDouble s12 = ext_ident_double_364;
