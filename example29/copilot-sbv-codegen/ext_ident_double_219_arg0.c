...
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ownship_position_y) - (ext_intruder_position_y))) + (((ext_ident_double_218) * (((ext_ownship_velocity_y) - (ext_intruder_velocity_y))))))));
*/
                                  ...
                                  const SDouble ext_ident_double_215)
{
  ...
  const SDouble s2 = ext_ident_double_218;
  const SDouble s3 = ext_ident_double_217;
  const SDouble s4 = ext_ident_double_214;
  const SDouble s5 = ext_ident_double_195;
  ...
  const SDouble s13 = ext_ident_double_213;
  const SDouble s14 = ext_ident_double_203;
  const SBool   s15 = ext_ident_bool_200;
  const SDouble s16 = ext_ident_double_199;
  const SDouble s17 = ext_ident_double_196;
  const SDouble s18 = ext_ownship_position_z;
  const SDouble s19 = ext_intruder_position_z;
  const SDouble s20 = ext_ident_double_198;
  const SDouble s21 = ext_ident_double_197;
  const SDouble s22 = ext_minimal_vertical_separation;
  const SDouble s23 = ext_ident_double_202;
  const SDouble s24 = ext_direction_parameter_vertical;
  const SDouble s25 = ext_ident_double_201;
  const SDouble s26 = ext_ident_double_212;
  const SDouble s27 = ext_sqrt_211;
  const SDouble s28 = ext_ident_double_204;
  const SDouble s29 = ext_ident_double_205;
  const SDouble s30 = ext_ident_double_210;
  const SDouble s31 = ext_ident_double_207;
  const SDouble s32 = ext_ident_double_206;
  const SDouble s33 = ext_ident_double_209;
  const SDouble s34 = ext_ident_double_208;
  const SDouble s35 = ext_minimal_horizontal_separation;
  const SDouble s36 = ext_ident_double_216;
  const SDouble s37 = ext_ident_double_215;
