/* File: "ext_ident_double_239_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_229) * (ext_ident_double_238))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SBool   s1 = ext_ident_bool_226;
  const SDouble s2 = ext_ident_double_225;
  const SDouble s3 = ext_ident_double_222;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_224;
  const SDouble s7 = ext_ident_double_223;
  ...
  const SDouble s11 = ext_ident_double_227;
  const SDouble s12 = ext_ident_double_238;
  const SDouble s13 = ext_sqrt_237;
  ...
  const SDouble s23 = ext_ident_double_231;
  const SDouble s24 = ext_ident_double_236;
  const SDouble s25 = ext_ident_double_233;
  const SDouble s26 = ext_ident_double_232;
  const SDouble s27 = ext_ident_double_235;
