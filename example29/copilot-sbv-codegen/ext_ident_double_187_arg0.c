...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_184) ? (ext_ident_double_186) : (-1.0))));
*/
                                  ...
                                  const SDouble ext_ident_double_185)
{
  ...
  const SDouble s2 = ext_ident_double_180;
  const SDouble s3 = ext_ownship_position_z;
  const SDouble s4 = ext_intruder_position_z;
  const SDouble s5 = ext_ident_double_182;
  const SDouble s6 = ext_ident_double_181;
  ...
  const SDouble s10 = ext_ident_double_185;
