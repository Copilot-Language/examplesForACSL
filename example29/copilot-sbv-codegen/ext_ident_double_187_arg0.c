...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_177) * (ext_ident_double_186))));
*/
...
{
  const SDouble s0 = ext_ident_double_177;
  const SBool   s1 = ext_ident_bool_174;
  const SDouble s2 = ext_ident_double_173;
  const SDouble s3 = ext_ident_double_170;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_172;
  const SDouble s7 = ext_ident_double_171;
  ...
  const SDouble s11 = ext_ident_double_175;
  const SDouble s12 = ext_ident_double_186;
  const SDouble s13 = ext_sqrt_185;
  ...
  const SDouble s23 = ext_ident_double_179;
  const SDouble s24 = ext_ident_double_184;
  const SDouble s25 = ext_ident_double_181;
  const SDouble s26 = ext_ident_double_180;
  const SDouble s27 = ext_ident_double_183;
  const SDouble s28 = ext_ident_double_182;
