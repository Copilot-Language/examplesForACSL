...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_81) / (ext_ident_double_83))));
*/
...
{
  const SDouble s0 = ext_ident_double_81;
  const SDouble s1 = ext_ident_double_62;
  const SDouble s2 = ext_ident_double_61;
  ...
  const SDouble s11 = ext_ident_double_80;
  const SDouble s12 = ext_ident_double_70;
  const SBool   s13 = ext_ident_bool_67;
  const SDouble s14 = ext_ident_double_66;
  const SDouble s15 = ext_ident_double_63;
  const SDouble s16 = ext_ownship_position_z;
  const SDouble s17 = ext_intruder_position_z;
  const SDouble s18 = ext_ident_double_65;
  const SDouble s19 = ext_ident_double_64;
  ...
  const SDouble s25 = ext_sqrt_78;
  const SDouble s26 = ext_ident_double_71;
  const SDouble s27 = ext_ident_double_72;
  const SDouble s28 = ext_ident_double_77;
  const SDouble s29 = ext_ident_double_74;
  const SDouble s30 = ext_ident_double_73;
  const SDouble s31 = ext_ident_double_76;
  const SDouble s32 = ext_ident_double_75;
  const SDouble s33 = ext_minimal_horizontal_separation;
  const SDouble s34 = ext_ident_double_83;
  const SDouble s35 = ext_ident_double_82;
