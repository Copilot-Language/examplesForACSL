...
2 -> 3
4 [label="ext_ident_double_213",color=cyan4, style=filled]
2 -> 4
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_direction_parameter_vertical) * (ext_ident_double_213))));
*/
                                  ...
                                  const SDouble ext_intruder_position_z)
{
  ...
  const SDouble s1 = ext_ident_double_213;
