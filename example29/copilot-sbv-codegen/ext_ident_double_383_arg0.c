/* File: "ext_ident_double_383_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_373) * (ext_ident_double_382))));
*/
...
{
  const SDouble s0 = ext_ident_double_373;
  const SBool   s1 = ext_ident_bool_370;
  const SDouble s2 = ext_ident_double_369;
  const SDouble s3 = ext_ident_double_366;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_368;
  const SDouble s7 = ext_ident_double_367;
  const SDouble s8 = ext_minimal_vertical_separation;
  const SDouble s9 = ext_ident_double_372;
  ...
  const SDouble s13 = ext_sqrt_381;
  const SDouble s14 = ext_ident_double_374;
  ...
  const SDouble s23 = ext_ident_double_375;
  const SDouble s24 = ext_ident_double_380;
  const SDouble s25 = ext_ident_double_377;
  const SDouble s26 = ext_ident_double_376;
  const SDouble s27 = ext_ident_double_379;
  const SDouble s28 = ext_ident_double_378;
