...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_276) * (ext_ident_double_278))));
*/
...
{
  const SDouble s0 = ext_ident_double_276;
  const SDouble s1 = ext_ownship_position_z;
  const SDouble s2 = ext_intruder_position_z;
  const SDouble s3 = ext_ident_double_278;
  const SDouble s4 = ext_ident_double_277;
