/* File: "ext_sqrt_343_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (((((ext_ident_double_336) * (ext_ident_double_337))) - (ext_ident_double_342)));
*/
...
{
  const SDouble s0 = ext_ident_double_336;
  ...
  const SDouble s9 = ext_ident_double_337;
  const SDouble s10 = ext_ident_double_342;
  const SDouble s11 = ext_ident_double_339;
  const SDouble s12 = ext_ident_double_338;
  const SDouble s13 = ext_ident_double_341;
