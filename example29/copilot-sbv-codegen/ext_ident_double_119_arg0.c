/* File: "ext_ident_double_119_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_100) + (ext_ident_double_118))));
*/
...
{
  const SDouble s0 = ext_ident_double_100;
  const SDouble s1 = ext_ident_double_99;
  ...
  const SDouble s11 = ext_ident_double_108;
  const SBool   s12 = ext_ident_bool_105;
  const SDouble s13 = ext_ident_double_104;
  const SDouble s14 = ext_ident_double_101;
  const SDouble s15 = ext_ownship_position_z;
  const SDouble s16 = ext_intruder_position_z;
  const SDouble s17 = ext_ident_double_103;
  const SDouble s18 = ext_ident_double_102;
  const SDouble s19 = ext_minimal_vertical_separation;
  const SDouble s20 = ext_ident_double_107;
  const SDouble s21 = ext_direction_parameter_vertical;
  const SDouble s22 = ext_ident_double_106;
  const SDouble s23 = ext_ident_double_117;
  const SDouble s24 = ext_sqrt_116;
  const SDouble s25 = ext_ident_double_109;
  const SDouble s26 = ext_ident_double_110;
  const SDouble s27 = ext_ident_double_115;
  const SDouble s28 = ext_ident_double_112;
  const SDouble s29 = ext_ident_double_111;
  const SDouble s30 = ext_ident_double_114;
  const SDouble s31 = ext_ident_double_113;
