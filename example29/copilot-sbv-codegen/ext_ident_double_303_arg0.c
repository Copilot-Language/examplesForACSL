...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_293) * (ext_ident_double_302))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SBool   s1 = ext_ident_bool_290;
  const SDouble s2 = ext_ident_double_289;
  const SDouble s3 = ext_ident_double_286;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_288;
  const SDouble s7 = ext_ident_double_287;
  const SDouble s8 = ext_minimal_vertical_separation;
  const SDouble s9 = ext_ident_double_292;
  const SDouble s10 = ext_direction_parameter_vertical;
  const SDouble s11 = ext_ident_double_291;
  const SDouble s12 = ext_ident_double_302;
  const SDouble s13 = ext_sqrt_301;
  const SDouble s14 = ext_ident_double_294;
  ...
  const SDouble s23 = ext_ident_double_295;
  const SDouble s24 = ext_ident_double_300;
  const SDouble s25 = ext_ident_double_297;
  const SDouble s26 = ext_ident_double_296;
  const SDouble s27 = ext_ident_double_299;
  const SDouble s28 = ext_ident_double_298;
