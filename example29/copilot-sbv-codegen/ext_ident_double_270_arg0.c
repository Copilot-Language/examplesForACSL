/* File: "ext_ident_double_270_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((ext_ident_double_269));
*/
...
{
  const SDouble s0 = ext_ident_double_269;
  const SDouble s1 = ext_ident_double_266;
  const SDouble s2 = ext_ident_double_247;
  const SDouble s3 = ext_ident_double_246;
  ...
  const SDouble s12 = ext_ident_double_265;
  const SDouble s13 = ext_ident_double_255;
  const SBool   s14 = ext_ident_bool_252;
  const SDouble s15 = ext_ident_double_251;
  const SDouble s16 = ext_ident_double_248;
  const SDouble s17 = ext_ownship_position_z;
  const SDouble s18 = ext_intruder_position_z;
  const SDouble s19 = ext_ident_double_250;
  const SDouble s20 = ext_ident_double_249;
  const SDouble s21 = ext_minimal_vertical_separation;
  const SDouble s22 = ext_ident_double_254;
  const SDouble s23 = ext_direction_parameter_vertical;
  const SDouble s24 = ext_ident_double_253;
  const SDouble s25 = ext_ident_double_264;
  const SDouble s26 = ext_sqrt_263;
  const SDouble s27 = ext_ident_double_256;
  const SDouble s28 = ext_ident_double_257;
  const SDouble s29 = ext_ident_double_262;
  const SDouble s30 = ext_ident_double_259;
  const SDouble s31 = ext_ident_double_258;
  const SDouble s32 = ext_ident_double_261;
  const SDouble s33 = ext_ident_double_260;
  const SDouble s34 = ext_minimal_horizontal_separation;
  const SDouble s35 = ext_ident_double_268;
  const SDouble s36 = ext_ident_double_267;
