/* File: "ext_ident_double_240_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_221) + (ext_ident_double_239))));
*/
...
{
  const SDouble s0 = ext_ident_double_221;
  const SDouble s1 = ext_ident_double_220;
  ...
  const SBool   s12 = ext_ident_bool_226;
  const SDouble s13 = ext_ident_double_225;
  const SDouble s14 = ext_ident_double_222;
  const SDouble s15 = ext_ownship_position_z;
  const SDouble s16 = ext_intruder_position_z;
  const SDouble s17 = ext_ident_double_224;
  const SDouble s18 = ext_ident_double_223;
  const SDouble s19 = ext_minimal_vertical_separation;
  const SDouble s20 = ext_ident_double_228;
  const SDouble s21 = ext_direction_parameter_vertical;
  const SDouble s22 = ext_ident_double_227;
  const SDouble s23 = ext_ident_double_238;
  const SDouble s24 = ext_sqrt_237;
  const SDouble s25 = ext_ident_double_230;
  const SDouble s26 = ext_ident_double_231;
  const SDouble s27 = ext_ident_double_236;
  const SDouble s28 = ext_ident_double_233;
  const SDouble s29 = ext_ident_double_232;
