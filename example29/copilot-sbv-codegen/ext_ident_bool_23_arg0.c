/* File: "ext_ident_bool_23_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((((((ext_ownship_position_x) - (ext_intruder_position_x))) * (((ext_ownship_planned_velocity_x) - (ext_intruder_velocity_x))))) + (((((ext_ownship_position_y) - (ext_intruder_position_y))) * (((ext_ownship_planned_velocity_y) - (ext_intruder_velocity_y))))))) >= (((((ext_direction_parameter_horizontal) * (((ext_ident_double_21) / (ext_ident_double_22))))) * (((((((ext_ownship_position_x) - (ext_intruder_position_x))) * (((ext_ownship_planned_velocity_y) - (ext_intruder_velocity_y))))) - (((((ext_ownship_planned_velocity_x) - (ext_intruder_velocity_x))) * (((ext_ownship_position_y) - (ext_intruder_position_y))))))))))));
*/
                             ...
                             const SDouble ext_ident_double_22)
{
  ...
  const SDouble s9 = ext_ident_double_21;
  const SDouble s10 = ext_sqrt_20;
  const SDouble s11 = ext_ident_double_19;
  const SDouble s12 = ext_minimal_horizontal_separation;
  const SDouble s13 = ext_ident_double_22;
