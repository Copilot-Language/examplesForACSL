/* File: "ext_ident_double_345_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_335) * (ext_ident_double_344))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SBool   s1 = ext_ident_bool_332;
  const SDouble s2 = ext_ident_double_331;
  const SDouble s3 = ext_ident_double_328;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_330;
  const SDouble s7 = ext_ident_double_329;
  const SDouble s8 = ext_minimal_vertical_separation;
  const SDouble s9 = ext_ident_double_334;
  const SDouble s10 = ext_direction_parameter_vertical;
  const SDouble s11 = ext_ident_double_333;
  const SDouble s12 = ext_ident_double_344;
  const SDouble s13 = ext_sqrt_343;
  const SDouble s14 = ext_ident_double_336;
  ...
  const SDouble s23 = ext_ident_double_337;
  const SDouble s24 = ext_ident_double_342;
  const SDouble s25 = ext_ident_double_339;
  const SDouble s26 = ext_ident_double_338;
  const SDouble s27 = ext_ident_double_341;
  const SDouble s28 = ext_ident_double_340;
