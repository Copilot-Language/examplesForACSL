/* File: "ext_ident_double_13_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_11) / (ext_ident_double_12))));
*/
