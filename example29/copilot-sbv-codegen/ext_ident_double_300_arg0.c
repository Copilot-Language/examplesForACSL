...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_297) * (ext_ident_double_299))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s1 = ext_ident_double_296;
  ...
  const SDouble s6 = ext_ident_double_299;
  const SDouble s7 = ext_ident_double_298;
