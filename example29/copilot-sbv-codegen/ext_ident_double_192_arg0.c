/* File: "ext_ident_double_192_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((ext_ident_double_191));
*/
                                  ...
                                  const SDouble ext_ident_double_189)
{
  ...
  const SDouble s1 = ext_ident_double_188;
  const SDouble s2 = ext_ident_double_169;
  const SDouble s3 = ext_ident_double_168;
  ...
  const SDouble s12 = ext_ident_double_187;
  const SDouble s13 = ext_ident_double_177;
  const SBool   s14 = ext_ident_bool_174;
  const SDouble s15 = ext_ident_double_173;
  const SDouble s16 = ext_ident_double_170;
  const SDouble s17 = ext_ownship_position_z;
  const SDouble s18 = ext_intruder_position_z;
  const SDouble s19 = ext_ident_double_172;
  const SDouble s20 = ext_ident_double_171;
  const SDouble s21 = ext_minimal_vertical_separation;
  const SDouble s22 = ext_ident_double_176;
  const SDouble s23 = ext_direction_parameter_vertical;
  const SDouble s24 = ext_ident_double_175;
  const SDouble s25 = ext_ident_double_186;
  const SDouble s26 = ext_sqrt_185;
  const SDouble s27 = ext_ident_double_178;
  const SDouble s28 = ext_ident_double_179;
  const SDouble s29 = ext_ident_double_184;
  const SDouble s30 = ext_ident_double_181;
  const SDouble s31 = ext_ident_double_180;
  const SDouble s32 = ext_ident_double_183;
  const SDouble s33 = ext_ident_double_182;
  const SDouble s34 = ext_minimal_horizontal_separation;
  const SDouble s35 = ext_ident_double_190;
  const SDouble s36 = ext_ident_double_189;
