/* File: "ext_ident_double_164_arg0.c". Automatically generated by SBV. Do not edit! */
                                  ...
                                  const SDouble ext_ident_double_161)
{
  ...
  const SDouble s1 = ext_ident_double_160;
  const SDouble s2 = ext_ident_double_141;
  const SDouble s3 = ext_ident_double_140;
  ...
  const SDouble s12 = ext_ident_double_159;
  const SDouble s13 = ext_ident_double_149;
  const SBool   s14 = ext_ident_bool_146;
  const SDouble s15 = ext_ident_double_145;
  const SDouble s16 = ext_ident_double_142;
  const SDouble s17 = ext_ownship_position_z;
  const SDouble s18 = ext_intruder_position_z;
  const SDouble s19 = ext_ident_double_144;
  const SDouble s20 = ext_ident_double_143;
  const SDouble s21 = ext_minimal_vertical_separation;
  const SDouble s22 = ext_ident_double_148;
  const SDouble s23 = ext_direction_parameter_vertical;
  const SDouble s24 = ext_ident_double_147;
  const SDouble s25 = ext_ident_double_158;
  const SDouble s26 = ext_sqrt_157;
  const SDouble s27 = ext_ident_double_150;
  const SDouble s28 = ext_ident_double_151;
  const SDouble s29 = ext_ident_double_156;
  const SDouble s30 = ext_ident_double_153;
  const SDouble s31 = ext_ident_double_152;
  const SDouble s32 = ext_ident_double_155;
  const SDouble s33 = ext_ident_double_154;
  const SDouble s34 = ext_minimal_horizontal_separation;
  const SDouble s35 = ext_ident_double_162;
  const SDouble s36 = ext_ident_double_161;
