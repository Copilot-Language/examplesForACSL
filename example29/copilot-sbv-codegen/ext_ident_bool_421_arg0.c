/* File: "ext_ident_bool_421_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_bool_70) || (ext_ident_bool_420))));
*/
...
{
  const SBool   s0 = ext_ident_bool_70;
  const SBool   s1 = ext_ident_bool_67;
  const SBool   s2 = ext_ident_bool_64;
  ...
  const SBool   s8 = ext_ident_bool_66;
  const SDouble s9 = ext_ident_double_65;
  const SBool   s10 = ext_ident_bool_68;
  const SDouble s11 = ext_ownship_planned_velocity_z;
  const SDouble s12 = ext_intruder_velocity_z;
  const SBool   s13 = ext_ident_bool_69;
  const SDouble s14 = ext_direction_parameter_vertical;
  ...
  const SBool   s18 = ext_ident_bool_420;
  const SBool   s19 = ext_ident_bool_72;
  const SDouble s20 = ext_minimal_horizontal_separation;
  const SDouble s21 = ext_ident_double_71;
  const SDouble s22 = ext_ownship_velocity_x;
  const SDouble s23 = ext_intruder_velocity_x;
  const SDouble s24 = ext_ownship_velocity_y;
  const SDouble s25 = ext_intruder_velocity_y;
  const SBool   s26 = ext_ident_bool_98;
  const SDouble s27 = ext_ident_double_97;
  const SDouble s28 = ext_ident_double_96;
  const SDouble s29 = ext_ident_double_93;
  const SDouble s30 = ext_ident_double_74;
  const SDouble s31 = ext_ident_double_73;
  const SDouble s32 = ext_ident_double_92;
  const SDouble s33 = ext_ident_double_82;
  const SBool   s34 = ext_ident_bool_79;
  const SDouble s35 = ext_ident_double_78;
  const SDouble s36 = ext_ident_double_75;
  const SDouble s37 = ext_ident_double_77;
  const SDouble s38 = ext_ident_double_76;
  const SDouble s39 = ext_ident_double_81;
  const SDouble s40 = ext_ident_double_80;
  const SDouble s41 = ext_ident_double_91;
  const SDouble s42 = ext_sqrt_90;
  const SDouble s43 = ext_ident_double_83;
  const SDouble s44 = ext_ident_double_84;
  const SDouble s45 = ext_ident_double_89;
  const SDouble s46 = ext_ident_double_86;
  const SDouble s47 = ext_ident_double_85;
  const SDouble s48 = ext_ident_double_88;
  const SDouble s49 = ext_ident_double_87;
  const SDouble s50 = ext_ident_double_95;
  const SDouble s51 = ext_ident_double_94;
  const SBool   s52 = ext_ident_bool_419;
  const SBool   s53 = ext_ident_bool_418;
  const SBool   s54 = ext_ident_bool_205;
  const SBool   s55 = ext_ident_bool_151;
  const SDouble s56 = ext_ownship_planned_velocity_x;
  const SDouble s57 = ext_ident_double_124;
  const SDouble s58 = ext_ident_double_123;
  const SDouble s59 = ext_ident_double_122;
  const SDouble s60 = ext_ident_double_119;
  const SDouble s61 = ext_ident_double_100;
  const SDouble s62 = ext_ident_double_99;
  const SDouble s63 = ext_ident_double_118;
  const SDouble s64 = ext_ident_double_108;
  const SBool   s65 = ext_ident_bool_105;
  const SDouble s66 = ext_ident_double_104;
  const SDouble s67 = ext_ident_double_101;
  const SDouble s68 = ext_ident_double_103;
  const SDouble s69 = ext_ident_double_102;
  const SDouble s70 = ext_ident_double_107;
  const SDouble s71 = ext_ident_double_106;
  const SDouble s72 = ext_ident_double_117;
  const SDouble s73 = ext_sqrt_116;
  const SDouble s74 = ext_ident_double_109;
  const SDouble s75 = ext_ident_double_110;
  const SDouble s76 = ext_ident_double_115;
  const SDouble s77 = ext_ident_double_112;
  const SDouble s78 = ext_ident_double_111;
  const SDouble s79 = ext_ident_double_114;
  const SDouble s80 = ext_ident_double_113;
  const SDouble s81 = ext_ident_double_121;
  const SDouble s82 = ext_ident_double_120;
  const SDouble s83 = ext_ownship_planned_velocity_y;
  const SDouble s84 = ext_ident_double_150;
  const SDouble s85 = ext_ident_double_149;
  const SDouble s86 = ext_ident_double_148;
  const SDouble s87 = ext_ident_double_145;
  const SDouble s88 = ext_ident_double_126;
  const SDouble s89 = ext_ident_double_125;
  const SDouble s90 = ext_ident_double_144;
  const SDouble s91 = ext_ident_double_134;
  const SBool   s92 = ext_ident_bool_131;
  const SDouble s93 = ext_ident_double_130;
  const SDouble s94 = ext_ident_double_127;
  const SDouble s95 = ext_ident_double_129;
  const SDouble s96 = ext_ident_double_128;
  const SDouble s97 = ext_ident_double_133;
  const SDouble s98 = ext_ident_double_132;
  const SDouble s99 = ext_ident_double_143;
  const SDouble s100 = ext_sqrt_142;
  const SDouble s101 = ext_ident_double_135;
  const SDouble s102 = ext_ident_double_136;
  const SDouble s103 = ext_ident_double_141;
  const SDouble s104 = ext_ident_double_138;
  const SDouble s105 = ext_ident_double_137;
  const SDouble s106 = ext_ident_double_140;
  const SDouble s107 = ext_ident_double_139;
  const SDouble s108 = ext_ident_double_147;
  const SDouble s109 = ext_ident_double_146;
  const SBool   s110 = ext_ident_bool_204;
  const SDouble s111 = ext_ident_double_177;
  const SDouble s112 = ext_ident_double_176;
  const SDouble s113 = ext_ident_double_175;
  const SDouble s114 = ext_ident_double_172;
  const SDouble s115 = ext_ident_double_153;
  const SDouble s116 = ext_ident_double_152;
  const SDouble s117 = ext_ident_double_171;
  const SDouble s118 = ext_ident_double_161;
  const SBool   s119 = ext_ident_bool_158;
  const SDouble s120 = ext_ident_double_157;
  const SDouble s121 = ext_ident_double_154;
  const SDouble s122 = ext_ident_double_156;
  const SDouble s123 = ext_ident_double_155;
  const SDouble s124 = ext_ident_double_160;
  const SDouble s125 = ext_ident_double_159;
  const SDouble s126 = ext_ident_double_170;
  const SDouble s127 = ext_sqrt_169;
  const SDouble s128 = ext_ident_double_162;
  const SDouble s129 = ext_ident_double_163;
  const SDouble s130 = ext_ident_double_168;
  const SDouble s131 = ext_ident_double_165;
  const SDouble s132 = ext_ident_double_164;
  const SDouble s133 = ext_ident_double_167;
  const SDouble s134 = ext_ident_double_166;
  const SDouble s135 = ext_ident_double_174;
  const SDouble s136 = ext_ident_double_173;
  const SDouble s137 = ext_ident_double_203;
  const SDouble s138 = ext_ident_double_202;
  const SDouble s139 = ext_ident_double_201;
  const SDouble s140 = ext_ident_double_198;
  const SDouble s141 = ext_ident_double_179;
  const SDouble s142 = ext_ident_double_178;
  const SDouble s143 = ext_ident_double_197;
  const SDouble s144 = ext_ident_double_187;
  const SBool   s145 = ext_ident_bool_184;
  const SDouble s146 = ext_ident_double_183;
  const SDouble s147 = ext_ident_double_180;
  const SDouble s148 = ext_ident_double_182;
  const SDouble s149 = ext_ident_double_181;
  const SDouble s150 = ext_ident_double_186;
  const SDouble s151 = ext_ident_double_185;
  const SDouble s152 = ext_ident_double_196;
  const SDouble s153 = ext_sqrt_195;
  const SDouble s154 = ext_ident_double_188;
  const SDouble s155 = ext_ident_double_189;
  const SDouble s156 = ext_ident_double_194;
  const SDouble s157 = ext_ident_double_191;
  const SDouble s158 = ext_ident_double_190;
  const SDouble s159 = ext_ident_double_193;
  const SDouble s160 = ext_ident_double_192;
  const SDouble s161 = ext_ident_double_200;
  const SDouble s162 = ext_ident_double_199;
  const SBool   s163 = ext_ident_bool_311;
  const SDouble s164 = ext_ident_double_310;
  const SDouble s165 = ext_ident_double_231;
  const SDouble s166 = ext_ident_double_230;
  const SDouble s167 = ext_ident_double_229;
  const SDouble s168 = ext_ident_double_226;
  const SDouble s169 = ext_ident_double_207;
  const SDouble s170 = ext_ident_double_206;
  const SDouble s171 = ext_ident_double_225;
  const SDouble s172 = ext_ident_double_215;
  const SBool   s173 = ext_ident_bool_212;
  const SDouble s174 = ext_ident_double_211;
  const SDouble s175 = ext_ident_double_208;
  const SDouble s176 = ext_ident_double_210;
  const SDouble s177 = ext_ident_double_209;
  const SDouble s178 = ext_ident_double_214;
  const SDouble s179 = ext_ident_double_213;
  const SDouble s180 = ext_ident_double_224;
  const SDouble s181 = ext_sqrt_223;
  const SDouble s182 = ext_ident_double_216;
  const SDouble s183 = ext_ident_double_217;
  const SDouble s184 = ext_ident_double_222;
  const SDouble s185 = ext_ident_double_219;
  const SDouble s186 = ext_ident_double_218;
  const SDouble s187 = ext_ident_double_221;
  const SDouble s188 = ext_ident_double_220;
  const SDouble s189 = ext_ident_double_228;
  const SDouble s190 = ext_ident_double_227;
  const SDouble s191 = ext_ident_double_257;
  const SDouble s192 = ext_ident_double_256;
  const SDouble s193 = ext_ident_double_255;
  const SDouble s194 = ext_ident_double_252;
  const SDouble s195 = ext_ident_double_233;
  const SDouble s196 = ext_ident_double_232;
  const SDouble s197 = ext_ident_double_251;
  const SDouble s198 = ext_ident_double_241;
  const SBool   s199 = ext_ident_bool_238;
  const SDouble s200 = ext_ident_double_237;
  const SDouble s201 = ext_ident_double_234;
  const SDouble s202 = ext_ident_double_236;
  const SDouble s203 = ext_ident_double_235;
  const SDouble s204 = ext_ident_double_240;
  const SDouble s205 = ext_ident_double_239;
  const SDouble s206 = ext_ident_double_250;
  const SDouble s207 = ext_sqrt_249;
  const SDouble s208 = ext_ident_double_242;
  const SDouble s209 = ext_ident_double_243;
  const SDouble s210 = ext_ident_double_248;
  const SDouble s211 = ext_ident_double_245;
  const SDouble s212 = ext_ident_double_244;
  const SDouble s213 = ext_ident_double_247;
  const SDouble s214 = ext_ident_double_246;
  const SDouble s215 = ext_ident_double_254;
  const SDouble s216 = ext_ident_double_253;
  const SDouble s217 = ext_ident_double_283;
  const SDouble s218 = ext_ident_double_282;
  const SDouble s219 = ext_ident_double_281;
  const SDouble s220 = ext_ident_double_278;
  const SDouble s221 = ext_ident_double_259;
  const SDouble s222 = ext_ident_double_258;
  const SDouble s223 = ext_ident_double_277;
  const SDouble s224 = ext_ident_double_267;
  const SBool   s225 = ext_ident_bool_264;
  const SDouble s226 = ext_ident_double_263;
  const SDouble s227 = ext_ident_double_260;
  const SDouble s228 = ext_ident_double_262;
  const SDouble s229 = ext_ident_double_261;
  const SDouble s230 = ext_ident_double_266;
  const SDouble s231 = ext_ident_double_265;
  const SDouble s232 = ext_ident_double_276;
  const SDouble s233 = ext_sqrt_275;
  const SDouble s234 = ext_ident_double_268;
  const SDouble s235 = ext_ident_double_269;
  const SDouble s236 = ext_ident_double_274;
  const SDouble s237 = ext_ident_double_271;
  const SDouble s238 = ext_ident_double_270;
  const SDouble s239 = ext_ident_double_273;
  const SDouble s240 = ext_ident_double_272;
  const SDouble s241 = ext_ident_double_280;
  const SDouble s242 = ext_ident_double_279;
  const SDouble s243 = ext_ident_double_309;
  const SDouble s244 = ext_ident_double_308;
  const SDouble s245 = ext_ident_double_307;
  const SDouble s246 = ext_ident_double_304;
  const SDouble s247 = ext_ident_double_285;
  const SDouble s248 = ext_ident_double_284;
  const SDouble s249 = ext_ident_double_303;
  const SDouble s250 = ext_ident_double_293;
  const SBool   s251 = ext_ident_bool_290;
  const SDouble s252 = ext_ident_double_289;
  const SDouble s253 = ext_ident_double_286;
  const SDouble s254 = ext_ident_double_288;
  const SDouble s255 = ext_ident_double_287;
  const SDouble s256 = ext_ident_double_292;
  const SDouble s257 = ext_ident_double_291;
  const SDouble s258 = ext_ident_double_302;
  const SDouble s259 = ext_sqrt_301;
  const SDouble s260 = ext_ident_double_294;
  const SDouble s261 = ext_ident_double_295;
  const SDouble s262 = ext_ident_double_300;
  const SDouble s263 = ext_ident_double_297;
  const SDouble s264 = ext_ident_double_296;
  const SDouble s265 = ext_ident_double_299;
  const SDouble s266 = ext_ident_double_298;
  const SDouble s267 = ext_ident_double_306;
  const SDouble s268 = ext_ident_double_305;
  const SBool   s269 = ext_ident_bool_417;
  const SDouble s270 = ext_ident_double_416;
  const SDouble s271 = ext_ident_double_337;
  const SDouble s272 = ext_ident_double_336;
  const SDouble s273 = ext_ident_double_335;
  const SDouble s274 = ext_ident_double_332;
  const SDouble s275 = ext_ident_double_313;
  const SDouble s276 = ext_ident_double_312;
  const SDouble s277 = ext_ident_double_331;
  const SDouble s278 = ext_ident_double_321;
  const SBool   s279 = ext_ident_bool_318;
  const SDouble s280 = ext_ident_double_317;
  const SDouble s281 = ext_ident_double_314;
  const SDouble s282 = ext_ident_double_316;
  const SDouble s283 = ext_ident_double_315;
  const SDouble s284 = ext_ident_double_320;
  const SDouble s285 = ext_ident_double_319;
  const SDouble s286 = ext_ident_double_330;
  const SDouble s287 = ext_sqrt_329;
  const SDouble s288 = ext_ident_double_322;
  const SDouble s289 = ext_ident_double_323;
  const SDouble s290 = ext_ident_double_328;
  const SDouble s291 = ext_ident_double_325;
  const SDouble s292 = ext_ident_double_324;
  const SDouble s293 = ext_ident_double_327;
  const SDouble s294 = ext_ident_double_326;
  const SDouble s295 = ext_ident_double_334;
  const SDouble s296 = ext_ident_double_333;
  const SDouble s297 = ext_ident_double_363;
  const SDouble s298 = ext_ident_double_362;
  const SDouble s299 = ext_ident_double_361;
  const SDouble s300 = ext_ident_double_358;
  const SDouble s301 = ext_ident_double_339;
  const SDouble s302 = ext_ident_double_338;
  const SDouble s303 = ext_ident_double_357;
  const SDouble s304 = ext_ident_double_347;
  const SBool   s305 = ext_ident_bool_344;
  const SDouble s306 = ext_ident_double_343;
  const SDouble s307 = ext_ident_double_340;
  const SDouble s308 = ext_ident_double_342;
  const SDouble s309 = ext_ident_double_341;
  const SDouble s310 = ext_ident_double_346;
  const SDouble s311 = ext_ident_double_345;
  const SDouble s312 = ext_ident_double_356;
  const SDouble s313 = ext_sqrt_355;
  const SDouble s314 = ext_ident_double_348;
  const SDouble s315 = ext_ident_double_349;
  const SDouble s316 = ext_ident_double_354;
  const SDouble s317 = ext_ident_double_351;
  const SDouble s318 = ext_ident_double_350;
  const SDouble s319 = ext_ident_double_353;
  const SDouble s320 = ext_ident_double_352;
  const SDouble s321 = ext_ident_double_360;
  const SDouble s322 = ext_ident_double_359;
  const SDouble s323 = ext_ident_double_389;
  const SDouble s324 = ext_ident_double_388;
  const SDouble s325 = ext_ident_double_387;
  const SDouble s326 = ext_ident_double_384;
  const SDouble s327 = ext_ident_double_365;
  const SDouble s328 = ext_ident_double_364;
  const SDouble s329 = ext_ident_double_383;
  const SDouble s330 = ext_ident_double_373;
  const SBool   s331 = ext_ident_bool_370;
  const SDouble s332 = ext_ident_double_369;
  const SDouble s333 = ext_ident_double_366;
  const SDouble s334 = ext_ident_double_368;
  const SDouble s335 = ext_ident_double_367;
  const SDouble s336 = ext_ident_double_372;
  const SDouble s337 = ext_ident_double_371;
  const SDouble s338 = ext_ident_double_382;
  const SDouble s339 = ext_sqrt_381;
  const SDouble s340 = ext_ident_double_374;
  const SDouble s341 = ext_ident_double_375;
  const SDouble s342 = ext_ident_double_380;
  const SDouble s343 = ext_ident_double_377;
  const SDouble s344 = ext_ident_double_376;
  const SDouble s345 = ext_ident_double_379;
  const SDouble s346 = ext_ident_double_378;
  const SDouble s347 = ext_ident_double_386;
  const SDouble s348 = ext_ident_double_385;
  const SDouble s349 = ext_ident_double_415;
  const SDouble s350 = ext_ident_double_414;
  const SDouble s351 = ext_ident_double_413;
  const SDouble s352 = ext_ident_double_410;
  const SDouble s353 = ext_ident_double_391;
  const SDouble s354 = ext_ident_double_390;
  const SDouble s355 = ext_ident_double_409;
  const SDouble s356 = ext_ident_double_399;
  const SBool   s357 = ext_ident_bool_396;
  const SDouble s358 = ext_ident_double_395;
  const SDouble s359 = ext_ident_double_392;
  const SDouble s360 = ext_ident_double_394;
  const SDouble s361 = ext_ident_double_393;
  const SDouble s362 = ext_ident_double_398;
  const SDouble s363 = ext_ident_double_397;
  const SDouble s364 = ext_ident_double_408;
  const SDouble s365 = ext_sqrt_407;
  const SDouble s366 = ext_ident_double_400;
  const SDouble s367 = ext_ident_double_401;
  const SDouble s368 = ext_ident_double_406;
  const SDouble s369 = ext_ident_double_403;
  const SDouble s370 = ext_ident_double_402;
  const SDouble s371 = ext_ident_double_405;
  const SDouble s372 = ext_ident_double_404;
  const SDouble s373 = ext_ident_double_412;
  const SDouble s374 = ext_ident_double_411;
  const SBool   s375 = s0 || s18;
  const SBool   s376 = s375 /* criterion3D_part3 */;
