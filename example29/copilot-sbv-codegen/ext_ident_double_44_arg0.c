/* File: "ext_ident_double_44_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_41) ? (ext_ident_double_43) : (-1.0))));
*/
...
{
  const SBool   s0 = ext_ident_bool_41;
  const SDouble s1 = ext_ident_double_40;
  const SDouble s2 = ext_ident_double_37;
  const SDouble s3 = ext_ownship_position_z;
  const SDouble s4 = ext_intruder_position_z;
  const SDouble s5 = ext_ident_double_39;
  const SDouble s6 = ext_ident_double_38;
  const SDouble s7 = ext_minimal_vertical_separation;
  const SDouble s8 = ext_ident_double_43;
  const SDouble s9 = ext_direction_parameter_vertical;
  const SDouble s10 = ext_ident_double_42;
