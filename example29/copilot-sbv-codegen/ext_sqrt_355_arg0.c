                          ...
                          const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s11 = ext_ident_double_351;
  const SDouble s12 = ext_ident_double_350;
  const SDouble s13 = ext_ident_double_353;
  const SDouble s14 = ext_ident_double_352;
