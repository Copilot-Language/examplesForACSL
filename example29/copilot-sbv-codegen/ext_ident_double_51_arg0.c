/* File: "ext_ident_double_51_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_48) * (ext_ident_double_50))));
*/
...
{
  const SDouble s0 = ext_ident_double_48;
  ...
  const SDouble s7 = ext_ident_double_49;
