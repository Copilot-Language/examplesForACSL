/* File: "ext_ident_double_265_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_255) * (ext_ident_double_264))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SBool   s1 = ext_ident_bool_252;
  const SDouble s2 = ext_ident_double_251;
  const SDouble s3 = ext_ident_double_248;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_250;
  const SDouble s7 = ext_ident_double_249;
  const SDouble s8 = ext_minimal_vertical_separation;
  const SDouble s9 = ext_ident_double_254;
  const SDouble s10 = ext_direction_parameter_vertical;
  const SDouble s11 = ext_ident_double_253;
  const SDouble s12 = ext_ident_double_264;
  const SDouble s13 = ext_sqrt_263;
  const SDouble s14 = ext_ident_double_256;
  ...
  const SDouble s24 = ext_ident_double_262;
  const SDouble s25 = ext_ident_double_259;
  const SDouble s26 = ext_ident_double_258;
  const SDouble s27 = ext_ident_double_261;
  const SDouble s28 = ext_ident_double_260;
