                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s1 = ext_ident_double_152;
  ...
  const SDouble s11 = ext_ident_double_161;
  const SBool   s12 = ext_ident_bool_158;
  const SDouble s13 = ext_ident_double_157;
  const SDouble s14 = ext_ident_double_154;
  const SDouble s15 = ext_ownship_position_z;
  const SDouble s16 = ext_intruder_position_z;
  const SDouble s17 = ext_ident_double_156;
  const SDouble s18 = ext_ident_double_155;
  const SDouble s19 = ext_minimal_vertical_separation;
  const SDouble s20 = ext_ident_double_160;
  const SDouble s21 = ext_direction_parameter_vertical;
  const SDouble s22 = ext_ident_double_159;
  const SDouble s23 = ext_ident_double_170;
  const SDouble s24 = ext_sqrt_169;
  const SDouble s25 = ext_ident_double_162;
  const SDouble s26 = ext_ident_double_163;
  const SDouble s27 = ext_ident_double_168;
  const SDouble s28 = ext_ident_double_165;
  const SDouble s29 = ext_ident_double_164;
  const SDouble s30 = ext_ident_double_167;
  const SDouble s31 = ext_ident_double_166;
