                             ...
                             const SDouble ext_ident_double_94)
{
  ...
  const SDouble s1 = ext_ident_double_96;
  const SDouble s2 = ext_ident_double_93;
  const SDouble s3 = ext_ident_double_74;
  const SDouble s4 = ext_ident_double_73;
  ...
  const SDouble s14 = ext_ident_double_82;
  const SBool   s15 = ext_ident_bool_79;
  const SDouble s16 = ext_ident_double_78;
  const SDouble s17 = ext_ident_double_75;
  const SDouble s18 = ext_ownship_position_z;
  const SDouble s19 = ext_intruder_position_z;
  const SDouble s20 = ext_ident_double_77;
  const SDouble s21 = ext_ident_double_76;
  ...
  const SDouble s25 = ext_ident_double_80;
  const SDouble s26 = ext_ident_double_91;
  const SDouble s27 = ext_sqrt_90;
  const SDouble s28 = ext_ident_double_83;
  const SDouble s29 = ext_ident_double_84;
  const SDouble s30 = ext_ident_double_89;
  const SDouble s31 = ext_ident_double_86;
  const SDouble s32 = ext_ident_double_85;
  const SDouble s33 = ext_ident_double_88;
  const SDouble s34 = ext_ident_double_87;
  const SDouble s35 = ext_minimal_horizontal_separation;
  const SDouble s36 = ext_ident_double_95;
  const SDouble s37 = ext_ident_double_94;
