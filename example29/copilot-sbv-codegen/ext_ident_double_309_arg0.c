...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_306) ? (ext_ident_double_308) : (-1.0))));
*/
...
{
  const SBool   s0 = ext_ident_bool_306;
  const SDouble s1 = ext_ident_double_305;
  const SDouble s2 = ext_ident_double_302;
  const SDouble s3 = ext_ownship_position_z;
  const SDouble s4 = ext_intruder_position_z;
  const SDouble s5 = ext_ident_double_304;
  const SDouble s6 = ext_ident_double_303;
  const SDouble s7 = ext_minimal_vertical_separation;
  const SDouble s8 = ext_ident_double_308;
  const SDouble s9 = ext_direction_parameter_vertical;
  const SDouble s10 = ext_ident_double_307;
