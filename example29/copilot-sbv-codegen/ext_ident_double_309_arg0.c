                                  ...
                                  const SDouble ext_ident_double_305)
{
  ...
  const SDouble s3 = ext_ident_double_307;
  const SDouble s4 = ext_ident_double_304;
  const SDouble s5 = ext_ident_double_285;
  const SDouble s6 = ext_ident_double_284;
  ...
  const SDouble s13 = ext_ident_double_303;
  const SDouble s14 = ext_ident_double_293;
  const SBool   s15 = ext_ident_bool_290;
  const SDouble s16 = ext_ident_double_289;
  const SDouble s17 = ext_ident_double_286;
  const SDouble s18 = ext_ownship_position_z;
  const SDouble s19 = ext_intruder_position_z;
  const SDouble s20 = ext_ident_double_288;
  const SDouble s21 = ext_ident_double_287;
  ...
  const SDouble s25 = ext_ident_double_291;
  const SDouble s26 = ext_ident_double_302;
  const SDouble s27 = ext_sqrt_301;
  const SDouble s28 = ext_ident_double_294;
  const SDouble s29 = ext_ident_double_295;
  const SDouble s30 = ext_ident_double_300;
  const SDouble s31 = ext_ident_double_297;
  const SDouble s32 = ext_ident_double_296;
  const SDouble s33 = ext_ident_double_299;
  const SDouble s34 = ext_ident_double_298;
  const SDouble s35 = ext_minimal_horizontal_separation;
  const SDouble s36 = ext_ident_double_306;
  const SDouble s37 = ext_ident_double_305;
