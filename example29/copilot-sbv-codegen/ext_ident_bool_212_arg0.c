/* File: "ext_ident_bool_212_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_211) >= (ext_minimal_vertical_separation))));
*/
                              ...
                              const SDouble ext_minimal_vertical_separation)
{
  ...
  const SDouble s1 = ext_ident_double_208;
  const SDouble s2 = ext_ownship_position_z;
  const SDouble s3 = ext_intruder_position_z;
  const SDouble s4 = ext_ident_double_210;
  const SDouble s5 = ext_ident_double_209;
