                              ...
                              const SDouble ext_ident_double_146)
{
  ...
  const SDouble s5 = ext_ident_double_123;
  const SDouble s6 = ext_ident_double_122;
  const SDouble s7 = ext_ident_double_119;
  const SDouble s8 = ext_ident_double_100;
  const SDouble s9 = ext_ident_double_99;
  ...
  const SDouble s15 = ext_ident_double_118;
  const SDouble s16 = ext_ident_double_108;
  const SBool   s17 = ext_ident_bool_105;
  const SDouble s18 = ext_ident_double_104;
  const SDouble s19 = ext_ident_double_101;
  const SDouble s20 = ext_ownship_position_z;
  const SDouble s21 = ext_intruder_position_z;
  const SDouble s22 = ext_ident_double_103;
  const SDouble s23 = ext_ident_double_102;
  const SDouble s24 = ext_minimal_vertical_separation;
  const SDouble s25 = ext_ident_double_107;
  const SDouble s26 = ext_direction_parameter_vertical;
  const SDouble s27 = ext_ident_double_106;
  const SDouble s28 = ext_ident_double_117;
  const SDouble s29 = ext_sqrt_116;
  const SDouble s30 = ext_ident_double_109;
  const SDouble s31 = ext_ident_double_110;
  const SDouble s32 = ext_ident_double_115;
  const SDouble s33 = ext_ident_double_112;
  const SDouble s34 = ext_ident_double_111;
  const SDouble s35 = ext_ident_double_114;
  const SDouble s36 = ext_ident_double_113;
  const SDouble s37 = ext_minimal_horizontal_separation;
  const SDouble s38 = ext_ident_double_121;
  const SDouble s39 = ext_ident_double_120;
  const SDouble s40 = ext_ownship_planned_velocity_y;
  const SDouble s41 = ext_ident_double_150;
  const SDouble s42 = ext_ident_double_149;
  const SDouble s43 = ext_ident_double_148;
  const SDouble s44 = ext_ident_double_145;
  const SDouble s45 = ext_ident_double_126;
  const SDouble s46 = ext_ident_double_125;
  const SDouble s47 = ext_ident_double_144;
  const SDouble s48 = ext_ident_double_134;
  const SBool   s49 = ext_ident_bool_131;
  const SDouble s50 = ext_ident_double_130;
  const SDouble s51 = ext_ident_double_127;
  const SDouble s52 = ext_ident_double_129;
  const SDouble s53 = ext_ident_double_128;
  const SDouble s54 = ext_ident_double_133;
  const SDouble s55 = ext_ident_double_132;
  const SDouble s56 = ext_ident_double_143;
  const SDouble s57 = ext_sqrt_142;
  const SDouble s58 = ext_ident_double_135;
  const SDouble s59 = ext_ident_double_136;
  const SDouble s60 = ext_ident_double_141;
  const SDouble s61 = ext_ident_double_138;
  const SDouble s62 = ext_ident_double_137;
  const SDouble s63 = ext_ident_double_140;
  const SDouble s64 = ext_ident_double_139;
  const SDouble s65 = ext_ident_double_147;
  const SDouble s66 = ext_ident_double_146;
