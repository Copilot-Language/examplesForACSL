...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_226) ? (ext_ident_double_228) : (-1.0))));
*/
...
{
  const SBool   s0 = ext_ident_bool_226;
  const SDouble s1 = ext_ident_double_225;
  const SDouble s2 = ext_ident_double_222;
  const SDouble s3 = ext_ownship_position_z;
  const SDouble s4 = ext_intruder_position_z;
  const SDouble s5 = ext_ident_double_224;
  const SDouble s6 = ext_ident_double_223;
  const SDouble s7 = ext_minimal_vertical_separation;
  const SDouble s8 = ext_ident_double_228;
  const SDouble s9 = ext_direction_parameter_vertical;
  const SDouble s10 = ext_ident_double_227;
