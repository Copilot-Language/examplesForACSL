...
/*@
 assigns \nothing;
 ensures \result == (((((ext_ident_double_284) * (ext_ident_double_285))) - (ext_ident_double_290)));
*/
                          ...
                          const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s9 = ext_ident_double_285;
  const SDouble s10 = ext_ident_double_290;
  const SDouble s11 = ext_ident_double_287;
  const SDouble s12 = ext_ident_double_286;
  const SDouble s13 = ext_ident_double_289;
  const SDouble s14 = ext_ident_double_288;
