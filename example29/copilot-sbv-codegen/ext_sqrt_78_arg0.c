/* File: "ext_sqrt_78_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (((((ext_ident_double_71) * (ext_ident_double_72))) - (ext_ident_double_77)));
*/
                         ...
                         const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s9 = ext_ident_double_72;
  const SDouble s10 = ext_ident_double_77;
  const SDouble s11 = ext_ident_double_74;
  const SDouble s12 = ext_ident_double_73;
  const SDouble s13 = ext_ident_double_76;
