/* File: "ext_ident_double_112_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((((ext_ownship_position_y) - (ext_intruder_position_y))) + (((ext_ident_double_111) * (((ext_ownship_velocity_y) - (ext_intruder_velocity_y))))))));
*/
                                  ...
                                  const SDouble ext_ident_double_108)
{
  ...
  const SDouble s4 = ext_ident_double_107;
  const SDouble s5 = ext_ident_double_88;
  const SDouble s6 = ext_ident_double_87;
  ...
  const SDouble s13 = ext_ident_double_106;
  const SDouble s14 = ext_ident_double_96;
  const SBool   s15 = ext_ident_bool_93;
  const SDouble s16 = ext_ident_double_92;
  const SDouble s17 = ext_ident_double_89;
  const SDouble s18 = ext_ownship_position_z;
  const SDouble s19 = ext_intruder_position_z;
  const SDouble s20 = ext_ident_double_91;
  const SDouble s21 = ext_ident_double_90;
  const SDouble s22 = ext_minimal_vertical_separation;
  const SDouble s23 = ext_ident_double_95;
  const SDouble s24 = ext_direction_parameter_vertical;
  const SDouble s25 = ext_ident_double_94;
  const SDouble s26 = ext_ident_double_105;
  const SDouble s27 = ext_sqrt_104;
  const SDouble s28 = ext_ident_double_97;
  const SDouble s29 = ext_ident_double_98;
  const SDouble s30 = ext_ident_double_103;
  const SDouble s31 = ext_ident_double_100;
  const SDouble s32 = ext_ident_double_99;
  const SDouble s33 = ext_ident_double_102;
  const SDouble s34 = ext_ident_double_101;
  const SDouble s35 = ext_minimal_horizontal_separation;
  const SDouble s36 = ext_ident_double_109;
  const SDouble s37 = ext_ident_double_108;
