...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_358) ? (ext_ident_double_360) : (-1.0))));
*/
...
{
  const SBool   s0 = ext_ident_bool_358;
  const SDouble s1 = ext_ident_double_357;
  const SDouble s2 = ext_ident_double_354;
  const SDouble s3 = ext_ownship_position_z;
  const SDouble s4 = ext_intruder_position_z;
  const SDouble s5 = ext_ident_double_356;
  const SDouble s6 = ext_ident_double_355;
  const SDouble s7 = ext_minimal_vertical_separation;
  const SDouble s8 = ext_ident_double_360;
  const SDouble s9 = ext_direction_parameter_vertical;
  const SDouble s10 = ext_ident_double_359;
