...
/*@
 assigns \nothing;
 ensures \result == ((((((((ext_minimal_horizontal_separation) * (ext_minimal_horizontal_separation))) - (((((((ext_ownship_position_x) - (ext_intruder_position_x))) * (ext_ident_double_299))) + (((((ext_ownship_position_y) - (ext_intruder_position_y))) * (ext_ident_double_325))))))) / (((((((ext_ownship_planned_velocity_x) - (ext_intruder_velocity_x))) * (ext_ident_double_351))) + (((((ext_ownship_planned_velocity_y) - (ext_intruder_velocity_y))) * (ext_ident_double_377))))))));
*/
                                  ...
                                  const SDouble ext_ident_double_373)
{
  ...
  const SDouble s3 = ext_ident_double_299;
  const SDouble s4 = ext_ident_double_298;
  const SDouble s5 = ext_ident_double_297;
  const SDouble s6 = ext_ident_double_294;
  const SDouble s7 = ext_ident_double_275;
  const SDouble s8 = ext_ident_double_274;
  ...
  const SDouble s15 = ext_ident_double_293;
  const SDouble s16 = ext_ident_double_283;
  const SBool   s17 = ext_ident_bool_280;
  const SDouble s18 = ext_ident_double_279;
  const SDouble s19 = ext_ident_double_276;
  const SDouble s20 = ext_ownship_position_z;
  const SDouble s21 = ext_intruder_position_z;
  const SDouble s22 = ext_ident_double_278;
  const SDouble s23 = ext_ident_double_277;
  const SDouble s24 = ext_minimal_vertical_separation;
  const SDouble s25 = ext_ident_double_282;
  const SDouble s26 = ext_direction_parameter_vertical;
  const SDouble s27 = ext_ident_double_281;
  const SDouble s28 = ext_ident_double_292;
  const SDouble s29 = ext_sqrt_291;
  const SDouble s30 = ext_ident_double_284;
  const SDouble s31 = ext_ident_double_285;
  const SDouble s32 = ext_ident_double_290;
  const SDouble s33 = ext_ident_double_287;
  const SDouble s34 = ext_ident_double_286;
  const SDouble s35 = ext_ident_double_289;
  const SDouble s36 = ext_ident_double_288;
  const SDouble s37 = ext_ident_double_296;
  const SDouble s38 = ext_ident_double_295;
  const SDouble s39 = ext_ident_double_325;
  const SDouble s40 = ext_ident_double_324;
  const SDouble s41 = ext_ident_double_323;
  const SDouble s42 = ext_ident_double_320;
  const SDouble s43 = ext_ident_double_301;
  const SDouble s44 = ext_ident_double_300;
  const SDouble s45 = ext_ident_double_319;
  const SDouble s46 = ext_ident_double_309;
  const SBool   s47 = ext_ident_bool_306;
  const SDouble s48 = ext_ident_double_305;
  const SDouble s49 = ext_ident_double_302;
  const SDouble s50 = ext_ident_double_304;
  const SDouble s51 = ext_ident_double_303;
  const SDouble s52 = ext_ident_double_308;
  const SDouble s53 = ext_ident_double_307;
  const SDouble s54 = ext_ident_double_318;
  const SDouble s55 = ext_sqrt_317;
  const SDouble s56 = ext_ident_double_310;
  const SDouble s57 = ext_ident_double_311;
  const SDouble s58 = ext_ident_double_316;
  const SDouble s59 = ext_ident_double_313;
  const SDouble s60 = ext_ident_double_312;
  const SDouble s61 = ext_ident_double_315;
  const SDouble s62 = ext_ident_double_314;
  const SDouble s63 = ext_ident_double_322;
  const SDouble s64 = ext_ident_double_321;
  const SDouble s65 = ext_ownship_planned_velocity_x;
  const SDouble s66 = ext_ident_double_351;
  const SDouble s67 = ext_ident_double_350;
  const SDouble s68 = ext_ident_double_349;
  const SDouble s69 = ext_ident_double_346;
  const SDouble s70 = ext_ident_double_327;
  const SDouble s71 = ext_ident_double_326;
  const SDouble s72 = ext_ident_double_345;
  const SDouble s73 = ext_ident_double_335;
  const SBool   s74 = ext_ident_bool_332;
  const SDouble s75 = ext_ident_double_331;
  const SDouble s76 = ext_ident_double_328;
  const SDouble s77 = ext_ident_double_330;
  const SDouble s78 = ext_ident_double_329;
  const SDouble s79 = ext_ident_double_334;
  const SDouble s80 = ext_ident_double_333;
  const SDouble s81 = ext_ident_double_344;
  const SDouble s82 = ext_sqrt_343;
  const SDouble s83 = ext_ident_double_336;
  const SDouble s84 = ext_ident_double_337;
  const SDouble s85 = ext_ident_double_342;
  const SDouble s86 = ext_ident_double_339;
  const SDouble s87 = ext_ident_double_338;
  const SDouble s88 = ext_ident_double_341;
  const SDouble s89 = ext_ident_double_340;
  const SDouble s90 = ext_ident_double_348;
  const SDouble s91 = ext_ident_double_347;
  const SDouble s92 = ext_ownship_planned_velocity_y;
  const SDouble s93 = ext_ident_double_377;
  const SDouble s94 = ext_ident_double_376;
  const SDouble s95 = ext_ident_double_375;
  const SDouble s96 = ext_ident_double_372;
  const SDouble s97 = ext_ident_double_353;
  const SDouble s98 = ext_ident_double_352;
  const SDouble s99 = ext_ident_double_371;
  const SDouble s100 = ext_ident_double_361;
  const SBool   s101 = ext_ident_bool_358;
  const SDouble s102 = ext_ident_double_357;
  const SDouble s103 = ext_ident_double_354;
  const SDouble s104 = ext_ident_double_356;
  const SDouble s105 = ext_ident_double_355;
  const SDouble s106 = ext_ident_double_360;
  const SDouble s107 = ext_ident_double_359;
  const SDouble s108 = ext_ident_double_370;
  const SDouble s109 = ext_sqrt_369;
  const SDouble s110 = ext_ident_double_362;
  const SDouble s111 = ext_ident_double_363;
  const SDouble s112 = ext_ident_double_368;
  const SDouble s113 = ext_ident_double_365;
  const SDouble s114 = ext_ident_double_364;
  const SDouble s115 = ext_ident_double_367;
  const SDouble s116 = ext_ident_double_366;
  const SDouble s117 = ext_ident_double_374;
  const SDouble s118 = ext_ident_double_373;
