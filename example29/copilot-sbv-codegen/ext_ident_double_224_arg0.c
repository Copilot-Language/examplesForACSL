                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s1 = ext_ident_double_216;
  ...
  const SDouble s12 = ext_ident_double_219;
  const SDouble s13 = ext_ident_double_218;
  const SDouble s14 = ext_ident_double_221;
  const SDouble s15 = ext_ident_double_220;
