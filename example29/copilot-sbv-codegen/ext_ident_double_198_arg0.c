                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s1 = ext_ident_double_178;
  ...
  const SBool   s12 = ext_ident_bool_184;
  const SDouble s13 = ext_ident_double_183;
  const SDouble s14 = ext_ident_double_180;
  const SDouble s15 = ext_ownship_position_z;
  const SDouble s16 = ext_intruder_position_z;
  const SDouble s17 = ext_ident_double_182;
  const SDouble s18 = ext_ident_double_181;
  const SDouble s19 = ext_minimal_vertical_separation;
  const SDouble s20 = ext_ident_double_186;
  const SDouble s21 = ext_direction_parameter_vertical;
  const SDouble s22 = ext_ident_double_185;
  const SDouble s23 = ext_ident_double_196;
  const SDouble s24 = ext_sqrt_195;
  const SDouble s25 = ext_ident_double_188;
  const SDouble s26 = ext_ident_double_189;
  const SDouble s27 = ext_ident_double_194;
  const SDouble s28 = ext_ident_double_191;
  const SDouble s29 = ext_ident_double_190;
  const SDouble s30 = ext_ident_double_193;
  const SDouble s31 = ext_ident_double_192;
