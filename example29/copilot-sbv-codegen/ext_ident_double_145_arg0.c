/* File: "ext_ident_double_145_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_126) + (ext_ident_double_144))));
*/
...
{
  const SDouble s0 = ext_ident_double_126;
  ...
  const SDouble s10 = ext_ident_double_144;
  const SDouble s11 = ext_ident_double_134;
  const SBool   s12 = ext_ident_bool_131;
  const SDouble s13 = ext_ident_double_130;
  const SDouble s14 = ext_ident_double_127;
  const SDouble s15 = ext_ownship_position_z;
  const SDouble s16 = ext_intruder_position_z;
  const SDouble s17 = ext_ident_double_129;
  const SDouble s18 = ext_ident_double_128;
  const SDouble s19 = ext_minimal_vertical_separation;
  const SDouble s20 = ext_ident_double_133;
  ...
  const SDouble s24 = ext_sqrt_142;
  const SDouble s25 = ext_ident_double_135;
  const SDouble s26 = ext_ident_double_136;
  const SDouble s27 = ext_ident_double_141;
  const SDouble s28 = ext_ident_double_138;
  const SDouble s29 = ext_ident_double_137;
  const SDouble s30 = ext_ident_double_140;
  const SDouble s31 = ext_ident_double_139;
