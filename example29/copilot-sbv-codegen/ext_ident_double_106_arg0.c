/* File: "ext_ident_double_106_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_96) * (ext_ident_double_105))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SBool   s1 = ext_ident_bool_93;
  const SDouble s2 = ext_ident_double_92;
  const SDouble s3 = ext_ident_double_89;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_91;
  const SDouble s7 = ext_ident_double_90;
  ...
  const SDouble s11 = ext_ident_double_94;
  const SDouble s12 = ext_ident_double_105;
  const SDouble s13 = ext_sqrt_104;
  const SDouble s14 = ext_ident_double_97;
  ...
  const SDouble s23 = ext_ident_double_98;
  const SDouble s24 = ext_ident_double_103;
  const SDouble s25 = ext_ident_double_100;
  const SDouble s26 = ext_ident_double_99;
  const SDouble s27 = ext_ident_double_102;
  const SDouble s28 = ext_ident_double_101;
