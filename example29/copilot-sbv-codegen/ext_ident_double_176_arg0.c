                                  ...
                                  const SDouble ext_ident_double_173)
{
  ...
  const SDouble s1 = ext_ident_double_172;
  const SDouble s2 = ext_ident_double_153;
  const SDouble s3 = ext_ident_double_152;
  ...
  const SDouble s12 = ext_ident_double_171;
  const SDouble s13 = ext_ident_double_161;
  const SBool   s14 = ext_ident_bool_158;
  const SDouble s15 = ext_ident_double_157;
  const SDouble s16 = ext_ident_double_154;
  ...
  const SDouble s25 = ext_ident_double_170;
  const SDouble s26 = ext_sqrt_169;
  const SDouble s27 = ext_ident_double_162;
  const SDouble s28 = ext_ident_double_163;
  const SDouble s29 = ext_ident_double_168;
  const SDouble s30 = ext_ident_double_165;
  const SDouble s31 = ext_ident_double_164;
  const SDouble s32 = ext_ident_double_167;
  const SDouble s33 = ext_ident_double_166;
  const SDouble s34 = ext_minimal_horizontal_separation;
  const SDouble s35 = ext_ident_double_174;
  const SDouble s36 = ext_ident_double_173;
