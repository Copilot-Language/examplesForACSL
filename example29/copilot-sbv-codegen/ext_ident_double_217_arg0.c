...
/*test 003*/
/*ACSL to write
 label "thetaVert_part2.2" (((Ext_ownship_position_x - Ext_intruder_position_x) * (Ext_ownship_velocity_x - Ext_intruder_velocity_x)) + ((Ext_ownship_position_y - Ext_intruder_position_y) * (Ext_ownship_velocity_y - Ext_intruder_velocity_y)))
*/
/*@
 assigns \nothing;
                                  ...
                                  const SDouble ext_intruder_velocity_y)
{
  ...
  const SDouble s15 = s14 /* thetaVert_part2.2 */;
