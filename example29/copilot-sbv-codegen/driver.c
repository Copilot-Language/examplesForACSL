...
/*@
 ...
 //ensures ext_sqrt_14 == tmp_ext_sqrt_14;
*/
void static sampleExts(void) {
  ...
  SDouble tmp_ext_sqrt_14 = sqrt(ext_sqrt_14_arg0(ext_ownship_position_x, ext_intruder_position_x, ext_ownship_position_y, ext_intruder_position_y, ext_minimal_horizontal_separation));
