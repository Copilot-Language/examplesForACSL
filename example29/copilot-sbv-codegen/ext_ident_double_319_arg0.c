...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_309) * (ext_ident_double_318))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SBool   s1 = ext_ident_bool_306;
  const SDouble s2 = ext_ident_double_305;
  const SDouble s3 = ext_ident_double_302;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_304;
  const SDouble s7 = ext_ident_double_303;
  const SDouble s8 = ext_minimal_vertical_separation;
  const SDouble s9 = ext_ident_double_308;
  const SDouble s10 = ext_direction_parameter_vertical;
  const SDouble s11 = ext_ident_double_307;
  const SDouble s12 = ext_ident_double_318;
  const SDouble s13 = ext_sqrt_317;
  ...
  const SDouble s26 = ext_ident_double_312;
