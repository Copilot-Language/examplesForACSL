...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_283) * (ext_ident_double_292))));
*/
...
{
  const SDouble s0 = ext_ident_double_283;
  const SBool   s1 = ext_ident_bool_280;
  const SDouble s2 = ext_ident_double_279;
  const SDouble s3 = ext_ident_double_276;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_278;
  const SDouble s7 = ext_ident_double_277;
  const SDouble s8 = ext_minimal_vertical_separation;
  const SDouble s9 = ext_ident_double_282;
  const SDouble s10 = ext_direction_parameter_vertical;
  const SDouble s11 = ext_ident_double_281;
  const SDouble s12 = ext_ident_double_292;
  const SDouble s13 = ext_sqrt_291;
  const SDouble s14 = ext_ident_double_284;
  ...
  const SDouble s23 = ext_ident_double_285;
  const SDouble s24 = ext_ident_double_290;
  const SDouble s25 = ext_ident_double_287;
  const SDouble s26 = ext_ident_double_286;
  const SDouble s27 = ext_ident_double_289;
  const SDouble s28 = ext_ident_double_288;
