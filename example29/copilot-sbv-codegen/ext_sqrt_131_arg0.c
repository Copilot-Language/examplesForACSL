/* File: "ext_sqrt_131_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (((((ext_ident_double_124) * (ext_ident_double_125))) - (ext_ident_double_130)));
*/
                          ...
                          const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s9 = ext_ident_double_125;
  const SDouble s10 = ext_ident_double_130;
  const SDouble s11 = ext_ident_double_127;
  const SDouble s12 = ext_ident_double_126;
  const SDouble s13 = ext_ident_double_129;
