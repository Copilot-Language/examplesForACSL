                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SBool   s1 = ext_ident_bool_158;
  const SDouble s2 = ext_ident_double_157;
  const SDouble s3 = ext_ident_double_154;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_156;
  const SDouble s7 = ext_ident_double_155;
  ...
  const SDouble s13 = ext_sqrt_169;
  const SDouble s14 = ext_ident_double_162;
  ...
  const SDouble s23 = ext_ident_double_163;
  const SDouble s24 = ext_ident_double_168;
  const SDouble s25 = ext_ident_double_165;
  const SDouble s26 = ext_ident_double_164;
  const SDouble s27 = ext_ident_double_167;
  const SDouble s28 = ext_ident_double_166;
