                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s11 = ext_ident_double_130;
  const SDouble s12 = ext_ident_double_127;
  const SDouble s13 = ext_ident_double_126;
  const SDouble s14 = ext_ident_double_129;
  const SDouble s15 = ext_ident_double_128;
