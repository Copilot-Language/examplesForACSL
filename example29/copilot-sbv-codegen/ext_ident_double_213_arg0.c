...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_203) * (ext_ident_double_212))));
*/
...
{
  const SDouble s0 = ext_ident_double_203;
  const SBool   s1 = ext_ident_bool_200;
  const SDouble s2 = ext_ident_double_199;
  const SDouble s3 = ext_ident_double_196;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_198;
  const SDouble s7 = ext_ident_double_197;
  const SDouble s8 = ext_minimal_vertical_separation;
  const SDouble s9 = ext_ident_double_202;
  const SDouble s10 = ext_direction_parameter_vertical;
  const SDouble s11 = ext_ident_double_201;
  const SDouble s12 = ext_ident_double_212;
  const SDouble s13 = ext_sqrt_211;
  const SDouble s14 = ext_ident_double_204;
  ...
  const SDouble s23 = ext_ident_double_205;
  const SDouble s24 = ext_ident_double_210;
  const SDouble s25 = ext_ident_double_207;
  const SDouble s26 = ext_ident_double_206;
  const SDouble s27 = ext_ident_double_209;
