...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_123) * (ext_ident_double_132))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SBool   s1 = ext_ident_bool_120;
  const SDouble s2 = ext_ident_double_119;
  const SDouble s3 = ext_ident_double_116;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_118;
  const SDouble s7 = ext_ident_double_117;
  ...
  const SDouble s11 = ext_ident_double_121;
  const SDouble s12 = ext_ident_double_132;
  const SDouble s13 = ext_sqrt_131;
  const SDouble s14 = ext_ident_double_124;
  ...
  const SDouble s23 = ext_ident_double_125;
  const SDouble s24 = ext_ident_double_130;
  const SDouble s25 = ext_ident_double_127;
  const SDouble s26 = ext_ident_double_126;
  const SDouble s27 = ext_ident_double_129;
  const SDouble s28 = ext_ident_double_128;
