...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_134) / (ext_ident_double_136))));
*/
                                  ...
                                  const SDouble ext_ident_double_135)
{
  ...
  const SDouble s1 = ext_ident_double_115;
  const SDouble s2 = ext_ident_double_114;
  ...
  const SDouble s11 = ext_ident_double_133;
  const SDouble s12 = ext_ident_double_123;
  const SBool   s13 = ext_ident_bool_120;
  const SDouble s14 = ext_ident_double_119;
  const SDouble s15 = ext_ident_double_116;
  ...
  const SDouble s21 = ext_ident_double_122;
  const SDouble s22 = ext_direction_parameter_vertical;
  const SDouble s23 = ext_ident_double_121;
  const SDouble s24 = ext_ident_double_132;
  const SDouble s25 = ext_sqrt_131;
  const SDouble s26 = ext_ident_double_124;
  const SDouble s27 = ext_ident_double_125;
  const SDouble s28 = ext_ident_double_130;
  const SDouble s29 = ext_ident_double_127;
  const SDouble s30 = ext_ident_double_126;
  const SDouble s31 = ext_ident_double_129;
  const SDouble s32 = ext_ident_double_128;
  const SDouble s33 = ext_minimal_horizontal_separation;
  const SDouble s34 = ext_ident_double_136;
  const SDouble s35 = ext_ident_double_135;
