/* File: "ext_ident_double_297_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_294) / (ext_ident_double_296))));
*/
                                  ...
                                  const SDouble ext_ident_double_295)
{
  ...
  const SDouble s1 = ext_ident_double_275;
  const SDouble s2 = ext_ident_double_274;
  ...
  const SDouble s12 = ext_ident_double_283;
  const SBool   s13 = ext_ident_bool_280;
  const SDouble s14 = ext_ident_double_279;
  const SDouble s15 = ext_ident_double_276;
  const SDouble s16 = ext_ownship_position_z;
  const SDouble s17 = ext_intruder_position_z;
  const SDouble s18 = ext_ident_double_278;
  const SDouble s19 = ext_ident_double_277;
  const SDouble s20 = ext_minimal_vertical_separation;
  const SDouble s21 = ext_ident_double_282;
  const SDouble s22 = ext_direction_parameter_vertical;
  const SDouble s23 = ext_ident_double_281;
  const SDouble s24 = ext_ident_double_292;
  const SDouble s25 = ext_sqrt_291;
  const SDouble s26 = ext_ident_double_284;
  const SDouble s27 = ext_ident_double_285;
  const SDouble s28 = ext_ident_double_290;
  const SDouble s29 = ext_ident_double_287;
  const SDouble s30 = ext_ident_double_286;
  const SDouble s31 = ext_ident_double_289;
  const SDouble s32 = ext_ident_double_288;
  const SDouble s33 = ext_minimal_horizontal_separation;
  const SDouble s34 = ext_ident_double_296;
  const SDouble s35 = ext_ident_double_295;
