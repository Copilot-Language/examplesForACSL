...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_93) ? (ext_ident_double_95) : (-1.0))));
*/
                                 ...
                                 const SDouble ext_ident_double_94)
{
  ...
  const SDouble s1 = ext_ident_double_92;
  const SDouble s2 = ext_ident_double_89;
  const SDouble s3 = ext_ownship_position_z;
  const SDouble s4 = ext_intruder_position_z;
  const SDouble s5 = ext_ident_double_91;
  const SDouble s6 = ext_ident_double_90;
  const SDouble s7 = ext_minimal_vertical_separation;
  const SDouble s8 = ext_ident_double_95;
