/* File: "ext_ident_bool_280_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_279) >= (ext_minimal_vertical_separation))));
*/
                              ...
                              const SDouble ext_minimal_vertical_separation)
{
  ...
  const SDouble s1 = ext_ident_double_276;
