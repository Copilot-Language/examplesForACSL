...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_146) ? (ext_ident_double_148) : (-1.0))));
*/
...
{
  const SBool   s0 = ext_ident_bool_146;
  ...
  const SDouble s6 = ext_ident_double_143;
  const SDouble s7 = ext_minimal_vertical_separation;
  const SDouble s8 = ext_ident_double_148;
