/* File: "ext_ident_double_238_arg0.c". Automatically generated by SBV. Do not edit! */
...
{
  const SDouble s0 = ext_sqrt_237;
  const SDouble s1 = ext_ident_double_230;
  ...
  const SDouble s10 = ext_ident_double_231;
  const SDouble s11 = ext_ident_double_236;
  const SDouble s12 = ext_ident_double_233;
  const SDouble s13 = ext_ident_double_232;
  const SDouble s14 = ext_ident_double_235;
