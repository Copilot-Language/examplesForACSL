...
{
  const SDouble s0 = ext_ident_double_58;
  const SDouble s1 = ext_ident_double_55;
  const SDouble s2 = ext_ident_double_36;
  const SDouble s3 = ext_ident_double_35;
  ...
  const SDouble s12 = ext_ident_double_54;
  const SDouble s13 = ext_ident_double_44;
  const SBool   s14 = ext_ident_bool_41;
  const SDouble s15 = ext_ident_double_40;
  const SDouble s16 = ext_ident_double_37;
  const SDouble s17 = ext_ownship_position_z;
  const SDouble s18 = ext_intruder_position_z;
  const SDouble s19 = ext_ident_double_39;
  const SDouble s20 = ext_ident_double_38;
  const SDouble s21 = ext_minimal_vertical_separation;
  const SDouble s22 = ext_ident_double_43;
  const SDouble s23 = ext_direction_parameter_vertical;
  const SDouble s24 = ext_ident_double_42;
  const SDouble s25 = ext_ident_double_53;
  const SDouble s26 = ext_sqrt_52;
  const SDouble s27 = ext_ident_double_45;
  const SDouble s28 = ext_ident_double_46;
  const SDouble s29 = ext_ident_double_51;
  const SDouble s30 = ext_ident_double_48;
  const SDouble s31 = ext_ident_double_47;
  const SDouble s32 = ext_ident_double_50;
  const SDouble s33 = ext_ident_double_49;
  const SDouble s34 = ext_minimal_horizontal_separation;
  const SDouble s35 = ext_ident_double_57;
  const SDouble s36 = ext_ident_double_56;
  const SDouble s37 = s0 /* theta_dir_1 */;
