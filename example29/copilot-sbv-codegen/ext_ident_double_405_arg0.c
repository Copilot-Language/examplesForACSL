...
1 -> 2
3 [label="ext_ident_double_404",color=cyan4, style=filled]
2 -> 3
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_404) - (((ext_minimal_horizontal_separation) * (ext_minimal_horizontal_separation))))));
*/
