...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_215) * (ext_ident_double_224))));
*/
...
{
  const SDouble s0 = ext_ident_double_215;
  const SBool   s1 = ext_ident_bool_212;
  const SDouble s2 = ext_ident_double_211;
  const SDouble s3 = ext_ident_double_208;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_210;
  const SDouble s7 = ext_ident_double_209;
  const SDouble s8 = ext_minimal_vertical_separation;
  const SDouble s9 = ext_ident_double_214;
  const SDouble s10 = ext_direction_parameter_vertical;
  const SDouble s11 = ext_ident_double_213;
  const SDouble s12 = ext_ident_double_224;
  const SDouble s13 = ext_sqrt_223;
  const SDouble s14 = ext_ident_double_216;
  ...
  const SDouble s23 = ext_ident_double_217;
  const SDouble s24 = ext_ident_double_222;
  const SDouble s25 = ext_ident_double_219;
  const SDouble s26 = ext_ident_double_218;
  const SDouble s27 = ext_ident_double_221;
  const SDouble s28 = ext_ident_double_220;
