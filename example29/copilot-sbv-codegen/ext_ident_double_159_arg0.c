/* File: "ext_ident_double_159_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_149) * (ext_ident_double_158))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SBool   s1 = ext_ident_bool_146;
  ...
  const SDouble s6 = ext_ident_double_144;
  const SDouble s7 = ext_ident_double_143;
  const SDouble s8 = ext_minimal_vertical_separation;
  const SDouble s9 = ext_ident_double_148;
  const SDouble s10 = ext_direction_parameter_vertical;
  const SDouble s11 = ext_ident_double_147;
  const SDouble s12 = ext_ident_double_158;
  const SDouble s13 = ext_sqrt_157;
  ...
  const SDouble s24 = ext_ident_double_156;
  const SDouble s25 = ext_ident_double_153;
  const SDouble s26 = ext_ident_double_152;
  const SDouble s27 = ext_ident_double_155;
  const SDouble s28 = ext_ident_double_154;
