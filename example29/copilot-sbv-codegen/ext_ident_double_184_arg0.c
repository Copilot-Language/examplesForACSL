/* File: "ext_ident_double_184_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_181) * (ext_ident_double_183))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s6 = ext_ident_double_183;
  const SDouble s7 = ext_ident_double_182;
