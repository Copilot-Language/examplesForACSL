...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_353) + (ext_ident_double_371))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s1 = ext_ident_double_352;
  ...
  const SDouble s11 = ext_ident_double_361;
  const SBool   s12 = ext_ident_bool_358;
  const SDouble s13 = ext_ident_double_357;
  const SDouble s14 = ext_ident_double_354;
  const SDouble s15 = ext_ownship_position_z;
  const SDouble s16 = ext_intruder_position_z;
  const SDouble s17 = ext_ident_double_356;
  const SDouble s18 = ext_ident_double_355;
  const SDouble s19 = ext_minimal_vertical_separation;
  const SDouble s20 = ext_ident_double_360;
  const SDouble s21 = ext_direction_parameter_vertical;
  const SDouble s22 = ext_ident_double_359;
  const SDouble s23 = ext_ident_double_370;
  const SDouble s24 = ext_sqrt_369;
  const SDouble s25 = ext_ident_double_362;
  const SDouble s26 = ext_ident_double_363;
  const SDouble s27 = ext_ident_double_368;
  const SDouble s28 = ext_ident_double_365;
  const SDouble s29 = ext_ident_double_364;
  const SDouble s30 = ext_ident_double_367;
  const SDouble s31 = ext_ident_double_366;
