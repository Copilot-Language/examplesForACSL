...
1 -> 2
3 [label="ext_ident_double_315",color=cyan4, style=filled]
2 -> 3
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_315) > 0)? 1 : ((ext_ident_double_315) < 0 ? -1 : (ext_ident_double_315))));
*/
SDouble ext_ident_double_316_arg0(const SDouble ext_ident_double_315,
                                  const SDouble ext_ownship_position_z,
                                  const SDouble ext_intruder_position_z)
{
  const SDouble s0 = ext_ident_double_315;
