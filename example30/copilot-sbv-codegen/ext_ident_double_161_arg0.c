...
/*@
 assigns \nothing;
 ensures \result == ((( (ext_ident_bool_158) ? (ext_ident_double_160) : (-1.0))));
*/
...
{
  const SBool   s0 = ext_ident_bool_158;
  const SDouble s1 = ext_ident_double_157;
  const SDouble s2 = ext_ident_double_154;
  const SDouble s3 = ext_ownship_position_z;
  const SDouble s4 = ext_intruder_position_z;
  const SDouble s5 = ext_ident_double_156;
  const SDouble s6 = ext_ident_double_155;
  const SDouble s7 = ext_minimal_vertical_separation;
  const SDouble s8 = ext_ident_double_160;
