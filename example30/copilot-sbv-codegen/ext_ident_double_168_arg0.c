...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_165) * (ext_ident_double_167))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s1 = ext_ident_double_164;
  ...
  const SDouble s6 = ext_ident_double_167;
  const SDouble s7 = ext_ident_double_166;
