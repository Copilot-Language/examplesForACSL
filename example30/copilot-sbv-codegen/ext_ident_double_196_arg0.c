                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s10 = ext_ident_double_189;
  const SDouble s11 = ext_ident_double_194;
  const SDouble s12 = ext_ident_double_191;
  const SDouble s13 = ext_ident_double_190;
  const SDouble s14 = ext_ident_double_193;
  const SDouble s15 = ext_ident_double_192;
