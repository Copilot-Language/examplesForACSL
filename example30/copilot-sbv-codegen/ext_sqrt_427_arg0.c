/* File: "ext_sqrt_427_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == (((ext_ident_double_426) - (((ext_minimal_horizontal_separation) * (ext_minimal_horizontal_separation)))));
*/
