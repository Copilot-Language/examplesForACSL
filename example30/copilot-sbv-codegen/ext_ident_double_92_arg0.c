                                 ...
                                 const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s2 = ext_ident_double_78;
  const SDouble s3 = ext_ident_double_75;
  const SDouble s4 = ext_ownship_position_z;
  const SDouble s5 = ext_intruder_position_z;
  const SDouble s6 = ext_ident_double_77;
  const SDouble s7 = ext_ident_double_76;
  ...
  const SDouble s13 = ext_sqrt_90;
  const SDouble s14 = ext_ident_double_83;
  ...
  const SDouble s23 = ext_ident_double_84;
  const SDouble s24 = ext_ident_double_89;
  const SDouble s25 = ext_ident_double_86;
  const SDouble s26 = ext_ident_double_85;
  const SDouble s27 = ext_ident_double_88;
  const SDouble s28 = ext_ident_double_87;
