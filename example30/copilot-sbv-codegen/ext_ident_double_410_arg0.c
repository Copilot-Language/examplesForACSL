                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s1 = ext_ident_double_390;
  ...
  const SDouble s11 = ext_ident_double_399;
  const SBool   s12 = ext_ident_bool_396;
  const SDouble s13 = ext_ident_double_395;
  const SDouble s14 = ext_ident_double_392;
  const SDouble s15 = ext_ownship_position_z;
  const SDouble s16 = ext_intruder_position_z;
  const SDouble s17 = ext_ident_double_394;
  const SDouble s18 = ext_ident_double_393;
  const SDouble s19 = ext_minimal_vertical_separation;
  const SDouble s20 = ext_ident_double_398;
  const SDouble s21 = ext_direction_parameter_vertical;
  const SDouble s22 = ext_ident_double_397;
  const SDouble s23 = ext_ident_double_408;
  const SDouble s24 = ext_sqrt_407;
  const SDouble s25 = ext_ident_double_400;
  const SDouble s26 = ext_ident_double_401;
  const SDouble s27 = ext_ident_double_406;
  const SDouble s28 = ext_ident_double_403;
  const SDouble s29 = ext_ident_double_402;
  const SDouble s30 = ext_ident_double_405;
  const SDouble s31 = ext_ident_double_404;
