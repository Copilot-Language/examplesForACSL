                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s1 = ext_ident_double_135;
  ...
  const SDouble s10 = ext_ident_double_136;
  const SDouble s11 = ext_ident_double_141;
  const SDouble s12 = ext_ident_double_138;
  const SDouble s13 = ext_ident_double_137;
  const SDouble s14 = ext_ident_double_140;
  const SDouble s15 = ext_ident_double_139;
