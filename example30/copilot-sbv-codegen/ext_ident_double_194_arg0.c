/* File: "ext_ident_double_194_arg0.c". Automatically generated by SBV. Do not edit! */
...
/*@
 assigns \nothing;
 ensures \result == ((((ext_ident_double_191) * (ext_ident_double_193))));
*/
                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SDouble s1 = ext_ident_double_190;
  ...
  const SDouble s6 = ext_ident_double_193;
  const SDouble s7 = ext_ident_double_192;
