/* File: "ext_ident_double_382_arg0.c". Automatically generated by SBV. Do not edit! */
...
{
  const SDouble s0 = ext_sqrt_381;
  const SDouble s1 = ext_ident_double_374;
  ...
  const SDouble s10 = ext_ident_double_375;
  const SDouble s11 = ext_ident_double_380;
  const SDouble s12 = ext_ident_double_377;
  const SDouble s13 = ext_ident_double_376;
  const SDouble s14 = ext_ident_double_379;
  const SDouble s15 = ext_ident_double_378;
