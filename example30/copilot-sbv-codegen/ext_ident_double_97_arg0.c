...
/*@
 assigns \nothing;
 ensures \result == ((ext_ident_double_96));
*/
                                 ...
                                 const SDouble ext_ident_double_94)
{
  ...
  const SDouble s1 = ext_ident_double_93;
  const SDouble s2 = ext_ident_double_74;
  const SDouble s3 = ext_ident_double_73;
  ...
  const SDouble s12 = ext_ident_double_92;
  const SDouble s13 = ext_ident_double_82;
  const SBool   s14 = ext_ident_bool_79;
  const SDouble s15 = ext_ident_double_78;
  const SDouble s16 = ext_ident_double_75;
  ...
  const SDouble s22 = ext_ident_double_81;
  const SDouble s23 = ext_direction_parameter_vertical;
  const SDouble s24 = ext_ident_double_80;
  const SDouble s25 = ext_ident_double_91;
  const SDouble s26 = ext_sqrt_90;
  const SDouble s27 = ext_ident_double_83;
  const SDouble s28 = ext_ident_double_84;
  const SDouble s29 = ext_ident_double_89;
  const SDouble s30 = ext_ident_double_86;
  const SDouble s31 = ext_ident_double_85;
  const SDouble s32 = ext_ident_double_88;
  const SDouble s33 = ext_ident_double_87;
  const SDouble s34 = ext_minimal_horizontal_separation;
  const SDouble s35 = ext_ident_double_95;
  const SDouble s36 = ext_ident_double_94;
