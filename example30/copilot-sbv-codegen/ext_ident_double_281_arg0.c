                                  ...
                                  const SDouble ext_ident_double_279)
{
  ...
  const SDouble s1 = ext_ident_double_259;
  const SDouble s2 = ext_ident_double_258;
  ...
  const SDouble s11 = ext_ident_double_277;
  const SDouble s12 = ext_ident_double_267;
  const SBool   s13 = ext_ident_bool_264;
  const SDouble s14 = ext_ident_double_263;
  const SDouble s15 = ext_ident_double_260;
  const SDouble s16 = ext_ownship_position_z;
  const SDouble s17 = ext_intruder_position_z;
  const SDouble s18 = ext_ident_double_262;
  const SDouble s19 = ext_ident_double_261;
  const SDouble s20 = ext_minimal_vertical_separation;
  const SDouble s21 = ext_ident_double_266;
  const SDouble s22 = ext_direction_parameter_vertical;
  const SDouble s23 = ext_ident_double_265;
  const SDouble s24 = ext_ident_double_276;
  const SDouble s25 = ext_sqrt_275;
  const SDouble s26 = ext_ident_double_268;
  const SDouble s27 = ext_ident_double_269;
  const SDouble s28 = ext_ident_double_274;
  const SDouble s29 = ext_ident_double_271;
  const SDouble s30 = ext_ident_double_270;
  const SDouble s31 = ext_ident_double_273;
  const SDouble s32 = ext_ident_double_272;
  const SDouble s33 = ext_minimal_horizontal_separation;
  const SDouble s34 = ext_ident_double_280;
  const SDouble s35 = ext_ident_double_279;
