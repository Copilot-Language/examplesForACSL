                                  ...
                                  const SDouble ext_minimal_horizontal_separation)
{
  ...
  const SBool   s1 = ext_ident_bool_131;
  const SDouble s2 = ext_ident_double_130;
  const SDouble s3 = ext_ident_double_127;
  ...
  const SDouble s9 = ext_ident_double_133;
  const SDouble s10 = ext_direction_parameter_vertical;
  const SDouble s11 = ext_ident_double_132;
  const SDouble s12 = ext_ident_double_143;
  const SDouble s13 = ext_sqrt_142;
  const SDouble s14 = ext_ident_double_135;
  ...
  const SDouble s23 = ext_ident_double_136;
  const SDouble s24 = ext_ident_double_141;
  const SDouble s25 = ext_ident_double_138;
  const SDouble s26 = ext_ident_double_137;
  const SDouble s27 = ext_ident_double_140;
  const SDouble s28 = ext_ident_double_139;
