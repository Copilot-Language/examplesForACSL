                                  ...
                                  const SDouble ext_ident_double_385)
{
  ...
  const SDouble s3 = ext_ident_double_387;
  const SDouble s4 = ext_ident_double_384;
  const SDouble s5 = ext_ident_double_365;
  const SDouble s6 = ext_ident_double_364;
  ...
  const SDouble s13 = ext_ident_double_383;
  const SDouble s14 = ext_ident_double_373;
  const SBool   s15 = ext_ident_bool_370;
  const SDouble s16 = ext_ident_double_369;
  const SDouble s17 = ext_ident_double_366;
  const SDouble s18 = ext_ownship_position_z;
  const SDouble s19 = ext_intruder_position_z;
  const SDouble s20 = ext_ident_double_368;
  const SDouble s21 = ext_ident_double_367;
  const SDouble s22 = ext_minimal_vertical_separation;
  const SDouble s23 = ext_ident_double_372;
  const SDouble s24 = ext_direction_parameter_vertical;
  const SDouble s25 = ext_ident_double_371;
  const SDouble s26 = ext_ident_double_382;
  const SDouble s27 = ext_sqrt_381;
  const SDouble s28 = ext_ident_double_374;
  const SDouble s29 = ext_ident_double_375;
  const SDouble s30 = ext_ident_double_380;
  const SDouble s31 = ext_ident_double_377;
  const SDouble s32 = ext_ident_double_376;
  const SDouble s33 = ext_ident_double_379;
  const SDouble s34 = ext_ident_double_378;
  const SDouble s35 = ext_minimal_horizontal_separation;
  const SDouble s36 = ext_ident_double_386;
  const SDouble s37 = ext_ident_double_385;
