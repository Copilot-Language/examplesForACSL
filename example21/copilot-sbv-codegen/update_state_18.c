...
/*@
 assigns \nothing;
 ensures \result == queue_18[ptr_18];
*/
SBool update_state_18(const SBool *queue_18, const SWord32 ptr_18)
{
  const SBool   s0 = queue_18[0];
  const SBool   s1 = queue_18[1];
  const SBool   s2 = queue_18[2];
  const SBool   s3 = queue_18[3];
  const SWord32 s4 = ptr_18;
  const SBool table0[] = {
      s0, s1, s2, s3
  };
